...
namespace SparksToothChart {
	...
	public class ToothGraphic {
		...
		private static float[] DefaultOrthographicXpos;
		...
		public static float GetDefaultOrthographicXpos(int intTooth) {
			if(DefaultOrthographicXpos==null) {
				DefaultOrthographicXpos=new float[33];//0-32, 0 not used
				float spacing=0;//the distance between each adjacent tooth.
				DefaultOrthographicXpos[8]=-spacing/2f-GetWidth(8)/2f;
				DefaultOrthographicXpos[7]=DefaultOrthographicXpos[8]-spacing-GetWidth(8)/2f-GetWidth(7)/2f;
				DefaultOrthographicXpos[6]=DefaultOrthographicXpos[7]-spacing-GetWidth(7)/2f-GetWidth(6)/2f;
				DefaultOrthographicXpos[5]=DefaultOrthographicXpos[6]-spacing-GetWidth(6)/2f-GetWidth(5)/2f;
				DefaultOrthographicXpos[4]=DefaultOrthographicXpos[5]-spacing-GetWidth(5)/2f-GetWidth(4)/2f;
				DefaultOrthographicXpos[3]=DefaultOrthographicXpos[4]-spacing-GetWidth(4)/2f-GetWidth(3)/2f;
				DefaultOrthographicXpos[2]=DefaultOrthographicXpos[3]-spacing-GetWidth(3)/2f-GetWidth(2)/2f;
				DefaultOrthographicXpos[1]=DefaultOrthographicXpos[2]-spacing-GetWidth(2)/2f-GetWidth(1)/2f;
				DefaultOrthographicXpos[9]=-DefaultOrthographicXpos[8];
				DefaultOrthographicXpos[10]=-DefaultOrthographicXpos[7];
				DefaultOrthographicXpos[11]=-DefaultOrthographicXpos[6];
				DefaultOrthographicXpos[12]=-DefaultOrthographicXpos[5];
				DefaultOrthographicXpos[13]=-DefaultOrthographicXpos[4];
				DefaultOrthographicXpos[14]=-DefaultOrthographicXpos[3];
				DefaultOrthographicXpos[15]=-DefaultOrthographicXpos[2];
				DefaultOrthographicXpos[16]=-DefaultOrthographicXpos[1];
				DefaultOrthographicXpos[24]=spacing/2f+GetWidth(24)/2f;
				DefaultOrthographicXpos[23]=DefaultOrthographicXpos[24]+spacing+GetWidth(24)/2f+GetWidth(23)/2f;
				DefaultOrthographicXpos[22]=DefaultOrthographicXpos[23]+spacing+GetWidth(23)/2f+GetWidth(22)/2f;
				DefaultOrthographicXpos[21]=DefaultOrthographicXpos[22]+spacing+GetWidth(22)/2f+GetWidth(21)/2f;
				DefaultOrthographicXpos[20]=DefaultOrthographicXpos[21]+spacing+GetWidth(21)/2f+GetWidth(20)/2f;
				DefaultOrthographicXpos[19]=DefaultOrthographicXpos[20]+spacing+GetWidth(20)/2f+GetWidth(19)/2f;
				DefaultOrthographicXpos[18]=DefaultOrthographicXpos[19]+spacing+GetWidth(19)/2f+GetWidth(18)/2f;
				DefaultOrthographicXpos[17]=DefaultOrthographicXpos[18]+spacing+GetWidth(18)/2f+GetWidth(17)/2f;
				DefaultOrthographicXpos[25]=-DefaultOrthographicXpos[24];
				DefaultOrthographicXpos[26]=-DefaultOrthographicXpos[23];
				DefaultOrthographicXpos[27]=-DefaultOrthographicXpos[22];
				DefaultOrthographicXpos[28]=-DefaultOrthographicXpos[21];
				DefaultOrthographicXpos[29]=-DefaultOrthographicXpos[20];
				DefaultOrthographicXpos[30]=-DefaultOrthographicXpos[19];
				DefaultOrthographicXpos[31]=-DefaultOrthographicXpos[18];
				DefaultOrthographicXpos[32]=-DefaultOrthographicXpos[17];
			}
			if(intTooth<1 || intTooth>32) {
				throw new ApplicationException("Invalid tooth_num: "+intTooth.ToString());//just for debugging
			}
			return DefaultOrthographicXpos[intTooth];
		}
