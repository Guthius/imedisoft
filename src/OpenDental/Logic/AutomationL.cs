...
namespace OpenDental
{
    public class AutomationL
    {
        ...
        {
            Action<string> actionShowMsg = (msg) =>
            {
            ...
            Func<List<Procedure>, Image> funcCreateToothChartImage = (listProcs) => { return SheetPrinting.GetToothChartHelper(patNum, false, listProceduresFilteredOverride: listProcs); };
