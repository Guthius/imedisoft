...
namespace OpenDental
{
    ...
    public class FeeL
    {
        ...
        {
            List<Fee> listFees = Fees.GetListExact(feeSchedNum, clinicNum, provNum, dateEffective);
            ...
            while (line != null)
            {
                ...
                Fee fee = Fees.GetFee(codeNum, feeSchedNum, clinicNum, provNum, listFees, dateEffective);
                string feeOldStr = "";
