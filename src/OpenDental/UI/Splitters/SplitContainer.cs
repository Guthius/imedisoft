...
public class SplitContainer:UserControl {
	...
	public int Panel1MinSize { 
		get{
			return _panel1MinSize96;
		}
		set{
			_panel1MinSize96=value;
	...
	public int Panel2MinSize { 
		get{
			return _panel2MinSize96;
		}
		set{
			_panel2MinSize96=value;
	...
	public int SplitterDistance { 
		get{
			...
			var splitterDist=_splitterDist96;
			return splitterDist;
		}
		set{
			//this happens on mouse up, but not during mouse drag
			var splitterDist=value;
			var panel1MinSize=Panel1MinSize;//scaled
			var panel2MinSize=Panel2MinSize;
			var splitterWidth=SplitterWidth;
			...
			var splitterDist96=splitterDist;
	...
	public int SplitterWidth { 
		get{
			var splitterWidth=_splitterWidth96;
			return splitterWidth;
		}
		set{
			_splitterWidth96=value;
			LayoutPanels();
		}
	}
	...
	protected override void OnPaint(PaintEventArgs e) {
		var g=e.Graphics;
		using var solidBrush=new SolidBrush(_colorSplitter);
		...
		var str="You must set Panel1 and/or Panel2 properties.\r\n"
	...
	protected override void OnMouseDown(MouseEventArgs e) {
		...
		_splitterDistWhenMouseDown=_splitterDist96;
		if(Orientation==Orientation.Vertical){
	...
	private void LayoutPanels(){
		...
		var splitterDist=SplitterDistance;//This gets us the scaled distance that also handles dragging situations
		var panel1MinSize=Panel1MinSize;//scaled
		var panel2MinSize=Panel2MinSize;
		var splitterWidth=SplitterWidth;
		if(splitterDist<panel1MinSize){
