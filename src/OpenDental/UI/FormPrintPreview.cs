...
public partial class FormPrintPreview:FormODBase {
	...
	public FormPrintPreview(ODprintout printout) {
		...
		_printout=printout;
		_printout.PrintDoc.EndPrint+=(_,_)=>SetPageNumText();
	}
	...
	public void LayoutToolBar(){
		...
		var button=new ODToolBarButton("",-1,"","PageNum");
	...
	private void SetPageNumText() {
		if(_printout.TotalPages==0) {
			...
			ToolBarMain.Buttons["PageNum"].Text=(printPreviewControl2.StartPage+1)
			                                    +" / "+_printout.TotalPages;
		}
	}
