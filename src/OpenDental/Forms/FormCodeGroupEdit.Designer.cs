namespace OpenDental {
	partial class FormCodeGroupEdit {
		...
		private void InitializeComponent() {
			...
			this.labelCodeListDesc = new System.Windows.Forms.Label();
			...
			// labelCodeListDesc
			// 
			this.labelCodeListDesc.Location = new System.Drawing.Point(146, 214);
			this.labelCodeListDesc.Name = "labelCodeListDesc";
			this.labelCodeListDesc.Size = new System.Drawing.Size(413, 57);
			this.labelCodeListDesc.TabIndex = 0;
			this.labelCodeListDesc.Text = "List of D codes with commas and dashes. No spaces.";
			// 
			// label5
			// 
			...
			this.Controls.Add(this.labelCodeListDesc);
		...
		private System.Windows.Forms.Label labelCodeListDesc;
