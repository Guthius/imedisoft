...
namespace OpenDental{
	...
	public partial class FormPath : FormODBase {
		...
		private void butSave_Click(object sender, System.EventArgs e){
			...
			if(radioDropboxStorage.Checked && true
			...
			if(radioDropboxStorage.Checked && !Cloud.Storage.Dropbox.FileExists(textAccessToken.Text,
			...
			if(radioSftp.Checked) {
				bool doesFileExist;
				try {
					doesFileExist=Sftp.FileExists(textSftpHostname.Text,textSftpUsername.Text,textSftpPassword.Text,
