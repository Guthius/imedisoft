namespace OpenDental {
	partial class FormBackup : FormODBase {
		...
		private void InitializeComponent()
		{
			...
			this.checkTaskHist = new OpenDental.UI.CheckBox();
			this.checkWikiPageHist = new OpenDental.UI.CheckBox();
			this.checkWikiListHist = new OpenDental.UI.CheckBox();
			this.labelSelectTables = new System.Windows.Forms.Label();
			this.checkEmailMessage = new OpenDental.UI.CheckBox();
			this.checkSecurityLog = new OpenDental.UI.CheckBox();
			this.checkArchiveDoBackupFirst = new OpenDental.UI.CheckBox();
			...
			this.tabPageSupplementalBackups = new OpenDental.UI.TabPage();
			...
			this.textSupplementalBackupCopyNetworkPath = new System.Windows.Forms.TextBox();
			this.labelLastSupplementalBackupDateTime = new System.Windows.Forms.Label();
			this.textSupplementalBackupDateLastComplete = new System.Windows.Forms.TextBox();
			this.checkSupplementalBackupEnabled = new OpenDental.UI.CheckBox();
    ...
    "a\\";
			...
			// tabPageArchive
			// 
			this.tabPageArchive.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(252)))), ((int)(((byte)(253)))), ((int)(((byte)(254)))));
			this.tabPageArchive.Controls.Add(this.checkOptimize);
			this.tabPageArchive.Controls.Add(this.checkTaskHist);
			this.tabPageArchive.Controls.Add(this.checkWikiPageHist);
			this.tabPageArchive.Controls.Add(this.checkWikiListHist);
			this.tabPageArchive.Controls.Add(this.labelSelectTables);
			this.tabPageArchive.Controls.Add(this.checkEmailMessage);
			...
			this.tabPageArchive.Location = new System.Drawing.Point(2, 21);
			this.tabPageArchive.Name = "tabPageArchive";
			this.tabPageArchive.Padding = new System.Windows.Forms.Padding(3);
			this.tabPageArchive.Size = new System.Drawing.Size(776, 554);
			this.tabPageArchive.TabIndex = 1;
			this.tabPageArchive.Text = "Remove Old Data";
			// 
			// checkOptimize
			// 
			this.checkOptimize.Location = new System.Drawing.Point(139, 274);
			...
			// checkTaskHist
			// 
			this.checkTaskHist.Location = new System.Drawing.Point(139, 172);
			this.checkTaskHist.Name = "checkTaskHist";
			this.checkTaskHist.Size = new System.Drawing.Size(247, 17);
			this.checkTaskHist.TabIndex = 20;
			this.checkTaskHist.Text = "TaskHist";
			// 
			// checkWikiPageHist
			// 
			this.checkWikiPageHist.Location = new System.Drawing.Point(139, 149);
			this.checkWikiPageHist.Name = "checkWikiPageHist";
			this.checkWikiPageHist.Size = new System.Drawing.Size(247, 17);
			this.checkWikiPageHist.TabIndex = 19;
			this.checkWikiPageHist.Text = "WikiPageHist";
			// 
			// checkWikiListHist
			// 
			this.checkWikiListHist.Location = new System.Drawing.Point(139, 126);
			this.checkWikiListHist.Name = "checkWikiListHist";
			this.checkWikiListHist.Size = new System.Drawing.Size(247, 17);
			this.checkWikiListHist.TabIndex = 18;
			this.checkWikiListHist.Text = "WikiListHist";
			// 
			// labelSelectTables
			// 
			...
			this.labelSelectTables.Location = new System.Drawing.Point(136, 59);
			this.labelSelectTables.Name = "labelSelectTables";
			this.labelSelectTables.Size = new System.Drawing.Size(341, 18);
			this.labelSelectTables.TabIndex = 17;
			this.labelSelectTables.Text = "Select the table(s) to remove data from:";
			// 
			// checkEmailMessage
			// 
			this.checkEmailMessage.Location = new System.Drawing.Point(139, 103);
			this.checkEmailMessage.Name = "checkEmailMessage";
			this.checkEmailMessage.Size = new System.Drawing.Size(247, 17);
			this.checkEmailMessage.TabIndex = 16;
			this.checkEmailMessage.Text = "EmailMessage";
			// 
			// checkSecurityLog
			// 
			this.checkSecurityLog.Location = new System.Drawing.Point(139, 80);
			this.checkSecurityLog.Name = "checkSecurityLog";
			this.checkSecurityLog.Size = new System.Drawing.Size(247, 17);
			this.checkSecurityLog.TabIndex = 0;
			this.checkSecurityLog.Text = "SecurityLog/SecurityLogHash";
			// 
			// checkArchiveDoBackupFirst
			// 
			this.checkArchiveDoBackupFirst.Location = new System.Drawing.Point(139, 253);
			this.checkArchiveDoBackupFirst.Name = "checkArchiveDoBackupFirst";
			this.checkArchiveDoBackupFirst.Size = new System.Drawing.Size(206, 17);
			...
			this.labelWarning.Location = new System.Drawing.Point(244, 499);
    ...
    "hen directly connected to the server.";
			...
			this.label7.Size = new System.Drawing.Size(738, 47);
			this.label7.TabIndex = 12;
			this.label7.Text = resources.GetString("label7.Text");
			// 
			// butSaveArchiveData
			// 
			this.butSaveArchiveData.Location = new System.Drawing.Point(139, 482);
			...
			this.groupBoxBackupConnection.Location = new System.Drawing.Point(131, 300);
    ...
    "cated.\r\nIf running on a single computer only, Server Name may be localhost.";
			...
			this.butArchive.Location = new System.Drawing.Point(139, 514);
			...
			this.dateTimeArchive.Location = new System.Drawing.Point(151, 221);
			...
			// 
			this.tabPageSupplementalBackups.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(252)))), ((int)(((byte)(253)))), ((int)(((byte)(254)))));
			...
			this.tabPageSupplementalBackups.Location = new System.Drawing.Point(2, 21);
			this.tabPageSupplementalBackups.Name = "tabPageSupplementalBackups";
			this.tabPageSupplementalBackups.Size = new System.Drawing.Size(776, 554);
			...
			this.butSupplementalSaveDefaults.Location = new System.Drawing.Point(192, 136);
			...
			// 
			this.labelLastSupplementalBackupDateTime.Location = new System.Drawing.Point(8, 86);
			...
			this.labelExplanation.Size = new System.Drawing.Size(759, 39);
		...
		private OpenDental.UI.CheckBox checkArchiveDoBackupFirst;
		private OpenDental.UI.TabPage tabPageSupplementalBackups;
		private UI.Button butSupplementalBrowse;
		private System.Windows.Forms.Label labelSupplementalBackupCopyNetworkPath;
		private System.Windows.Forms.TextBox textSupplementalBackupCopyNetworkPath;
		private System.Windows.Forms.Label labelLastSupplementalBackupDateTime;
		private System.Windows.Forms.TextBox textSupplementalBackupDateLastComplete;
		private OpenDental.UI.CheckBox checkSupplementalBackupEnabled;
		...
		private UI.CheckBox checkTaskHist;
		private UI.CheckBox checkWikiPageHist;
		private UI.CheckBox checkWikiListHist;
