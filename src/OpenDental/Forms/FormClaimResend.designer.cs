namespace OpenDental.Forms{
	partial class FormClaimResend {
		...
		private void InitializeComponent() {
			...
			this.radioClaimOriginal.Click += new System.EventHandler(this.RadioButtonClaimOriginal_Click);
			// 
			...
			this.radioClaimReplacement.Click += new System.EventHandler(this.RadioButtonClaimReplacement_Click);
			// 
			// butSend
			// 
