...
namespace OpenDental{
	...
	public partial class FormReqStudentsMany : FormODBase {
		...
		private void FillGrid() {
			...
			long schoolClassNum=_listSchoolClasses[comboClass.SelectedIndex].SchoolClassNum;
			long schoolCourseNum=_listSchoolCourses[comboCourse.SelectedIndex].SchoolCourseNum;
			table=ReqStudents.RefreshManyStudents(schoolClassNum,schoolCourseNum);
		...
		private void gridMain_CellDoubleClick(object sender,ODGridClickEventArgs e) {
			...
			formReqStudentOne.ProvNum=PIn.Long(table.Rows[e.Row]["studentNum"].ToString());
