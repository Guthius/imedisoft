namespace OpenDental.Forms{
	partial class FormChartViewDateFilter {
		...
		private void InitializeComponent() {
			...
			this.listPresetDateRanges = new OpenDental.UI.ListBox();
			...
			this.listPresetDateRanges.SelectionMode = OpenDental.UI.SelectionMode.None;
			this.listPresetDateRanges.Size = new System.Drawing.Size(91, 69);
			this.listPresetDateRanges.TabIndex = 8;
			this.listPresetDateRanges.MouseClick += new System.Windows.Forms.MouseEventHandler(this.ListBoxPresetDateRanges_MouseClick);
			// 
			// textDateEnd
			// 
			...
			this.butOK.Location = new System.Drawing.Point(224, 160);
			...
			this.butNowStart.TabIndex = 20;
			this.butNowStart.Text = "Now";
			this.butNowStart.Click += new System.EventHandler(this.ButtonNowStart_Click);
			// 
			// butNowEnd
			// 
			...
			this.butNowEnd.TabIndex = 21;
			this.butNowEnd.Text = "Now";
			this.butNowEnd.Click += new System.EventHandler(this.ButtonNowEnd_Click);
			// 
		...
		private OpenDental.UI.ListBox listPresetDateRanges;
