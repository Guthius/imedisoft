...
namespace OpenDental {
	public partial class FormEhrLabResultEdit2014:FormODBase {
		...
		private void butObsIdLoinc_Click(object sender,EventArgs e) {
			...
			textObsID.Text=FormL.LoincSelected.LoincCode;
			textObsIDCodeSystemName.Text="LN";
			textObsIDText.Text=FormL.LoincSelected.NameShort;
			textObsIDOrigText.Text=FormL.LoincSelected.NameLongCommon;
		}
		...
		private void butCodedElementLoinc_Click(object sender,EventArgs e) {
			...
			textObsElementID.Text=FormS.SnomedSelected.SnomedCode;
			textObsElementText.Text=FormS.SnomedSelected.Description;
			textObsElementCodeSystem.Text="SCT";
			textObsElementOrigText.Text=FormS.SnomedSelected.Description;
		}
		...
		private void butUnitOfMeasureUCUM_Click(object sender,EventArgs e) {
			...
			textObsUnitsID.Text=FormU.UcumSelected.UcumCode;
			textObsUnitsCodeSystem.Text="UCUM";
			textObsUnitsText.Text=FormU.UcumSelected.Description;
			textObsUnitsTextOrig.Text=FormU.UcumSelected.Description;
		}
