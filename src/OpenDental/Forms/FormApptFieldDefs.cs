...
namespace OpenDental{
	...
	public partial class FormApptFieldDefs:FormODBase {
		...
		private void listMain_DoubleClick(object sender, System.EventArgs e) {
			...
			FrmApptFieldDefEdit frmApptFieldDefEdit=new FrmApptFieldDefEdit();
			frmApptFieldDefEdit.ApptFieldDef=_listApptFieldDefs[listMain.SelectedIndex];
			...
			if(frmApptFieldDefEdit.IsDialogOK) {
				if(frmApptFieldDefEdit.ApptFieldDef==null) {
					...
					_listApptFieldDefs[listMain.SelectedIndex]=frmApptFieldDefEdit.ApptFieldDef;
				}
				FillListMain();
			}
		}
		...
		private void butAdd_Click(object sender, System.EventArgs e) {
			...
			FrmApptFieldDefEdit frmApptFieldDefEdit=new FrmApptFieldDefEdit();
			frmApptFieldDefEdit.ApptFieldDef=apptFieldDef;
			frmApptFieldDefEdit.IsNew=true;
			frmApptFieldDefEdit.ShowDialog();
			if(frmApptFieldDefEdit.IsDialogOK) {
				_listApptFieldDefs.Add(frmApptFieldDefEdit.ApptFieldDef);
				FillListMain();
			}
		}
