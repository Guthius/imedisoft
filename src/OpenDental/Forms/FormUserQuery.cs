    ...
    public partial class FormUserQuery : FormODBase
    {
        ...
        private static string ReplaceColumnString(int index, string dataString)
        {
            ...
            if (columnName.StartsWith("date"))
            {
                ...
                DateTime date = SIn.Date(dataString);
            ...
            switch (columnName)
            {
                ...
                case "withpat":
                    ...
                    long patNum = SIn.Long(dataString);
                ...
                case "secplannum":
                    if (_dictionaryPlanCarrier.ContainsKey(SIn.Long(dataString)))
                        retVal = _dictionaryPlanCarrier[SIn.Long(dataString)].ToString();
                    else
                        retVal = "";
                    break;
                //referralnum
                case "referralnum":
                    try
                    {
                        Referral referral = Referrals.GetReferral(SIn.Long(dataString));
        ...
        private void LayoutHelperForState(QueryExecuteState queryExecuteState)
        {
            switch (queryExecuteState)
            {
                ...
                case QueryExecuteState.Executing:
                    ...
                    Text = Lans.g(this, "User Query - Executing Query...");
                ...
                case QueryExecuteState.Formatting:
                    ...
                    Text = Lans.g(this, "User Query - Formatting Query...");
        ...
        private void ExecuteQuery(bool useReportServer, bool wasSqlValidated)
        {
            ...
            DataTable table = DataConnectionCancelable.GetTableConAlreadyOpen(_serverThreadId, _query, wasSqlValidated, useReportServer, hasStackTrace, suppressMessage: true);
            /*
