...
namespace OpenDental {
	public partial class FormWebSchedCarrierRuleCopyToClinics:FormODBase {
		...
		private void CopyRulesHelper(List<ClinicDto> listClinicsTo) {
			long clinicNumFrom=comboClinicsFrom.GetSelected<ClinicDto>().Id;
			string logMessage="";
			List<WebSchedCarrierRule> listWebSchedCarrierRulesFromClinic=gridWebSchedCarrierRules.SelectedTags<WebSchedCarrierRule>();
			List<WebSchedCarrierRule> listWebSchedCarrierRulesToClinics=WebSchedCarrierRules.GetWebSchedCarrierRulesForClinics(listClinicsTo.Select(x => x.Id).ToList());
		...
		private void butCopyRules_Click(object sender,EventArgs e) {
			...
			List<ClinicDto> listClinics=listClinicsCopyTo.GetListSelected<ClinicDto>();
		...
		private void butCopyToAll_Click(object sender,EventArgs e) {
			...
			List<ClinicDto> listClinics=listClinicsCopyTo.Items.GetAll<ClinicDto>();
			CopyRulesHelper(listClinics);
		}
