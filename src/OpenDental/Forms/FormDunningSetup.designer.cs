namespace OpenDental.Forms{
	partial class FormDunningSetup {
		...
		private void InitializeComponent() {
			...
			this.listBill = new OpenDental.UI.ListBox();
			...
			this.butDuplicate.Click += new System.EventHandler(this.ButtonDuplicate_Click);
			// 
			// gridDunning
			// 
			...
			this.listBill.SelectionMode = OpenDental.UI.SelectionMode.MultiExtended;
		...
		private OpenDental.UI.ListBox listBill;
