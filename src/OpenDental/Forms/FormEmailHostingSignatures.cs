...
namespace OpenDental {
	public partial class FormEmailHostingSignatures:FormODBase {
		...
		private void FillSignature() {
			...
			bool isClinicActivated=Clinics.IsMassEmailSignedUp(clinic.Id) || Clinics.IsSecureEmailSignedUp(clinic.Id);
			...
			string plainTextSignature=EmailHostingTemplates.GetSignature(clinic.Id,isHtml:false);
			string htmlSignature=EmailHostingTemplates.GetSignature(clinic.Id,isHtml:true);
