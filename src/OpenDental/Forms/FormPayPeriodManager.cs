...
namespace OpenDental {
	...
	public partial class FormPayPeriodManager:FormODBase {
		...
		private void FormPayPeriodManager_Load(object sender, System.EventArgs e) {
			List<string> listDayOptions=new List<string>();
		...
		private DateTime GetDateOfDay(DateTime dateStart,DayOfWeek dayOfWeek) {
			DateTime dateTimeResult=dateStart.AddDays(1);//PayDate cannot be the same as the last day of the pay period.
		...
		private void butSave_Click(object sender,EventArgs e) {
			...
			//Save payperiods
			for(int i=0;i<_listPayPeriods.Count;i++) {//PayPeriods are always new in this form.
