...
namespace OpenDental {
	public partial class FormEServicesAutoMsgingPreferences:FormODBase {
		...
		private void comboClinic_SelectionChangeCommitted(object sender,EventArgs e) {
			bool isDefaultClinic=GetSelectedClinic().Id==0;
		...
		private void checkUseDefaultPrefs_Click(object sender,EventArgs e) {
			...
			ClinicPref clinicPref=_listClinicPrefs.FirstOrDefault(x => x.ClinicNum==clinic.Id && x.PrefName==PrefName.AutoMsgingUseDefaultPref);
			if(clinicPref==null) {
		...
		private void checkSendToGuarantorForMinors_Click(object sender,EventArgs e) {
			...
			ClinicPref clinicPref=_listClinicPrefs.FirstOrDefault(x => x.ClinicNum==clinic.Id && x.PrefName==PrefName.AutoCommUnder18SendToGuarantor);
			if(clinicPref==null) {
