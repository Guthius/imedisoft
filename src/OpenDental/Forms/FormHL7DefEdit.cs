	...
	public partial class FormHL7DefEdit:FormODBase {
		...
		private void FillGrid() {
			...
			for(int i=0;i<HL7DefCur.hl7DefMessages.Count;i++) {
				...
				for(int j=0;j<HL7DefCur.hl7DefMessages[i].ListHL7DefSegments.Count;j++) {
					row=new GridRow();
					row.Cells.Add("");
		...
		private void gridMain_CellDoubleClick(object sender,ODGridClickEventArgs e) {
			using FormHL7DefMessageEdit formHL7DefMessageEdit=new FormHL7DefMessageEdit();
		...
		private void butDelete_Click(object sender,EventArgs e) {
			...
			for(int m=0;m<HL7DefCur.hl7DefMessages.Count;m++) {
				for(int s=0;s<HL7DefCur.hl7DefMessages[m].ListHL7DefSegments.Count;s++) {
					for(int f=0;f<HL7DefCur.hl7DefMessages[m].ListHL7DefSegments[s].hl7DefFields.Count;f++) {
