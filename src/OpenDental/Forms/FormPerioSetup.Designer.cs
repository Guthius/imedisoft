...
namespace OpenDental {
	partial class FormPerioSetup {
		...
		private void InitializeComponent() {
			...
			this.radioGingMarg = new System.Windows.Forms.RadioButton();
			this.radioRecession = new System.Windows.Forms.RadioButton();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			this.butAll323.Location = new System.Drawing.Point(128, 192);
			...
			this.butSave.Location = new System.Drawing.Point(467, 287);
			...
			// radioGingMarg
			// 
			this.radioGingMarg.Location = new System.Drawing.Point(128, 259);
			this.radioGingMarg.Name = "radioGingMarg";
			this.radioGingMarg.Size = new System.Drawing.Size(319, 20);
			this.radioGingMarg.TabIndex = 25;
			this.radioGingMarg.TabStop = true;
			this.radioGingMarg.Text = "Always use the term \"Gingival Margin\"";
			this.radioGingMarg.UseVisualStyleBackColor = true;
			// 
			// radioRecession
			// 
			this.radioRecession.Location = new System.Drawing.Point(128, 238);
			this.radioRecession.Name = "radioRecession";
			this.radioRecession.Size = new System.Drawing.Size(319, 20);
			this.radioRecession.TabIndex = 26;
			this.radioRecession.TabStop = true;
			this.radioRecession.Text = "Use the term \"Recession\" unless hyperplasia";
			this.radioRecession.UseVisualStyleBackColor = true;
			// 
			// FormPerioSetup
			// 
			this.ClientSize = new System.Drawing.Size(554, 323);
			this.Controls.Add(this.radioRecession);
			this.Controls.Add(this.radioGingMarg);
			...
			this.Load += new System.EventHandler(this.FormPerioSetup_Load);
		...
		private System.Windows.Forms.RadioButton radioGingMarg;
		private System.Windows.Forms.RadioButton radioRecession;
	}
}