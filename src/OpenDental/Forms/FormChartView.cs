...
namespace OpenDental{
	...
	public partial class FormChartView : FormODBase {
		...
		private void FormChartView_Load(object sender,EventArgs e) {
			string[] stringArrayChartViewDateTypes=Enum.GetNames(typeof(ChartViewDates));
			Array arrayChartViewDateValues=Enum.GetValues(typeof(ChartViewDates));
			for(int i=0;i<stringArrayChartViewDateTypes.Length;i++) {
