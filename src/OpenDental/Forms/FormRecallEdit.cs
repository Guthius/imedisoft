...
namespace OpenDental{
	...
	public partial class FormRecallEdit : FormODBase {
		...
		private void comboType_SelectionChangeCommitted(object sender,EventArgs e) {
			...
			Interval interval=_listRecallTypes[comboType.SelectedIndex].DefaultInterval;
			...
			List<RecallTrigger> listRecallTriggers=RecallTriggers.GetForType(_listRecallTypes[comboType.SelectedIndex].RecallTypeNum);
			...
			DateTime dateTimeDue=DateTime.Today+interval;
