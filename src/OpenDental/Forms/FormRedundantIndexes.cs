	...
	public partial class FormRedundantIndexes:FormODBase {
		...
		private void butDrop_Click(object sender,EventArgs e) {
			...
			if(checkLogAddStatements.Checked) {
				...
				using MsgBoxCopyPaste msgBoxCopyPaste=new MsgBoxCopyPaste(Lan.g(this,"SQL statements to add the selected index(es) back will be in the following location")+":\r\n"+path);
			...
			if(checkLogAddStatements.Checked) {
				try {
					...
					using MsgBoxCopyPaste msgBoxCopyPaste=new MsgBoxCopyPaste(Lan.g(this,"Could not create or modify the log file. Copy and paste the following queries into a text file and "
