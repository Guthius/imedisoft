	...
	public partial class FormInsCatsSetup:FormODBase {
		...
		private void gridMain_CellDoubleClick(object sender,OpenDental.UI.ODGridClickEventArgs e) {
			...
			if(gridMain.ListGridRows[e.Row].Tag.GetType()==typeof(CovCat)){
				...
				using FormInsCatEdit formInsCatEdit=new FormInsCatEdit((CovCat)gridMain.ListGridRows[e.Row].Tag);
				...
				using FormInsSpanEdit formInsSpanEdit=new FormInsSpanEdit((CovSpan)gridMain.ListGridRows[e.Row].Tag);
		...
		private void butAddSpan_Click(object sender, System.EventArgs e){
			...
			using FormInsSpanEdit formInsSpanEdit=new FormInsSpanEdit(covSpan);
		...
		private void butAddCat_Click(object sender, System.EventArgs e) {
			...
			using FormInsCatEdit formInsCatEdit=new FormInsCatEdit(covcat);
