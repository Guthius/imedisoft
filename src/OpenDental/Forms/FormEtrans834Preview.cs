...
namespace OpenDental {
	...
	public FormEtrans834Preview(X834 x834) {
		...
		private bool TryImport834() {
			...
			EtransL.ImportInsurancePlansReturnData importInsurancePlansReturnData=EtransL.ImportInsurancePlansUsingPatientLimited(_x834,_listPatientLimiteds,checkIsPatientCreate.Checked,checkIsEmployerCreate.Checked,checkDropExistingIns.Checked, actionStatus);
			Cursor=Cursors.Default;
