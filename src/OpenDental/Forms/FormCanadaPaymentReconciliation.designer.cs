namespace OpenDental.Forms{
	partial class FormCanadaPaymentReconciliation {
		...
		private void InitializeComponent() {
			...
			this.listBillingProvider = new OpenDental.UI.ListBox();
			...
			this.butSave.Location = new System.Drawing.Point(215, 300);
		...
		private OpenDental.UI.ListBox listBillingProvider;
