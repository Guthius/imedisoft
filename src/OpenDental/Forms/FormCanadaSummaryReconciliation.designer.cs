namespace OpenDental.Forms{
	partial class FormCanadaSummaryReconciliation {
		...
		private void InitializeComponent() {
			...
			this.listNetworks = new OpenDental.UI.ListBox();
			this.label3 = new System.Windows.Forms.Label();
			this.listTreatingProvider = new OpenDental.UI.ListBox();
			...
			this.listCarriers.Click += new System.EventHandler(this.ListBoxCarriers_Click);
			// 
			// listNetworks
			// 
			...
			this.listNetworks.Click += new System.EventHandler(this.ListBoxNetwork_Click);
			// 
			// label3
			// 
			...
			this.butSave.Location = new System.Drawing.Point(222, 520);
			...
			this.checkGetForAllCarriers.Click += new System.EventHandler(this.CheckBoxGetForAllCarriers_Click);
			// 
		...
		private OpenDental.UI.ListBox listNetworks;
		private System.Windows.Forms.Label label3;
		private OpenDental.UI.ListBox listTreatingProvider;
