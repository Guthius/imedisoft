...
namespace OpenDental {
	public partial class FormInsPlanSelectFam {
		...
		private void InitializeComponent(){
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormInsPlanSelectFam));
			this.butOK = new OpenDental.UI.Button();
			this.labelRelat = new System.Windows.Forms.Label();
			this.listRelat = new OpenDental.UI.ListBox();
			this.gridMain = new OpenDental.UI.GridOD();
			this.butNone = new OpenDental.UI.Button();
			this.checkShowPlansNotInUse = new OpenDental.UI.CheckBox();
			this.SuspendLayout();
			// 
			// butOK
			// 
			this.butOK.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.butOK.Location = new System.Drawing.Point(704, 248);
			...
			this.butNone.Location = new System.Drawing.Point(22, 248);
			...
			this.checkShowPlansNotInUse.Size = new System.Drawing.Size(389, 17);
			...
			this.ClientSize = new System.Drawing.Size(792, 284);
		...
		private OpenDental.UI.ListBox listRelat;
		private System.Windows.Forms.Label labelRelat;
		private OpenDental.UI.GridOD gridMain;
		private OpenDental.UI.Button butNone;
		private OpenDental.UI.CheckBox checkShowPlansNotInUse;
	}
}
