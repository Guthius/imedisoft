...
namespace OpenDental {
	public partial class FormProcButtonEdit {
		...
		private void InitializeComponent(){
			...
			this.listADA = new OpenDental.UI.ListBox();
			...
			this.checkMultiVisit = new OpenDental.UI.CheckBox();
			...
			this.butSave.Location = new System.Drawing.Point(700, 510);
		...
		private OpenDental.UI.ListBox listADA;
		...
		private OpenDental.UI.CheckBox checkMultiVisit;
