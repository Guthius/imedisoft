...
namespace OpenDental{
	...
	/// </summary>
	public partial class FormApptViewEditMobile : FormODBase {
		...
		public FormApptViewEditMobile(ApptView apptView,List<ApptViewItem> apptMobileViewItems, FormApptViewEdit parentForm) {
