namespace OpenDental.Forms{
	partial class FormApptPrintSetup {
		...
		private void InitializeComponent() {
			...
			this.butPreview.Click += new System.EventHandler(this.ButtonPreview_Click);
			// 
			...
			this.butSelectedView.Click += new System.EventHandler(this.ButtonCurrentView_Click);
			// 
			// butSelectedDay
			// 
			...
			this.butSelectedDay.Click += new System.EventHandler(this.ButtonAllForDay_Click);
			// 
			// groupBox1
			// 
