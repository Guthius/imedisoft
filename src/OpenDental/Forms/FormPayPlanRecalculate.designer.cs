namespace OpenDental.Forms{
	partial class FormPayPlanRecalculate {
		...
		private void InitializeComponent() {
			...
			this.checkRecalculateInterest = new OpenDental.UI.CheckBox();
			...
			this.butSave.Location = new System.Drawing.Point(292, 150);
		...
		private OpenDental.UI.CheckBox checkRecalculateInterest;
