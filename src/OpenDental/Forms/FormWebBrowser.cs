...
namespace OpenDental {
	...
	public partial class FormWebBrowser:FormODBase {
		...
		public FormWebBrowser(){
			...
			Lan.F(this);
			SHDocVw.WebBrowser webBrowser=(SHDocVw.WebBrowser)browser.ActiveXInstance;
		...
		private void CreateNewWindow(string url) {
			...
			FormWebBrowser formWebBrowser=new FormWebBrowser(url);//Open the page in a new window, but stay inside of OD.
			formWebBrowser.WindowState=FormWindowState.Normal;
			LayoutManager.Add(formWebBrowser.PanelBorders,this);
