...
namespace OpenDental {
	public partial class FormProcCodes {
		...
		private void InitializeComponent() {
			...
			this.comboSort = new OpenDental.UI.ComboBox();
			...
			this.groupProcCodeSetup = new OpenDental.UI.GroupBox();
			this.groupBox2 = new OpenDental.UI.GroupBox();
			this.comboFeeSchedGroup1 = new OpenDental.UI.ComboBox();
			this.checkGroups1 = new OpenDental.UI.CheckBox();
			...
			this.comboProvider1 = new OpenDental.UI.ComboBox();
			this.comboClinic1 = new OpenDental.UI.ComboBoxClinicPicker();
			this.comboFeeSched1 = new OpenDental.UI.ComboBox();
			this.groupBox3 = new OpenDental.UI.GroupBox();
			this.comboFeeSchedGroup2 = new OpenDental.UI.ComboBox();
			this.checkGroups2 = new OpenDental.UI.CheckBox();
			...
			this.comboProvider2 = new OpenDental.UI.ComboBox();
			...
			this.comboFeeSched2 = new OpenDental.UI.ComboBox();
			this.groupBox4 = new OpenDental.UI.GroupBox();
			this.comboFeeSchedGroup3 = new OpenDental.UI.ComboBox();
			this.checkGroups3 = new OpenDental.UI.CheckBox();
			...
			this.comboProvider3 = new OpenDental.UI.ComboBox();
			...
			this.comboFeeSched3 = new OpenDental.UI.ComboBox();
			...
			this.checkShowHidden.Location = new System.Drawing.Point(4, 531);
			this.checkShowHidden.Name = "checkShowHidden";
			this.checkShowHidden.Size = new System.Drawing.Size(102, 17);
			...
			this.butShowHiddenDefault.Location = new System.Drawing.Point(107, 528);
			this.butShowHiddenDefault.Name = "butShowHiddenDefault";
			this.butShowHiddenDefault.Size = new System.Drawing.Size(56, 23);
			...
			this.checkGroups1.Size = new System.Drawing.Size(183, 17);
			...
			this.checkGroups2.Size = new System.Drawing.Size(183, 17);
			...
			this.checkGroups3.Size = new System.Drawing.Size(183, 17);
		...
		private OpenDental.UI.GroupBox groupProcCodeSetup;
		private OpenDental.UI.GroupBox groupBox2;
		private OpenDental.UI.ComboBox comboProvider1;
		private UI.ComboBoxClinicPicker comboClinic1;
		private UI.ComboBox comboFeeSched1;
		private OpenDental.UI.GroupBox groupBox3;
		private OpenDental.UI.ComboBox comboProvider2;
		private UI.ComboBoxClinicPicker comboClinic2;
		private UI.ComboBox comboFeeSched2;
		private OpenDental.UI.GroupBox groupBox4;
		private OpenDental.UI.ComboBox comboProvider3;
		private UI.ComboBoxClinicPicker comboClinic3;
		private UI.ComboBox comboFeeSched3;
		...
		private OpenDental.UI.ComboBox comboSort;
		private Label label6;
		private OpenDental.UI.CheckBox checkGroups1;
		private OpenDental.UI.CheckBox checkGroups2;
		private OpenDental.UI.CheckBox checkGroups3;
		private UI.ComboBox comboFeeSchedGroup1;
		private UI.ComboBox comboFeeSchedGroup2;
		private UI.ComboBox comboFeeSchedGroup3;
	}
}
