...
namespace OpenDental {
	...
	public partial class FormFeeSchedTools :FormODBase {
		...
		private void FormFeeSchedTools_Load(object sender, System.EventArgs e) {
			...
			LayoutManager.MoveLocation(comboGroup,new Point(LayoutManager.Scale(129),LayoutManager.Scale(46)));
			LayoutManager.MoveLocation(comboGroupTo,new Point(LayoutManager.Scale(129),LayoutManager.Scale(45)));
			FillComboBoxes();
		...
		private void butIncrease_Click(object sender, System.EventArgs e) {
			...
			List<Fee> listFees=Fees.GetListExact(feeSchedNum,clinicNum,provNum,odDatePickerEffectiveDateSelected.GetDateTime());
			...
			progressOD.ActionMain=() => {
				listFees=Fees.IncreaseNew(feeSchedNum,percent,round,listFees,clinicNum,provNum,odDatePickerEffectiveDateIncrease.GetDateTime());
