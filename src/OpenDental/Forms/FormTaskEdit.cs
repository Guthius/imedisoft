...
namespace OpenDental {
	...
	public partial class FormTaskEdit:FormODBase {
		...
		private void butChange_Click(object sender,System.EventArgs e) {
			...
			using FormApptsOther formApptsOther=new FormApptsOther(frmPatientSelect.PatNumSelected,null);//Select only, can't create new appt so don't need pinboard appointments.
