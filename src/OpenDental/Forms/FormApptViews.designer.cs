...
namespace OpenDental {
	public partial class FormApptViews {
		...
		private void InitializeComponent()
		{
			...
			this.checkTwoRows = new OpenDental.UI.CheckBox();
			this.butProcColors = new OpenDental.UI.Button();
			this.comboClinic = new OpenDental.UI.ComboBoxClinicPicker();
			this.butCopyView = new OpenDental.UI.Button();
			...
			// butCopyView
			// 
			this.butCopyView.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.butCopyView.Location = new System.Drawing.Point(55, 437);
			this.butCopyView.Name = "butCopyView";
			...
			this.Controls.Add(this.butCopyView);
		...
		private OpenDental.UI.ListBox listViews;
