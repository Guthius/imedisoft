...
namespace OpenDental {
	public partial class FormEhrLabImageEdit:FormODBase {
		...
		private void FillGrid() {
			...
			gridMain.Columns.Add(new GridColumn(Lan.g("TableLabImage","Attached"),60,HorizontalAlignment.Center));
			gridMain.Columns.Add(new GridColumn(Lan.g("TableLabImage","Date"),80,HorizontalAlignment.Center));
			gridMain.Columns.Add(new GridColumn(Lan.g("TableLabImage","Category"),80,HorizontalAlignment.Center));
			gridMain.Columns.Add(new GridColumn(Lan.g("TableLabImage","Desc"),180,HorizontalAlignment.Left));
