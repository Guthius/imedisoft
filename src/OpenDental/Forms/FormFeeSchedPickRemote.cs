...
namespace OpenDental {
	public partial class FormFeeSchedPickRemote:FormODBase {
		...
		private void FillListFeeSchedFilesOntario() {
			...
			_listFeeSchedFilesOntario.Add("ON_ODA_2025_AN.txt");//Ontario Dental Association 2025 fee schedule for Anaesthesiologists.
			_listFeeSchedFilesOntario.Add("ON_ODA_2025_EN.txt");//Ontario Dental Association 2025 fee schedule for Endodontists.
			_listFeeSchedFilesOntario.Add("ON_ODA_2025_GP.txt");//Ontario Dental Association 2025 fee schedule for General Practitioners.
			_listFeeSchedFilesOntario.Add("ON_ODA_2025_OS.txt");//Ontario Dental Association 2025 fee schedule for Oral & Maxillofacial Surgeons.
			_listFeeSchedFilesOntario.Add("ON_ODA_2025_PA.txt");//Ontario Dental Association 2025 fee schedule for Paediatric Dentists.
			_listFeeSchedFilesOntario.Add("ON_ODA_2025_PE.txt");//Ontario Dental Association 2025 fee schedule for Periodontists.
			_listFeeSchedFilesOntario.Add("ON_ODA_2025_PR.txt");//Ontario Dental Association 2025 fee schedule for Prosthodontists.
		}
