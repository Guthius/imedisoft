...
namespace OpenDental {
	public partial class FormProcCodeNew {
		...
		private void InitializeComponent(){
			...
			this.comboPaintType = new OpenDental.UI.ComboBox();
			this.comboTreatArea = new OpenDental.UI.ComboBox();
		...
		private OpenDental.UI.ComboBox comboPaintType;
		private OpenDental.UI.ComboBox comboTreatArea;
