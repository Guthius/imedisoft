namespace OpenDental.Forms {
	partial class FormAdjust {
		...
		private void InitializeComponent(){
			...
			this.textAmount.Validating += new System.ComponentModel.CancelEventHandler(this.TextBoxAmount_Validating);
			// 
			// listTypePos
			// 
    ...
    " for the adjustment are removed.";
			...
			this.butEditAnyway.Click += new System.EventHandler(this.ButtonEditAnyway_Click);
			// 
			// textProcWriteoff
			// 
			...
			this.butDetachProc.Click += new System.EventHandler(this.ButtonDetachProc_Click);
			// 
			// butAttachProc
			// 
			...
			this.butAttachProc.Click += new System.EventHandler(this.ButtonAttachProc_Click);
			// 
			...
			this.checkOnlyTsiExcludedAdjTypes.CheckedChanged += new System.EventHandler(this.CheckBoxOnlyTsiExcludedAdjTypes_Checked);
			// 
			// FormAdjust
			// 
