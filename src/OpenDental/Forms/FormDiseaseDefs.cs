...
namespace OpenDental{
	...
	public partial class FormDiseaseDefs:FormODBase {
		...
		public List<long> ListDiseaseDefNumsColored=new List<long>();
		...
		private void gridMain_CellDoubleClick(object sender,ODGridClickEventArgs e) {
			...
			if(IsSelectionMode) {//selection mode.
				bool isInvalidSnomedCode=!String.IsNullOrWhiteSpace(diseaseDef.SnomedCode) && Snomeds.GetByCode(diseaseDef.SnomedCode)==null;
			...
			using FormDiseaseDefEdit formDiseaseDefEdit=new FormDiseaseDefEdit(diseaseDef);
		...
		private void butAdd_Click(object sender,System.EventArgs e) {
			...
			using FormDiseaseDefEdit formDiseaseDefEdit=new FormDiseaseDefEdit(diseaseDef);//also sets ItemOrder correctly if using alphabetical during the insert diseaseDef call.
		...
		private void butOK_Click(object sender,EventArgs e) {
			...
			bool isInvalidSnomedCode=!String.IsNullOrWhiteSpace(_listDiseaseDefs[gridMain.GetSelectedIndex()].SnomedCode) && Snomeds.GetByCode(_listDiseaseDefs[gridMain.GetSelectedIndex()].SnomedCode)==null;
