	...
	public partial class FormHL7DefMessageEdit:FormODBase {
		...
		private void FillGrid() {
			...
			if(HL7DefMessageCur!=null && HL7DefMessageCur.ListHL7DefSegments!=null) {
				for(int i=0;i<HL7DefMessageCur.ListHL7DefSegments.Count;i++) {
		...
		private void butDelete_Click(object sender,EventArgs e) {
			...
			for(int s=0;s<HL7DefMessageCur.ListHL7DefSegments.Count;s++) {
				for(int f=0;f<HL7DefMessageCur.ListHL7DefSegments[s].hl7DefFields.Count;f++) {
