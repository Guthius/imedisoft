...
namespace OpenDental {
	public partial class FormConfirmList {
		...
		private void InitializeComponent()
		{
			...
			this.comboViewStatus = new OpenDental.UI.ComboBox();
			this.comboShowRecall = new OpenDental.UI.ComboBox();
		...
		private OpenDental.UI.ComboBox comboShowRecall;
		...
		private OpenDental.UI.ComboBox comboViewStatus;
