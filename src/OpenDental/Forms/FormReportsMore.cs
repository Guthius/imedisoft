	...
	public partial class FormReportsMore:FormODBase {
		...
		private void FillLists() {
			...
			for(int i=0;i<_listDisplayReportsProdInc.Count;i++) {
				if(GroupPermissions.HasPermission(Security.CurUser,EnumPermType.Reports,_listDisplayReportsProdInc[i].DisplayReportNum,listGroupPermissions:_listGroupPermissions)) {
			...
			for(int i=0;i<_listDisplayReportsDaily.Count;i++) {
				if(GroupPermissions.HasPermission(Security.CurUser,EnumPermType.Reports,_listDisplayReportsDaily[i].DisplayReportNum,listGroupPermissions:_listGroupPermissions)) {
			...
			for(int i=0;i<_listDisplayReportsMonthly.Count;i++) {
				if(GroupPermissions.HasPermission(Security.CurUser,EnumPermType.Reports,_listDisplayReportsMonthly[i].DisplayReportNum,listGroupPermissions:_listGroupPermissions)) {
			...
			for(int i=0;i<_listDisplayReportsList.Count;i++) {
				if(GroupPermissions.HasPermission(Security.CurUser,EnumPermType.Reports,_listDisplayReportsList[i].DisplayReportNum,listGroupPermissions:_listGroupPermissions)) {
			...
			for(int i=0;i<_listDisplayReportsPublicHealth.Count;i++) {
				if(GroupPermissions.HasPermission(Security.CurUser,EnumPermType.Reports,_listDisplayReportsPublicHealth[i].DisplayReportNum,listGroupPermissions:_listGroupPermissions)) {
			...
			for(int i=0;i<_listDisplayReportsArizonaPrimary.Count;i++) {
				if(GroupPermissions.HasPermission(Security.CurUser,EnumPermType.Reports,_listDisplayReportsArizonaPrimary[i].DisplayReportNum,listGroupPermissions:_listGroupPermissions)) {
		...
		private void listProdInc_MouseDown(object sender,MouseEventArgs e) {
			...
			if(!GroupPermissions.HasPermission(Security.CurUser,EnumPermType.Reports,_listDisplayReportsProdInc[selected].DisplayReportNum,listGroupPermissions:_listGroupPermissions)) {
			...
			,List<GroupPermission> listReportPermissions=null,bool doValidatePerm=true)
		{
			if(doValidatePerm) {
				...
				if(!GroupPermissions.HasPermission(Security.CurUser,EnumPermType.Reports,displayReport.DisplayReportNum,listGroupPermissions:listReportPermissions)) {
			...
			switch(displayReport.InternalName) {
				...
				case DisplayReports.ReportNames.ProductionByProcedure:
					...
					using(FormRpProdByProc formRpProdByProc=new FormRpProdByProc()) {
