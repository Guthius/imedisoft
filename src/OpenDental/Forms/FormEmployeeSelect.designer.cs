...
namespace OpenDental {
	public partial class FormEmployeeSelect {
		...
		private void InitializeComponent(){
			...
			this.checkFurloughed = new OpenDental.UI.CheckBox();
			this.checkNonFurloughed = new OpenDental.UI.CheckBox();
			this.checkWorkingOffice = new OpenDental.UI.CheckBox();
			this.checkWorkingHome = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkFurloughed;
		private OpenDental.UI.CheckBox checkNonFurloughed;
		private OpenDental.UI.CheckBox checkWorkingOffice;
		private OpenDental.UI.CheckBox checkWorkingHome;
