...
namespace OpenDental.Forms {
	public partial class FormDunningEdit {
		...
		private void InitializeComponent()
		{
			...
			this.checkSuperFamily = new OpenDental.UI.CheckBox();
			...
			this.radioAny.CheckedChanged += new System.EventHandler(this.RadioButtonAny_CheckedChanged);
			// 
			// groupBox2
			// 
			...
			this.butSave.Location = new System.Drawing.Point(820, 493);
		...
		private OpenDental.UI.CheckBox checkSuperFamily;
	}
}
