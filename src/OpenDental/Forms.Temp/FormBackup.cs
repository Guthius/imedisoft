...
public partial class FormBackup : FormODBase
{
    ...
    private void FormBackup_Load(object sender, EventArgs e)
    {
        ...
        Class1.Decrypt(PrefC.GetString(PrefName.ArchivePassHash), out var decryptedPassword);

        textArchivePass.Text = decryptedPassword;
        textArchivePass.PasswordChar = (textArchivePass.Text == "" ? '\0' : '*');
    ...
    private bool SaveTabPrefs()
    {
        ...
        Class1.Encrypt(textArchivePass.Text, out var encryptedPassword);
    ...
    private void butBrowseFrom_Click(object sender, EventArgs e)
    {
    ...
    private void butBrowseTo_Click(object sender, EventArgs e)
    {
        using var folderBrowserDialog = new FolderBrowserDialog();
        ...
        textBackupToPath.Text = ODFileUtils.CombinePaths(folderBrowserDialog.SelectedPath, "");
    }

    private void butBrowseRestoreFrom_Click(object sender, EventArgs e)
    {
        using var folderBrowserDialog = new FolderBrowserDialog();
        ...
        textBackupRestoreFromPath.Text = ODFileUtils.CombinePaths(folderBrowserDialog.SelectedPath, "");
    }

    private void butBrowseRestoreTo_Click(object sender, EventArgs e)
    {
        using var folderBrowserDialog = new FolderBrowserDialog();
    ...
    private void butBrowseRestoreAtoZTo_Click(object sender, EventArgs e)
    {
        using var folderBrowserDialog = new FolderBrowserDialog();
    ...
    {
        if (!Programs.IsEnabledByHq(ProgramName.CentralDataStorage, out var err))
        {
            MsgBox.Show(err);
            return;
        }
