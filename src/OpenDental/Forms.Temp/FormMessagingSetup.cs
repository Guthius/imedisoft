...
public partial class FormMessagingSetup : FormODBase {
	...
	private void butAdd_Click(object sender,EventArgs e) {
		using var formSigElementDefEdit=new FormSigElementDefEdit();
		...
		//set the order
		var sigElementDef=formSigElementDefEdit.SigElementDefCur.Copy();
		...
		FillLists();
		//Select the item
		for(var i=0;i<listToFrom.Items.Count;i++){
		...
		for(var i=0;i<listExtras.Items.Count;i++) {
		...
		for(var i=0;i<listMessages.Items.Count;i++) {
