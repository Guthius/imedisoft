...
public partial class FormUserPassword : FormODBase {
	...
	public PasswordContainer PasswordContainer_;
	...
	private void butSave_Click(object sender, System.EventArgs e) {
		...
		if(Programs.UsingEcwTightOrFullMode()) {//Same check as FormLogOn
			PasswordContainer_=Authentication.GenerateLoginDetails(textPassword.Text,HashTypes.MD5_ECW);
		}
		else {
			PasswordContainer_=Authentication.GenerateLoginDetailsSHA512(textPassword.Text);
		}
