...
public partial class FormOrthoHardwareSpecs:FormODBase {
	...
	private List<OrthoHardwareSpec> _listOrthoHardwareSpecsAll= [];
	...
	private void FillGrid(int selectedIndex=-1){
		...
		var col=new GridColumn(Lan.g("TableOrthoHardwareSpecs","Description"),200);
		...
		for(var i=0;i<_listOrthoHardwareSpecsOneType.Count;i++){
	...
	private void butUp_Click(object sender, System.EventArgs e) {
		...
		var orthoHardwareSpecSelected=_listOrthoHardwareSpecsOneType[idx];
		orthoHardwareSpecSelected.ItemOrder--;
		OrthoHardwareSpecs.Update(orthoHardwareSpecSelected);
		var orthoHardwareSpecAbove=_listOrthoHardwareSpecsOneType[idx-1];
	...
	private void butDown_Click(object sender, System.EventArgs e) {
		...
		orthoHardwareSpecSelected.ItemOrder++;
		OrthoHardwareSpecs.Update(orthoHardwareSpecSelected);
		var orthoHardwareSpecBelow=_listOrthoHardwareSpecsOneType[idx+1];
