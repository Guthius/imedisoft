namespace OpenDental{
	partial class FormEServicesPaymentPortal {
		...
		private void InitializeComponent() {
			...
			this.comboBoxPayTypeM2P = new OpenDental.UI.ComboBox();
			this.labelPayTypeM2P = new System.Windows.Forms.Label();
			...
			this.butSave.Location = new System.Drawing.Point(475, 609);
			...
			this.groupBoxMessageToPay.Location = new System.Drawing.Point(12, 164);
			...
			// comboBoxPayTypeM2P
			// 
			this.comboBoxPayTypeM2P.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.comboBoxPayTypeM2P.Location = new System.Drawing.Point(385, 137);
			this.comboBoxPayTypeM2P.Name = "comboBoxPayTypeM2P";
			this.comboBoxPayTypeM2P.Size = new System.Drawing.Size(164, 21);
			this.comboBoxPayTypeM2P.TabIndex = 54;
			this.comboBoxPayTypeM2P.Text = "comboBox1";
			// 
			// labelPayTypeM2P
			// 
			this.labelPayTypeM2P.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.labelPayTypeM2P.Location = new System.Drawing.Point(174, 140);
			this.labelPayTypeM2P.Name = "labelPayTypeM2P";
			this.labelPayTypeM2P.Size = new System.Drawing.Size(205, 18);
			this.labelPayTypeM2P.TabIndex = 55;
			this.labelPayTypeM2P.Text = "Message-to-Pay Payment Type";
			this.labelPayTypeM2P.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// FormEServicesPaymentPortal
			// 
			this.ClientSize = new System.Drawing.Size(562, 645);
			this.Controls.Add(this.labelPayTypeM2P);
			this.Controls.Add(this.comboBoxPayTypeM2P);
		...
		private UI.ComboBox comboBoxPayTypeM2P;
		private System.Windows.Forms.Label labelPayTypeM2P;
	}
}