...
public partial class FormSigElementDefEdit : FormODBase {
	...
	private void butPlay_Click(object sender,EventArgs e) {
		try {
			var rawData=Convert.FromBase64String(SigElementDefCur.Sound);
	...
	private void butRecord_Click(object sender,EventArgs e) {
		...
		var soundRecorderVirtualPath=Environment.ExpandEnvironmentVariables(@"%systemroot%\Sysnative")+"\\SoundRecorder.exe";
		try {
	...
	private void butRecordNew_Click(object sender,EventArgs e) {
		using var formRecordAudio=new FormRecordAudio();
