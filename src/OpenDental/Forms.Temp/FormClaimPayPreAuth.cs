...
public partial class FormClaimPayPreAuth:FormODBase {
	...
	private void FillGrid(){
		...
		for(var i=0;i<ListClaimProcs.Count;i++){
			...
			var procedure=Procedures.GetProcFromList(_listProcedures,ListClaimProcs[i].ProcNum);
	...
	private void gridMain_CellDoubleClick(object sender,ODGridClickEventArgs e) {
		...
		using var formClaimProc=new FormClaimProc(ListClaimProcs[e.Row],procedure:null,_family,_patient,_listInsPlans,listClaimProcHists,ref listClaimProcHistsLoop,_listPatPlans,doSaveToDb:false,_listInsSubs);
