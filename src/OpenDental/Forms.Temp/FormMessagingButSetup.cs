...
public partial class FormMessagingButSetup : FormODBase {
	...
	private void Reinitialize() {
		...
		string s;
		for(var i=0;i<_listComputers.Count;i++) {
	...
	private void listButtons_DoubleClick(object sender,EventArgs e) {
		...
		if(sigButDef==null) {//Add
			...
			using var formSigButDefEdit=new FormSigButDefEdit(sigButDef.Copy());
	...
	private void butSynchAll_Click(object sender,EventArgs e) {
		...
		var strWarning="Synchronize the Buttons associated to the 'All' computer to phonecomp computers."
	...
	private void butUp_Click(object sender,EventArgs e) {
		...
		var sigButDefButton=SigButDefs.GetByIndex(selected,_sigButDefArray);
