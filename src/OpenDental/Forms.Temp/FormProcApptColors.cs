...
public partial class FormProcApptColors:FormODBase {
	...
	private void FillGrid(){
		...
		var col=new GridColumn(Lan.g("FormProcApptColors","Code Range"),20){ IsWidthDynamic=true };
		gridMain.Columns.Add(col);
		gridMain.ListGridRows.Clear();
		GridRow row;
		for(var i=0;i<_listProcApptColors.Count;i++) {
			row=new GridRow();
	...
	private void butAdd_Click(object sender, System.EventArgs e) {
		using var formProcApptColorEdit=new FormProcApptColorEdit();
