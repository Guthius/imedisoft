...
public partial class FormShowFeatures : FormODBase {
	...
	private void FormShowFeatures_Load(object sender, System.EventArgs e) {
		...
		var isLateChargesFeatureActive=PrefC.GetBool(PrefName.ShowFeatureLateCharges);
	...
	private void checkEnableClinics_Click(object sender,EventArgs e) {
		...
		var question="If you are subscribed to eServices, you may need to restart the eConnector when you turn clinics on or off. Continue?";
