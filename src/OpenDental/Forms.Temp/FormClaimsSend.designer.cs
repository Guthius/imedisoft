...
namespace OpenDental {
	public partial class FormClaimsSend {
		...
		private void InitializeComponent(){
			...
			this.comboHistoryType = new OpenDental.UI.ComboBox();
			...
			this.comboCustomTracking = new OpenDental.UI.ComboBox();
			...
			this.dateRangePicker.CalendarSelectionChanged += new System.EventHandler(this.dateRangePicker_CalendarSelection);
			// 
			// label4
			// 
		...
		private OpenDental.UI.ComboBox comboCustomTracking;
		private Label labelCustomTracking;
		private OpenDental.UI.ComboBox comboHistoryType;
