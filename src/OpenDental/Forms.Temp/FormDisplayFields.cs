...
public partial class FormDisplayFields : FormODBase {
	...
	private void FillGrids(){
		...
		for(var i=0;i<_listDisplayFieldsShowing.Count;i++){
			...
			var displayText=_listDisplayFieldsShowing[i].DescriptionOverride;
	...
	private void gridMain_CellDoubleClick(object sender,ODGridClickEventArgs e) {
		var displayFieldTemp=_listDisplayFieldsShowing[e.Row].Copy();
	...
	private bool ContainsDuplicateDescriptions() {
		...
		for(var i=0;i<_listDisplayFieldsShowing.Count;i++) {
			var description=_listDisplayFieldsShowing[i].Description;
	...
	public class DisplayFieldComparer : IEqualityComparer<DisplayField> {
		public int GetHashCode(DisplayField displayField) {
			var hash=displayField.InternalName;
			return hash.GetHashCode();
		}

		public bool Equals(DisplayField displayFieldA, DisplayField displayFieldB) {
			var retVal=displayFieldA.InternalName==displayFieldB.InternalName;
