...
public partial class FormPayPeriodEdit : FormODBase {
	...
	private void butSave_Click(object sender, System.EventArgs e) {
		...
		var datePaycheck=SIn.Date(textDatePaycheck.Text);
		...
		var listPayPeriodsExisting=PayPeriods.GetDeepCopy();
		...
		if(PayPeriods.AreAnyOverlapping(listPayPeriodsExisting, [_payPeriod])) {
