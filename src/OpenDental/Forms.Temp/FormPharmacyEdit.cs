...
public partial class FormPharmacyEdit:FormODBase {
	...
	private void FormPharmacyEdit_Load(object sender, System.EventArgs e) {
		...
		var listPharmClinics=PharmClinics.GetPharmClinicsForPharmacy(PharmacyCur.PharmacyNum);
	...
	private void butSave_Click(object sender, System.EventArgs e) {
		...
		var listPharmClinicOld=(List<PharmClinic>)comboClinic.Tag;
		var listPharmClinicNew=new List<PharmClinic>();
