...
public partial class FormPractice : FormODBase {
	...
	private void FormPractice_Load(object sender, System.EventArgs e) {
		...
		var selectedBillingProvNum=PrefC.GetLong(PrefName.InsBillingProv);
	...
	private void butSave_Click(object sender, System.EventArgs e) {
		var phone=TelephoneNumbers.FormatNumbersExactTen(textPhone.Text);
		var billingPhone=TelephoneNumbers.FormatNumbersExactTen(textBillingPhone.Text);
		var payTophone=TelephoneNumbers.FormatNumbersExactTen(textPayToPhone.Text);
		...
		var fax=TelephoneNumbers.FormatNumbersExactTen(textFax.Text);
