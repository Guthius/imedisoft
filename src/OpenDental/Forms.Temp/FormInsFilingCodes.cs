...
public partial class FormInsFilingCodes:FormODBase {
	...
	private void FillGrid(){
		...
		var col=new GridColumn(Lan.g("TableInsFilingCodes","Description"),250);
	...
	private void butAdd_Click(object sender, System.EventArgs e) {
		using var formInsFilingCodeEdit=new FormInsFilingCodeEdit();
		formInsFilingCodeEdit.InsFilingCodeCur=new InsFilingCode();
		formInsFilingCodeEdit.InsFilingCodeCur.ItemOrder=_listInsFilingCodes.Count;
		formInsFilingCodeEdit.InsFilingCodeCur.IsNew=true;
		formInsFilingCodeEdit.ShowDialog();
		FillGrid();
		changed=true;
	}
	...
	private void gridMain_CellDoubleClick(object sender,ODGridClickEventArgs e) {
		...
		using var formInsFilingCodeEdit=new FormInsFilingCodeEdit();
		formInsFilingCodeEdit.InsFilingCodeCur=_listInsFilingCodes[e.Row];
		formInsFilingCodeEdit.ShowDialog();
		FillGrid();
		changed=true;
	}
	...
	private void butUp_Click(object sender,EventArgs e) {
		...
		//swap the orders.
		var order1=_listInsFilingCodes[idx-1].ItemOrder;
		var order2=_listInsFilingCodes[idx].ItemOrder;
	...
	private void butDown_Click(object sender,EventArgs e) {
		...
		var order1=_listInsFilingCodes[idx].ItemOrder;
		var order2=_listInsFilingCodes[idx+1].ItemOrder;
