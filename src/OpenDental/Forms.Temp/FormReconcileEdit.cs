...
public partial class FormReconcileEdit : FormODBase {
	...
	private void FormReconcileEdit_Load(object sender,EventArgs e) {
		...
		var doIncludeUncleared=!ReconcileCur.IsLocked;
	...
	private void checkLocked_Click(object sender,EventArgs e) {
		...
		//}
		SaveList();
		var doIncludeUncleared=!checkLocked.Checked;
		_listJournalEntries=JournalEntries.GetForReconcile(ReconcileCur.AccountNum,doIncludeUncleared,ReconcileCur.ReconcileNum);
		FillGrid();
	}
	...
	private void butDelete_Click(object sender,EventArgs e) {
		...
		var listJournalEntries=JournalEntries.GetForReconcile(ReconcileCur.AccountNum,includeUncleared:false,ReconcileCur.ReconcileNum);
	...
	private void butPrint_Click(object sender,EventArgs e) {
		var printDocument=new PrintDocument();//TODO: Implement ODprintout pattern - MigraDoc
		...
		var document=CreatePrintDocument(printDocument);
	...
	private MigraDoc.DocumentObjectModel.Document CreatePrintDocument(PrintDocument pd) {
		...
		var fontHeading=MigraDocHelper.CreateFont(13,true);
		var fontBodyx=MigraDocHelper.CreateFont(9,false);
		var fontNamex=MigraDocHelper.CreateFont(9,true);
		var fontTotalx=MigraDocHelper.CreateFont(9,true);
		var paragraphPageNum=new Paragraph();
