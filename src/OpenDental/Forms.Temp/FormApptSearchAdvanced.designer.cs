namespace OpenDental{
	partial class FormApptSearchAdvanced {
		...
		private void InitializeComponent() {
			...
			this.butMore.Click += new System.EventHandler(this.ButtonMore_Click);
			// 
			// groupBox2
			// 
			...
			this.butProviders.Click += new System.EventHandler(this.ButtonProviders_Click);
			//
			// textAfter
			// 
			...
			this.butProvHygenist.Click += new System.EventHandler(this.ButtonProvHygenist_Click);
			// 
			// butProvDentist
			// 
			...
			this.butProvDentist.Click += new System.EventHandler(this.ButtonProvDentist_Click);
			// 
