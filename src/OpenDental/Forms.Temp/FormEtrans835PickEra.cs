...
public partial class FormEtrans835PickEra:FormODBase {
	...
	private void FillGridEras() {
		...
		gridEras.Columns.Add(new UI.GridColumn(Lan.g(this,"Carrier"),200));
		gridEras.Columns.Add(new UI.GridColumn(Lan.g(this,"Date Rec'd"),70,HorizontalAlignment.Center));
		var col=new UI.GridColumn(Lan.g(this,"Note"),70);
		col.IsWidthDynamic=true;
		gridEras.Columns.Add(col);
		gridEras.ListGridRows.Clear();
		for(var i=0;i<_listEtrans.Count;i++) {
