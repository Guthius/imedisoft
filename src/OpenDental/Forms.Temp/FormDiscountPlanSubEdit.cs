...
public partial class FormDiscountPlanSubEdit:FormODBase {
	...
	private void butDrop_Click(object sender,EventArgs e) {
		...
		var logText=Lan.g(this,"The discount plan")+" "+DiscountPlanCur.Description+" "+Lan.g(this,"was dropped.");
	...
	private void butSave_Click(object sender,EventArgs e) {
		...
		if(discountPlanSub!=null) {
			...
			if(discountPlanSub.DiscountPlanNum!=DiscountPlanSubCur.DiscountPlanNum) {
				var logText=Lan.g(this,"The discount plan changed to")+" "+DiscountPlanCur.Description+".";
				SecurityLogs.MakeLogEntry(EnumPermType.DiscountPlanAddDrop,DiscountPlanSubCur.PatNum,logText);
			}
		}
		else {
			...
			var logText=Lan.g(this,"The discount plan")+" "+DiscountPlanCur.Description+" "+Lan.g(this,"was added.");
			SecurityLogs.MakeLogEntry(EnumPermType.DiscountPlanAddDrop,DiscountPlanSubCur.PatNum,logText);
		}
		...
		if(DiscountPlanCur!=null && DiscountPlanCur.PlanNote!=textPlanNote.Text) {
			var logText=Lan.g(this, "Discount plan: ")+DiscountPlanCur.Description + Lan.g(this," plan note changed from \"") + DiscountPlanCur.PlanNote + Lan.g(this,"\" to \"") + textPlanNote.Text +"\"";
