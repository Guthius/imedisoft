namespace OpenDental{
	partial class FormEServicesMisc {
		...
		private void InitializeComponent() {
			...
			this.groupTimeFormat = new OpenDental.UI.GroupBox();
			this.label1 = new System.Windows.Forms.Label();
			this.labelTimeCustom = new System.Windows.Forms.Label();
			this.textTimeCustom = new System.Windows.Forms.TextBox();
			this.label3 = new System.Windows.Forms.Label();
			this.radioTimeCustom = new System.Windows.Forms.RadioButton();
			this.radioTime24HourShort = new System.Windows.Forms.RadioButton();
			this.radioTime24HourLong = new System.Windows.Forms.RadioButton();
			this.radioTimeLongTime = new System.Windows.Forms.RadioButton();
			this.radioTimeShortTime = new System.Windows.Forms.RadioButton();
			...
			this.butSave.Location = new System.Drawing.Point(789, 432);
    ...
    "ons, ASAP List texts, and other forms of patient communication.";
			...
			this.label34.Text = "Example: MMMM d, yyyy";
			// 
			// radioDateCustom
			// 
    ...
    "";
			...
			// groupTimeFormat
			// 
			this.groupTimeFormat.Controls.Add(this.label1);
			this.groupTimeFormat.Controls.Add(this.labelTimeCustom);
			this.groupTimeFormat.Controls.Add(this.textTimeCustom);
			this.groupTimeFormat.Controls.Add(this.label3);
			this.groupTimeFormat.Controls.Add(this.radioTimeCustom);
			this.groupTimeFormat.Controls.Add(this.radioTime24HourShort);
			this.groupTimeFormat.Controls.Add(this.radioTime24HourLong);
			this.groupTimeFormat.Controls.Add(this.radioTimeLongTime);
			this.groupTimeFormat.Controls.Add(this.radioTimeShortTime);
			this.groupTimeFormat.Location = new System.Drawing.Point(12, 265);
			this.groupTimeFormat.Name = "groupTimeFormat";
			this.groupTimeFormat.Size = new System.Drawing.Size(851, 160);
			this.groupTimeFormat.TabIndex = 501;
			this.groupTimeFormat.Text = "Time Format";
			// 
			// label1
			// 
			this.label1.Location = new System.Drawing.Point(6, 16);
			this.label1.Name = "label1";
			this.label1.Size = new System.Drawing.Size(838, 13);
			this.label1.TabIndex = 315;
			this.label1.Text = "This time format will be applied to eReminders, eConfirmations, manual confirmati" +
    "ons, ASAP List texts, and other forms of patient communication.";
			// 
			// labelTimeCustom
			// 
			this.labelTimeCustom.Location = new System.Drawing.Point(217, 114);
			this.labelTimeCustom.Name = "labelTimeCustom";
			this.labelTimeCustom.Size = new System.Drawing.Size(225, 20);
			this.labelTimeCustom.TabIndex = 314;
			this.labelTimeCustom.Text = "labelTimeCustom";
			this.labelTimeCustom.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// textTimeCustom
			// 
			this.textTimeCustom.Anchor = System.Windows.Forms.AnchorStyles.Top;
			this.textTimeCustom.Location = new System.Drawing.Point(86, 114);
			this.textTimeCustom.Multiline = true;
			this.textTimeCustom.Name = "textTimeCustom";
			this.textTimeCustom.Size = new System.Drawing.Size(123, 20);
			this.textTimeCustom.TabIndex = 313;
			this.textTimeCustom.TextChanged += new System.EventHandler(this.textTimeCustom_TextChanged);
			this.textTimeCustom.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.textTimeCustom_KeyPress);
			// 
			// label3
			// 
			this.label3.Location = new System.Drawing.Point(89, 138);
			this.label3.Name = "label3";
			this.label3.Size = new System.Drawing.Size(755, 20);
			this.label3.TabIndex = 74;
			this.label3.Text = "Example: H:m:ss tt";
			// 
			// radioTimeCustom
			// 
			this.radioTimeCustom.Location = new System.Drawing.Point(15, 114);
			this.radioTimeCustom.Name = "radioTimeCustom";
			this.radioTimeCustom.Size = new System.Drawing.Size(70, 20);
			this.radioTimeCustom.TabIndex = 82;
			this.radioTimeCustom.Text = "Custom:";
			this.radioTimeCustom.UseVisualStyleBackColor = true;
			// 
			// radioTime24HourShort
			// 
			this.radioTime24HourShort.Location = new System.Drawing.Point(15, 74);
			this.radioTime24HourShort.Name = "radioTime24HourShort";
			this.radioTime24HourShort.Size = new System.Drawing.Size(438, 20);
			this.radioTime24HourShort.TabIndex = 81;
			this.radioTime24HourShort.Text = "21:45";
			this.radioTime24HourShort.UseVisualStyleBackColor = true;
			// 
			// radioTime24HourLong
			// 
			this.radioTime24HourLong.Location = new System.Drawing.Point(15, 94);
			this.radioTime24HourLong.Name = "radioTime24HourLong";
			this.radioTime24HourLong.Size = new System.Drawing.Size(438, 20);
			this.radioTime24HourLong.TabIndex = 80;
			this.radioTime24HourLong.Text = "21:45:17";
			this.radioTime24HourLong.UseVisualStyleBackColor = true;
			// 
			// radioTimeLongTime
			// 
			this.radioTimeLongTime.Location = new System.Drawing.Point(15, 54);
			this.radioTimeLongTime.Name = "radioTimeLongTime";
			this.radioTimeLongTime.Size = new System.Drawing.Size(438, 20);
			this.radioTimeLongTime.TabIndex = 79;
			this.radioTimeLongTime.Text = "9:45:17 PM";
			this.radioTimeLongTime.UseVisualStyleBackColor = true;
			this.radioTimeLongTime.Click += new System.EventHandler(this.radioTimeFormat_Click);
			// 
			// radioTimeShortTime
			// 
			this.radioTimeShortTime.Location = new System.Drawing.Point(15, 34);
			this.radioTimeShortTime.Name = "radioTimeShortTime";
			this.radioTimeShortTime.Size = new System.Drawing.Size(438, 20);
			this.radioTimeShortTime.TabIndex = 78;
			this.radioTimeShortTime.Text = "9:45 PM";
			this.radioTimeShortTime.UseVisualStyleBackColor = true;
			this.radioTimeShortTime.Click += new System.EventHandler(this.radioTimeFormat_Click);
			// 
			// FormEServicesMisc
			// 
		...
		private UI.GroupBox groupTimeFormat;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.Label labelTimeCustom;
		private System.Windows.Forms.TextBox textTimeCustom;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.RadioButton radioTimeCustom;
		private System.Windows.Forms.RadioButton radioTime24HourShort;
		private System.Windows.Forms.RadioButton radioTime24HourLong;
		private System.Windows.Forms.RadioButton radioTimeLongTime;
		private System.Windows.Forms.RadioButton radioTimeShortTime;
	}
}