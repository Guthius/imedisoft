...
public partial class FormReactivationEdit : FormODBase {
	...
	private void FormReactivationEdit_Load(object sender, System.EventArgs e) {
		...
		var dateTimeLastContacted=Reactivations.GetDateLastContacted(ReactivationCur.PatNum);
	...
	private void butSave_Click(object sender, System.EventArgs e) {
		var defSelectedStatus=comboStatus.GetSelected<Def>();//Null when 'None' is selected.
		var didStatusChange=(ReactivationCur.ReactivationStatus!=(defSelectedStatus?.DefNum??0));
