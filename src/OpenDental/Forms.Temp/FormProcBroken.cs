...
public partial class FormProcBroken:FormODBase {
	...
	private void butSave_Click(object sender,System.EventArgs e) {
		...
		if(comboProv.GetSelectedProvNum()!=_procedureOld.ProvNum && PrefC.GetBool(PrefName.ProcProvChangesClaimProcWithClaim)) {
			var listClaimProcs=ClaimProcs.GetForProc(ClaimProcs.Refresh(_procedureOld.PatNum),_procedureOld.ProcNum);
		...
		var procedureCode=ProcedureCodes.GetProcCode(_procedure.CodeNum);
		var logText=procedureCode.ProcCode+" ("+_procedure.ProcStatus+"), "+Lan.g(this,"Fee")+": "+_procedure.ProcFee.ToString("c")+", "+procedureCode.Descript;
