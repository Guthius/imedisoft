...
public partial class FormHL7DefSegmentEdit:FormODBase {
	...
	private void FormHL7DefSegmentEdit_Load(object sender,EventArgs e) {
		...
		for(var i=0;i<Enum.GetNames(typeof(SegmentNameHL7)).Length;i++) {
			comboSegmentName.Items.Add(Lan.g("enumSegmentNameHL7",Enum.GetName(typeof(SegmentNameHL7),i)));
		}
	...
	private void FillGrid() {
		...
		var col=new GridColumn(Lan.g(this,"Field Name"),180);
		...
		if(HL7DefSegmentCur!=null && HL7DefSegmentCur.hl7DefFields!=null) {
			for(var i=0;i<HL7DefSegmentCur.hl7DefFields.Count;i++) {
				var row=new GridRow();
	...
	private void butDelete_Click(object sender,EventArgs e) {
		...
		for(var f=0;f<HL7DefSegmentCur.hl7DefFields.Count;f++) {
