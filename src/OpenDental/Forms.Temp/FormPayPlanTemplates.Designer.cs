namespace OpenDental {
	partial class FormPayPlanTemplates {
		...
		private void InitializeComponent() {
			...
			// 
			this.gridPayPlanTemplates.HasMultilineHeaders = true;
			...
			this.butOK.Location = new System.Drawing.Point(949, 480);
			...
			this.butAddTemplate.Location = new System.Drawing.Point(917, 19);
