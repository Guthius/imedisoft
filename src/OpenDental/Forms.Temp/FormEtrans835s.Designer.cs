namespace OpenDental {
	partial class FormEtrans835s {
		...
		private void InitializeComponent() {
			...
			this.checkAutomatableCarriersOnly = new OpenDental.UI.CheckBox();
			this.checkShowFinalizedOnly = new OpenDental.UI.CheckBox();
			this.butAutoProcessedEras = new OpenDental.UI.Button();
			...
			// groupBox2
			// 
			this.groupBox2.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(252)))), ((int)(((byte)(253)))), ((int)(((byte)(254)))));
			...
			this.groupBox2.Size = new System.Drawing.Size(240, 42);
			...
			this.textRangeMin.Location = new System.Drawing.Point(48, 18);
			...
			this.textRangeMax.Location = new System.Drawing.Point(149, 18);
			...
			// labelDaysOldMax
			// 
			this.labelDaysOldMax.Location = new System.Drawing.Point(109, 19);
			...
			// labelDaysOldMin
			// 
			this.labelDaysOldMin.Location = new System.Drawing.Point(3, 19);
		...
		private OpenDental.UI.CheckBox checkAutomatableCarriersOnly;
		private OpenDental.UI.CheckBox checkShowFinalizedOnly;
		private UI.Button butAutoProcessedEras;
	}
}