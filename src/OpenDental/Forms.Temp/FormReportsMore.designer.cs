...
namespace OpenDental {
	public partial class FormReportsMore {
		...
		private void InitializeComponent() {
			...
			this.listArizonaPrimaryCare = new OpenDental.UI.ListBox();
			this.butLaserLabels = new OpenDental.UI.Button();
			this.listDaily = new OpenDental.UI.ListBox();
			this.listProdInc = new OpenDental.UI.ListBox();
			this.butPW = new OpenDental.UI.Button();
			this.butUserQuery = new OpenDental.UI.Button();
			this.listPublicHealth = new OpenDental.UI.ListBox();
			this.listLists = new OpenDental.UI.ListBox();
			...
			// 
			this.labelArizonaPrimaryCare.Location = new System.Drawing.Point(281, 421);
			this.labelArizonaPrimaryCare.Name = "labelArizonaPrimaryCare";
			this.labelArizonaPrimaryCare.Size = new System.Drawing.Size(156, 18);
			this.labelArizonaPrimaryCare.TabIndex = 20;
			this.labelArizonaPrimaryCare.Text = "Arizona Primary Care";
			this.labelArizonaPrimaryCare.TextAlign = System.Drawing.ContentAlignment.BottomLeft;
			...
			// labelPublicHealth
			// 
			this.labelPublicHealth.Location = new System.Drawing.Point(281, 316);
			...
			// 
			this.listArizonaPrimaryCare.Location = new System.Drawing.Point(284, 441);
			...
			// listPublicHealth
			// 
			this.listPublicHealth.Location = new System.Drawing.Point(284, 336);
			...
			this.listLists.Size = new System.Drawing.Size(242, 238);
		...
		private OpenDental.UI.ListBox listLists;
		private OpenDental.UI.ListBox listPublicHealth;
		private OpenDental.UI.Button butUserQuery;
		private OpenDental.UI.Button butPW;
		private OpenDental.UI.ListBox listProdInc;
		private Label labelProdInc;
		private OpenDental.UI.ListBox listDaily;
