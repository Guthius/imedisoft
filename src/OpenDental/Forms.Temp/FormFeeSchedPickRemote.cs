...
public partial class FormFeeSchedPickRemote:FormODBase {
	...
	public bool IsFileChosenProtected() {
		var fileNameChosen=getFileChosenName();
	...
	private void FillListFeeSchedFilesAll() {
		...
		var listAllFeeSchedFiles=new List<string>();
		...
		using(var streamReader=new StreamReader(httpWebResponse.GetResponseStream())) {
			...
			var startIndex=html.IndexOf("<body>")+6;
			var bodyLength=html.Substring(startIndex).IndexOf("</body>");
			var fileListStr=html.Substring(startIndex,bodyLength).Trim();
			var stringArrayFiles=fileListStr.Split(["\n","\r\n"],StringSplitOptions.RemoveEmptyEntries);
			for(var i=0;i<stringArrayFiles.Length;i++) {
				...
				if(stringArrayFiles[i].ToUpper().StartsWith("QC_ACDQ_")) {
					try {
						var year=SIn.Long(stringArrayFiles[i].Substring(8,4));
	...
	private void FillListFeeSchedFilesOntario() {
		_listFeeSchedFilesOntario=
		[
			"ON_ODA_2024_AN.txt", //Ontario Dental Association 2024 fee schedule for Anaesthesiologists.
			"ON_ODA_2024_EN.txt", //Ontario Dental Association 2024 fee schedule for Endodontists.
			"ON_ODA_2024_GP.txt", //Ontario Dental Association 2024 fee schedule for General Practitioners.
			"ON_ODA_2024_OS.txt", //Ontario Dental Association 2024 fee schedule for Oral & Maxillofacial Surgeons.
			"ON_ODA_2024_PA.txt", //Ontario Dental Association 2024 fee schedule for Paediatric Dentists.
			"ON_ODA_2024_PE.txt", //Ontario Dental Association 2024 fee schedule for Periodontists.
			"ON_ODA_2024_PR.txt", //Ontario Dental Association 2024 fee schedule for Prosthodontists.
			"ON_ODA_2025_AN.txt", //Ontario Dental Association 2025 fee schedule for Anaesthesiologists.
			"ON_ODA_2025_EN.txt", //Ontario Dental Association 2025 fee schedule for Endodontists.
			"ON_ODA_2025_GP.txt", //Ontario Dental Association 2025 fee schedule for General Practitioners.
			"ON_ODA_2025_OS.txt", //Ontario Dental Association 2025 fee schedule for Oral & Maxillofacial Surgeons.
			"ON_ODA_2025_PA.txt", //Ontario Dental Association 2025 fee schedule for Paediatric Dentists.
			"ON_ODA_2025_PE.txt", //Ontario Dental Association 2025 fee schedule for Periodontists.
			"ON_ODA_2025_PR.txt" //Ontario Dental Association 2025 fee schedule for Prosthodontists.
		];
	}

	private void FillListFeeSchedFilesBCDA() {
		_listFeeSchedFilesBCDA=
		[
			"BC_BCDA_2023_GP.txt", //British Columbia Dental Association 2023 fee schedule for General Practitioners.
			"BC_BCDA_2023_LTC.txt", //British Columbia Dental Association 2023 fee schedule.
			"BC_BCDA_2023_PA.txt", //British Columbia Dental Association 2023 fee schedule for Paediatric Dentists.
			"BC_BCDA_2023_PE.txt", //British Columbia Dental Association 2023 fee schedule for Periodontists.
			"BC_BCDA_2024_GP.txt", //British Columbia Dental Association 2024 fee schedule for General Practitioners.
			"BC_BCDA_2024_LTC.txt", //British Columbia Dental Association 2024 fee schedule.
			"BC_BCDA_2024_PA.txt", //British Columbia Dental Association 2024 fee schedule for Paediatric Dentists.
			"BC_BCDA_2024_PE.txt" //British Columbia Dental Association 2024 fee schedule for Periodontists.
		];
	}
