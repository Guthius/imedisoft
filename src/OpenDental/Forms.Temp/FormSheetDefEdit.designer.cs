namespace OpenDental{
	partial class FormSheetDefEdit {
		...
		private void InitializeComponent() {
			...
			this.groupAlignH = new OpenDental.UI.GroupBox();
			...
			this.groupPage = new OpenDental.UI.GroupBox();
			...
			this.listBoxFields = new OpenDental.UI.ListBox();
			...
			this.checkShowSigBox = new OpenDental.UI.CheckBox();
			this.checkShowRectangle = new OpenDental.UI.CheckBox();
			this.checkShowLine = new OpenDental.UI.CheckBox();
			this.checkShowPatImage = new OpenDental.UI.CheckBox();
			this.checkShowImage = new OpenDental.UI.CheckBox();
			this.checkShowComboBox = new OpenDental.UI.CheckBox();
			this.butShowNone = new OpenDental.UI.Button();
			this.butShowAll = new OpenDental.UI.Button();
			this.checkShowCheckBox = new OpenDental.UI.CheckBox();
			this.checkShowStaticText = new OpenDental.UI.CheckBox();
			this.checkShowInputField = new OpenDental.UI.CheckBox();
			this.checkShowOutputText = new OpenDental.UI.CheckBox();
			...
			this.groupShowField.Size = new System.Drawing.Size(40, 482);
			...
			this.checkShowMobileHeader.Location = new System.Drawing.Point(13, 461);
			...
			this.checkShowGrid.Location = new System.Drawing.Point(13, 413);
			...
			this.checkShowSpecial.Location = new System.Drawing.Point(13, 389);
			...
			this.checkShowSigBoxPractice.Location = new System.Drawing.Point(13, 353);
			...
			this.checkShowSigBox.Location = new System.Drawing.Point(13, 329);
			...
			this.checkShowRectangle.Location = new System.Drawing.Point(13, 293);
			...
			this.checkShowLine.Location = new System.Drawing.Point(13, 269);
			...
			this.checkShowPatImage.Location = new System.Drawing.Point(13, 233);
			...
			this.checkShowImage.Location = new System.Drawing.Point(13, 209);
			...
			this.checkShowComboBox.Location = new System.Drawing.Point(13, 173);
			...
			this.checkShowCheckBox.Location = new System.Drawing.Point(13, 149);
			...
			this.checkShowStaticText.Location = new System.Drawing.Point(13, 125);
			...
			this.checkShowInputField.Location = new System.Drawing.Point(13, 101);
			...
			this.checkShowOutputText.Location = new System.Drawing.Point(13, 77);
		...
		private OpenDental.UI.GroupBox groupPage;
		private OpenDental.UI.GroupBox groupAlignH;
		...
		private OpenDental.UI.GroupBox groupBoxSubViews;
		private OpenDental.UI.ComboBox comboLanguages;
		private OpenDental.UI.CheckBox checkSynchMatchedFields;
		private System.Windows.Forms.Panel panelLeft;
		private System.Windows.Forms.Panel panelRight;
		private UI.Button butUndo;
		private UI.Button butRedo;
		private UI.GroupBox groupAddField;
		...
		private OpenDental.UI.CheckBox checkShowSigBox;
		private OpenDental.UI.CheckBox checkShowRectangle;
		private OpenDental.UI.CheckBox checkShowLine;
		private OpenDental.UI.CheckBox checkShowPatImage;
		private OpenDental.UI.CheckBox checkShowImage;
		private OpenDental.UI.CheckBox checkShowComboBox;
		private UI.Button butShowNone;
		private UI.Button butShowAll;
		private OpenDental.UI.CheckBox checkShowCheckBox;
		private OpenDental.UI.CheckBox checkShowStaticText;
		private OpenDental.UI.CheckBox checkShowInputField;
		private OpenDental.UI.CheckBox checkShowOutputText;
		private OpenDental.UI.CheckBox checkShowMobileHeader;
