namespace OpenDental {
	partial class FormAdjMulti {
		...
		private void InitializeComponent() {
			...
			this.listTypePos = new OpenDental.UI.ListBox();
			...
			this.gridMain.Location = new System.Drawing.Point(31, 230);
			this.gridMain.Name = "gridMain";
			this.gridMain.SelectionMode = OpenDental.UI.GridSelectionMode.MultiExtended;
			this.gridMain.Size = new System.Drawing.Size(712, 279);
			this.gridMain.TabIndex = 1;
			this.gridMain.Title = "Account Entries";
			...
			this.butAdd.Location = new System.Drawing.Point(780, 230);
			...
			this.butPickProv.Click += new System.EventHandler(this.ButtonPickProv_Click);
			// 
			// dateAdjustment
			// 
			...
			this.radioFixedAmt.CheckedChanged += new System.EventHandler(this.RadioButtonFixedAmt_CheckedChanged);
			// 
			// radioPercentRemBal
			// 
			...
			this.listTypePos.SelectedIndexChanged += new System.EventHandler(this.ListBoxTypePos_SelectedIndexChanged);
			// 
			// labelAdditions
			// 
			...
			this.listTypeNeg.SelectedIndexChanged += new System.EventHandler(this.ListBoxTypeNeg_SelectedIndexChanged);
			// 
			// groupBox3
			// 
			...
			this.radioIncludeAll.Click += new System.EventHandler(this.RadioButtonCredits_Click);
			// 
			// radioAllocatedOnly
			// 
			...
			this.radioAllocatedOnly.Click += new System.EventHandler(this.RadioButtonCredits_Click);
			// 
			// radioExcludeAll
			// 
			...
			this.radioExcludeAll.Click += new System.EventHandler(this.RadioButtonCredits_Click);
			// 
			// groupCreditLogic
			// 
			...
			this.butUpdate.Location = new System.Drawing.Point(780, 358);
			this.butUpdate.Name = "butUpdate";
			this.butUpdate.Size = new System.Drawing.Size(76, 24);
			this.butUpdate.TabIndex = 173;
