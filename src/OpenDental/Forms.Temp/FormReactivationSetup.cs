...
public partial class FormReactivationSetup : FormODBase {
	...
	private void FillGrid(){
		var availableFields="[NameFL], [NameF], [ClinicName], [ClinicPhone], [PracticeName], [PracticePhone], [OfficePhone]";
		gridMain.BeginUpdate();
		gridMain.Columns.Clear();
		var col=new GridColumn(Lan.g("TableReactivationMsgs","Mode"),61);
	...
	private void gridMain_CellDoubleClick(object sender,ODGridClickEventArgs e) {
		var prefName=gridMain.SelectedTag<PrefName>();
