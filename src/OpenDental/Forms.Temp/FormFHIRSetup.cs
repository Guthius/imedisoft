...
public partial class FormFHIRSetup:FormODBase {
	...
	private void FormFHIRSetup_Load(object sender,EventArgs e) {
		var program=Programs.GetCur(ProgramName.FHIR);
	...
	private void FillGrid() {
		...
		GridRow row;
		for(var i=0;i<_listApiKeyVisibleInfos.Count;i++) {
			row=new GridRow();
	...
	private void butAddKey_Click(object sender,EventArgs e) {
		using var formFHIRAssignKey=new FormFHIRAssignKey();
	...
	private void gridMain_CellDoubleClick(object sender,ODGridClickEventArgs e) {
		using var formFHIRAPIKeyEdit=new FormFHIRAPIKeyEdit((ApiKeyVisibleInfo)gridMain.ListGridRows[e.Row].Tag);
	...
	private void SetPermissions() {
		...
		var apiKeyPair=(ApiKeyVisibleInfo)gridMain.ListGridRows[gridMain.SelectedIndices[0]].Tag;
	...
	private void butSave_Click(object sender,EventArgs e) {
		...
		var programProperty=ProgramProperties.GetPropByDesc("SubscriptionProcessingFrequency",ProgramProperties.GetForProgram(program.ProgramNum));
	...
	private void butViewLicense_Click(object sender,EventArgs e) {
		using var formLicense=new FormLicense(Properties.Resources.OpenDentalApiEndUserLicense);
