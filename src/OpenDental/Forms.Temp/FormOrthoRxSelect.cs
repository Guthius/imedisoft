...
public partial class FormOrthoRxSelect:FormODBase {
	...
	private void FillLists(){
		...
		_listOrthoRxsAvail= [];
		for(var i=0;i<_listOrthoRxsAll.Count;i++){
	...
	private void butRemove_Click(object sender,EventArgs e) {
		...
		for(var i=listBoxSelected.SelectedIndices.Count-1;i>=0;i--){//backwards
	...
	private void butSelect_Click(object sender,EventArgs e) {
		...
		for(var i=0;i<listBoxAvail.SelectedIndices.Count;i++){
