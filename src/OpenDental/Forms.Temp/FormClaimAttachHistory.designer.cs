namespace OpenDental {
	partial class FormClaimAttachHistory {
		...
		private void InitializeComponent() {
			...
			this.gridMain.Location = new System.Drawing.Point(14, 41);
			this.gridMain.Name = "gridMain";
			this.gridMain.SelectionMode = OpenDental.UI.GridSelectionMode.MultiExtended;
			this.gridMain.Size = new System.Drawing.Size(353, 440);
			this.gridMain.TabIndex = 49;
			this.gridMain.Title = "Attachment Images Sent";
			...
			this.label1.Text = "Dental X Change uses the concept of one attachment with multiple images";
			// 
