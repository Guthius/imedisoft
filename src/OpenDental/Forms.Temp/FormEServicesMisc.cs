...
public partial class FormEServicesMisc:FormODBase {
	...
	private void FormEServicesMisc_Load(object sender,EventArgs e) {
		...
		var formatDate=PrefC.GetString(PrefName.PatientCommunicationDateFormat);
		...
		var formatTime=PrefC.GetString(PrefName.PatientCommunicationTimeFormat);
	...
	private void SaveTabMisc() {
		...
		var formatDateOld=PrefC.GetString(PrefName.PatientCommunicationDateFormat);
		...
		var formatTimeOld=PrefC.GetString(PrefName.PatientCommunicationTimeFormat);
