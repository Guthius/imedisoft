...
public partial class FormScreenEdit : FormODBase {
	...
	private void FormScreenEdit_Load(object sender, System.EventArgs e) {
		...
		comboGradeLevel.Items.AddList(Enum.GetNames(typeof(PatientGrade)));
	...
	private void SetCheckState(UI.CheckBox checkBox,YN state){
		switch(state){
			case YN.Unknown:
	...
	private YN GetCheckState(UI.CheckBox checkBox){
