	...
	private void butAdd_Click(object sender,EventArgs e) {
		...
		if(hasEdgeExpress) {
			...
			try {
				...
				//Card Not Present API
					...
					var xWebResponseProcessed=EdgeExpress.CNP.ProcessTransaction(xWebResponse,null,doCreatePayment:false);
		...
		if(hasXCharge) {
			...
			try {
				...
				var errMsg=Lans.g("There was a problem adding the credit card.  Please try again.");
