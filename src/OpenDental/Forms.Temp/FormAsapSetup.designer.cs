namespace OpenDental{
	partial class FormAsapSetup {
		...
		private void InitializeComponent() {
			...
			this.comboClinic.SelectedIndexChanged += new System.EventHandler(this.ComboBoxClinic_SelectedIndexChanged);
			// 
			// gridMain
			// 
			...
			this.checkUseDefaults.Click += new System.EventHandler(this.CheckBoxUseDefaults_Click);
			// 
			// textWebSchedPerDay
			// 
			...
			this.textWebSchedPerDay.Validating += new System.ComponentModel.CancelEventHandler(this.TextBoxWebSchedPerDay_Validating);
    ...
    "nt is broken";
			this.checkAsapPromptEnabled.Click += new System.EventHandler(this.CheckBoxAsapPromptEnabled_Click);
			// 
			// groupBoxASAPPrompt
			// 
