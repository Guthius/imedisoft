namespace OpenDental {
	partial class FormRecallList {
		...
		private void InitializeComponent()
		{
			...
			this.groupSetStatusRecalls = new OpenDental.UI.GroupBox();
			this.comboSetStatusRecalls = new OpenDental.UI.ComboBox();
			...
			this.groupViewRecalls = new OpenDental.UI.GroupBox();
			this.comboShowReminders = new OpenDental.UI.ComboBox();
			this.comboProviderRecalls = new OpenDental.UI.ComboBox();
			this.comboRecallTypes = new OpenDental.UI.ComboBox();
			this.labelRecallTypes = new System.Windows.Forms.Label();
			this.checkIncludeReminded = new OpenDental.UI.CheckBox();
			this.labelSortRecalls = new System.Windows.Forms.Label();
			this.comboSiteRecalls = new OpenDental.UI.ComboBox();
			...
			this.checkShowConflictingTypes = new OpenDental.UI.CheckBox();
			this.butRefreshRecalls = new OpenDental.UI.Button();
			this.labelShowReminders = new System.Windows.Forms.Label();
			this.checkGroupFamiliesRecalls = new OpenDental.UI.CheckBox();
			this.datePickerRecalls = new OpenDental.UI.ODDateRangePicker();
			this.comboSortRecalls = new OpenDental.UI.ComboBox();
			this.tabPageReminders = new OpenDental.UI.TabPage();
			this.gridReminders = new OpenDental.UI.GridOD();
			this.groupViewRemind = new OpenDental.UI.GroupBox();
			...
			this.tabPageReactivations = new OpenDental.UI.TabPage();
			this.groupEmailFromReact = new OpenDental.UI.GroupBox();
			this.comboEmailFromReact = new OpenDental.UI.ComboBox();
			...
			this.groupSetStatusReact = new OpenDental.UI.GroupBox();
			this.comboSetStatusReact = new OpenDental.UI.ComboBox();
			this.butSetStatusReact = new OpenDental.UI.Button();
			this.groupViewReact = new OpenDental.UI.GroupBox();
			this.comboProviderReact = new OpenDental.UI.ComboBox();
			this.datePickerReact = new OpenDental.UI.ODDateRangePicker();
			this.checkExcludeInactive = new OpenDental.UI.CheckBox();
			this.checkShowDoNotContact = new OpenDental.UI.CheckBox();
			this.checkGroupFamiliesReact = new OpenDental.UI.CheckBox();
			this.comboBillingTypes = new OpenDental.UI.ComboBox();
			this.labelBillingTypes = new System.Windows.Forms.Label();
			this.comboShowReactivate = new OpenDental.UI.ComboBox();
			this.labelShowReactivate = new System.Windows.Forms.Label();
			this.comboSortReact = new OpenDental.UI.ComboBox();
			this.labelSortByReact = new System.Windows.Forms.Label();
			this.comboSiteReact = new OpenDental.UI.ComboBox();
		...
		private OpenDental.UI.GroupBox groupSetStatusRecalls;
		...
		private OpenDental.UI.GroupBox groupViewRecalls;
		private OpenDental.UI.CheckBox checkShowConflictingTypes;
		...
		private OpenDental.UI.CheckBox checkGroupFamiliesRecalls;
		private OpenDental.UI.Button butRefreshRecalls;
		private OpenDental.UI.TabPage tabPageReminders;
		private OpenDental.UI.GridOD gridReminders;
		private OpenDental.UI.GroupBox groupViewRemind;
		...
		private OpenDental.UI.TabPage tabPageReactivations;
		private System.Windows.Forms.Label labelReactPatCount;
		private OpenDental.UI.GroupBox groupSetStatusReact;
		private OpenDental.UI.Button butSetStatusReact;
		private OpenDental.UI.GroupBox groupViewReact;
		...
		private OpenDental.UI.CheckBox checkShowDoNotContact;
		private UI.ComboBox comboSetStatusReact;
		private OpenDental.UI.CheckBox checkGroupFamiliesReact;
		...
		private OpenDental.UI.GroupBox groupEmailFromReact;
		private OpenDental.UI.ComboBox comboEmailFromReact;
		private UI.GridOD gridReactivations;
		private OpenDental.UI.CheckBox checkIncludeReminded;
