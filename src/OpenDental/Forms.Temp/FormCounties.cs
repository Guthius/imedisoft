...
public partial class FormCounties : FormODBase {
	...
	private void FillList(){
		...
		var countyInfo="";
		for(var i=0;i<_listCounties.Count;i++){
	...
	private void listCounties_DoubleClick(object sender, System.EventArgs e) {
		...
		var frmCountyEdit=new FrmCountyEdit();
	...
	private void butDelete_Click(object sender, System.EventArgs e) {
		...
		var county=_listCounties[listCounties.SelectedIndex];
		var usedBy=Counties.UsedBy(county.CountyName);
		if(usedBy != ""){
