...
namespace OpenDental {
	public partial class FormRpOutstandingIns {
		...
		private void InitializeComponent() {
			...
			this.comboPreauthOptions = new OpenDental.UI.ComboBox();
			this.tabControlDate = new OpenDental.UI.TabControl();
			this.tabDaysOld = new OpenDental.UI.TabPage();
			...
			this.butZeroClaims = new OpenDental.UI.Button();
			...
			this.label2.Location = new System.Drawing.Point(1080, 668);
			...
			this.textBox1.Location = new System.Drawing.Point(1143, 666);
			...
			this.groupBox2.Size = new System.Drawing.Size(1098, 90);
			...
			this.tabControlDate.Location = new System.Drawing.Point(6, 19);
			this.tabControlDate.Name = "tabControlDate";
			this.tabControlDate.PaddingTabPages = 1;
			this.tabControlDate.Size = new System.Drawing.Size(231, 67);
			...
			this.tabDaysOld.Location = new System.Drawing.Point(1, 20);
			this.tabDaysOld.Name = "tabDaysOld";
			this.tabDaysOld.Padding = new System.Windows.Forms.Padding(3);
			this.tabDaysOld.Size = new System.Drawing.Size(229, 46);
			this.tabDaysOld.TabIndex = 0;
			this.tabDaysOld.Text = "Days Old";
			// 
			// textDaysOldMax
			// 
			this.textDaysOldMax.Location = new System.Drawing.Point(90, 23);
			...
			// labelDaysOldMax
			// 
			this.labelDaysOldMax.Location = new System.Drawing.Point(2, 21);
			...
			// textDaysOldMin
			// 
			this.textDaysOldMin.Location = new System.Drawing.Point(90, 2);
			...
			// 
			this.labelDateMinMaxAdvice.Location = new System.Drawing.Point(158, -3);
			...
			// labelDaysOldMin
			// 
			this.labelDaysOldMin.Location = new System.Drawing.Point(2, 2);
			...
			this.tabDateRange.Location = new System.Drawing.Point(1, 20);
			this.tabDateRange.Name = "tabDateRange";
			this.tabDateRange.Padding = new System.Windows.Forms.Padding(3);
			this.tabDateRange.Size = new System.Drawing.Size(229, 46);
			...
			this.dateRangePicker.Location = new System.Drawing.Point(3, 0);
			...
			this.dateRangePicker.CalendarClosed += new System.EventHandler(this.dateRangePicker_CalendarClosed);
			this.dateRangePicker.CalendarSelectionChanged += new System.EventHandler(this.dateRangePicker_CalendarSelectionChanged);
			// 
			// comboDateFilterBy
			// 
			...
			this.groupBoxUpdateCustomTracking.Location = new System.Drawing.Point(825, 618);
			...
			this.groupBox1.Location = new System.Drawing.Point(171, 618);
			...
			this.groupBox3.Location = new System.Drawing.Point(498, 618);
			...
			// butZeroClaims
			// 
			this.butZeroClaims.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.butZeroClaims.Location = new System.Drawing.Point(92, 630);
			this.butZeroClaims.Name = "butZeroClaims";
			this.butZeroClaims.Size = new System.Drawing.Size(75, 24);
			this.butZeroClaims.TabIndex = 261;
			this.butZeroClaims.Text = "Zero Claims";
			this.butZeroClaims.Click += new System.EventHandler(this.butZeroClaims_Click);
			// 
			// FormRpOutstandingIns
			// 
			this.ClientSize = new System.Drawing.Size(1230, 729);
			this.Controls.Add(this.butZeroClaims);
		...
		private OpenDental.UI.CheckBox checkIgnoreCustom;
		...
		private UI.ComboBox comboLastClaimTrack;
		private OpenDental.UI.GroupBox groupBoxUpdateCustomTracking;
		private Label labelCustomTracking;
		private Label label3;
		private UI.ComboBox comboErrorDef;
		private Label labelForUser;
		private UI.Button butPickUser;
		private UI.Button butAssignUser;
		private UI.ComboBox comboUserAssigned;
		...
		private UI.ComboBox comboDateFilterBy;
		private OpenDental.UI.TabControl tabControlDate;
		private OpenDental.UI.TabPage tabDaysOld;
