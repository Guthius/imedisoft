...
namespace OpenDental {
	public partial class FormRpPaySheet {
		...
		private void InitializeComponent()
		{
			...
			this.checkShowProvSeparate = new OpenDental.UI.CheckBox();
			this.radioPatient = new System.Windows.Forms.RadioButton();
			this.radioCheck = new System.Windows.Forms.RadioButton();
			this.checkPatientTypes = new OpenDental.UI.CheckBox();
			this.listPatientTypes = new OpenDental.UI.ListBox();
			this.checkInsuranceTypes = new OpenDental.UI.CheckBox();
			...
			this.listClaimPayGroups = new OpenDental.UI.ListBox();
			...
			this.checkShowMerchantFees = new OpenDental.UI.CheckBox();
			...
			// 
			// checkShowMerchantFees
			// 
			this.checkShowMerchantFees.CheckAlign = System.Drawing.ContentAlignment.TopLeft;
			this.checkShowMerchantFees.Location = new System.Drawing.Point(26, 442);
			this.checkShowMerchantFees.Name = "checkShowMerchantFees";
			this.checkShowMerchantFees.Size = new System.Drawing.Size(159, 18);
			this.checkShowMerchantFees.TabIndex = 62;
			this.checkShowMerchantFees.Text = "Show merchant fees";
			// 
			// FormRpPaySheet
			// 
			this.ClientSize = new System.Drawing.Size(844, 507);
			this.Controls.Add(this.checkShowMerchantFees);
		...
		private OpenDental.UI.CheckBox checkPatientTypes;
		private OpenDental.UI.ListBox listPatientTypes;
		private OpenDental.UI.CheckBox checkInsuranceTypes;
		private OpenDental.UI.CheckBox checkAllClin;
		private OpenDental.UI.ListBox listClin;
		private Label labelClin;
		private OpenDental.UI.ListBox listInsuranceTypes;
		private OpenDental.UI.CheckBox checkAllProv;
		private OpenDental.UI.CheckBox checkAllClaimPayGroups;
		private OpenDental.UI.ListBox listClaimPayGroups;
		private OpenDental.UI.CheckBox checkUnearned;
		...
		private UI.CheckBox checkShowMerchantFees;
	}
}
