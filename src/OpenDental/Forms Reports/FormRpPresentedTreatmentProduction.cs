...
public partial class FormRpPresentedTreatmentProduction:FormODBase {
	...
	private void RunTotals(List<long> listUserNums,List<long> listClinicsNums) {
		...
		if(checkAllUsers.Checked) {
			...
			var strUsers="";
			for(var i=0;i<listUser.SelectedIndices.Count;i++) {
				if(i==0) {
		...
		var table=RpPresentedTreatmentProduction.GetPresentedTreatmentProductionTable(date1.SelectionStart,date2.SelectionStart,listClinicsNums,checkAllClinics.Checked
			,true,radioPresenter.Checked,radioFirstPresented.Checked,listUserNums,false);
	...
	private void RunDetailed(List<long> listUserNums,List<long> listClinicsNums) {
		...
		var tableReport=RpPresentedTreatmentProduction.GetPresentedTreatmentProductionTable(date1.SelectionStart,date2.SelectionStart,listClinicsNums,checkAllClinics.Checked
			,true,radioPresenter.Checked,radioFirstPresented.Checked,listUserNums,true);
		var query=report.AddQuery(tableReport,"","",SplitByKind.None,1,true);
	...
	private void butOK_Click(object sender,EventArgs e) {
		...
		if(true && !checkAllClinics.Checked && listClin.SelectedIndices.Count==0) {
