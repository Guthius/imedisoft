...
public partial class FormRpWriteoffSheet : FormODBase {
	...
	private void butOK_Click(object sender,System.EventArgs e) {
		...
		if(writeoffType==PPOWriteoffDateCalc.ClaimPayDate) {
			query.AddGroupSummaryField("Write-off (Write-off Estimate + Write-off Adjustment)","Provider","$writeoff",SummaryOperation.Sum, [0],Color.Black,new Font("Tahoma",9,FontStyle.Bold),0,50);
		}
