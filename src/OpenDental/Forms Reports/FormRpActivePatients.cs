...
public partial class FormRpActivePatients:FormODBase {
	...
	private void butOK_Click(object sender,EventArgs e) {
		...
		var listBillingTypeDefNums=new List<long>();
