...
namespace OpenDental{
	...
	public partial class FormRpAccountingProfitLoss:FormODBase {
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			DataTable tableIncome=Accounts.GetAccountTotalByType(monthCalendarStart.GetDateSelected(),monthCalendarEnd.GetDateSelected(), AccountType.Income);
			DataTable tableExpenses=Accounts.GetAccountTotalByType(monthCalendarStart.GetDateSelected(),monthCalendarEnd.GetDateSelected(), AccountType.Expense);
