...
public partial class FormRpInsOverpaid:FormODBase {
	...
	private void butOK_Click(object sender, System.EventArgs e) {
		...
		var tableOverpaid=RpInsOverpaid.GetInsuranceOverpaid(dateStart.SelectionStart,dateEnd.SelectionStart,listClinicNums,
		...
		var query=report.AddQuery(tableOverpaid,DateTime.Today.ToShortDateString());
