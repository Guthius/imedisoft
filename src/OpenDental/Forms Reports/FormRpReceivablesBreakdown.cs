		...
		private void butOK_Click(object sender,System.EventArgs e) {
			...
			for(int j = 0;j <= 1;j++) {
				...
				if(isPayPlan2) {
					...
					DataTable TablePayPlanCreditDynamic=RpReceivablesBreakdown.GetRecvBreakdownTable(date1.SelectionStart,listProvNums,radioWriteoffPay.Checked,isPayPlan2,wDate,eDate,bDate,"TablePayPlanCreditDynamic");
					for(int i=0;i<TablePayPlanCreditDynamic.Rows.Count;i++) {
