...
public partial class FormRpReferralAnalysis:FormODBase {
	...
	private void butOK_Click(object sender, System.EventArgs e) {
		...
		var listProvNames=new List<string>();
		if(listProv.SelectedIndices[0]==0) {
			listProv.ClearSelected();
			for(var i=1;i<listProv.Items.Count;i++) {//Start i at 1 due to the 'All' option.
		...
		var table=RpReferralAnalysis.GetReferralTable(dateFrom,dateTo,listProvNums,checkAddress.Checked,checkNewPat.Checked);
