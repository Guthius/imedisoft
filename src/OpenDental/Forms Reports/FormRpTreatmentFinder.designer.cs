...
namespace OpenDental {
	public partial class FormRpTreatmentFinder {
		...
		private void InitializeComponent(){
			...
			this.checkIncludeNoIns = new OpenDental.UI.CheckBox();
			this.groupBox1 = new OpenDental.UI.GroupBox();
			this.label5 = new System.Windows.Forms.Label();
			this.checkUseTreatingProvider = new OpenDental.UI.CheckBox();
			this.comboClinics = new OpenDental.UI.ComboBoxClinicPicker();
			this.codeRangeFilter = new OpenDental.UI.ODCodeRangeFilter();
			this.checkBenefitAssumeGeneral = new OpenDental.UI.CheckBox();
			...
			this.checkIncludePatsWithApts = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkIncludePatsWithApts;
		private OpenDental.UI.CheckBox checkBenefitAssumeGeneral;
		private UI.ODCodeRangeFilter codeRangeFilter;
		private OpenDental.UI.CheckBox checkUseTreatingProvider;
		...
		private OpenDental.UI.CheckBox checkIncludeHiddenBillingTypes;
	}
}
