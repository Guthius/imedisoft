...
public partial class FormRpDentalSealantMeasure:FormODBase {
	...
	private void butOK_Click(object sender,EventArgs e) {
		...
		var tableMeasures=RpDentalSealantMeasure.GetDentalSealantMeasureTable(textYear.Text);
		var tableTotals=tableMeasures.Clone();
		var totalsRow=tableTotals.NewRow();
		var numerator=0;
		var denominator=0;
