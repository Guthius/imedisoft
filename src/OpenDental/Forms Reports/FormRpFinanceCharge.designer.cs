...
namespace OpenDental {
	public partial class FormRpFinanceCharge {
		...
		private void InitializeComponent(){
			...
			this.listBillingType = new OpenDental.UI.ListBox();
			this.checkAllProv = new OpenDental.UI.CheckBox();
			this.checkAllBilling = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.ListBox listBillingType;
		private OpenDental.UI.CheckBox checkAllProv;
		private OpenDental.UI.CheckBox checkAllBilling;
