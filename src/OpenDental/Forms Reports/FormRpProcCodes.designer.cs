...
namespace OpenDental {
	public partial class FormRpProcCodes {
		...
		private void InitializeComponent()
		{
			...
			this.listBoxProviders = new OpenDental.UI.ListBox();
			this.label2 = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.checkShowBlankFees = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.ListBox listBoxClinics;
		private OpenDental.UI.ListBox listBoxProviders;
		private Label label2;
		private Label label3;
		private OpenDental.UI.CheckBox checkShowBlankFees;
