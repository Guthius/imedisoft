...
namespace OpenDental {
	public partial class FormRpPayPlans {
		...
		private void InitializeComponent()
		{
			...
			this.checkShowFamilyBalance = new OpenDental.UI.CheckBox();
			this.checkAllClin = new OpenDental.UI.CheckBox();
			this.listClin = new OpenDental.UI.ListBox();
			this.labelClin = new System.Windows.Forms.Label();
			this.checkHasDateRange = new OpenDental.UI.CheckBox();
		...
		private OpenDental.UI.CheckBox checkShowFamilyBalance;
		private OpenDental.UI.CheckBox checkAllClin;
		private OpenDental.UI.ListBox listClin;
		private Label labelClin;
		private OpenDental.UI.CheckBox checkHasDateRange;
