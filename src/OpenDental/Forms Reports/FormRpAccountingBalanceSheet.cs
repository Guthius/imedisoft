...
public partial class FormRpAccountingBalanceSheet:FormODBase {
	...
	private void butOK_Click(object sender, System.EventArgs e) {
		...
		var tableAssets=Accounts.GetAccountTotalByType(monthCalendar.GetDateSelected(),AccountType.Asset);
		var tableLiabilities=Accounts.GetAccountTotalByType(monthCalendar.GetDateSelected(),AccountType.Liability);
		var tableEquity=Accounts.GetAccountTotalByType(monthCalendar.GetDateSelected(),AccountType.Equity);
		...
		tableEquity.LoadDataRow(["NetIncomeThisYear",Accounts.NetIncomeThisYear(monthCalendar.GetDateSelected())], LoadOption.OverwriteChanges);
