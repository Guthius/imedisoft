...
namespace OpenDental {
	public partial class FormRpReferralAnalysis {
		...
		private void InitializeComponent(){
			...
			this.checkAddress = new OpenDental.UI.CheckBox();
			this.label5 = new System.Windows.Forms.Label();
			this.butOK = new OpenDental.UI.Button();
			this.checkNewPat = new OpenDental.UI.CheckBox();
			this.checkLandscape = new OpenDental.UI.CheckBox();
    ...
    "t necessarily everyone.";
			...
			this.butOK.Location = new System.Drawing.Point(568, 377);
			...
			this.checkNewPat.Size = new System.Drawing.Size(350, 18);
			...
			this.checkLandscape.Size = new System.Drawing.Size(350, 18);
		...
		private OpenDental.UI.CheckBox checkAddress;
		private Label label5;
		private OpenDental.UI.CheckBox checkNewPat;
		private OpenDental.UI.CheckBox checkLandscape;
	}
}
