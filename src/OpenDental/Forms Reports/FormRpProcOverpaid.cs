...
public partial class FormRpProcOverpaid: FormODBase {
	...
	private void FillGrid() {
		...
		if(gridMain.Columns.Count==0) {
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Patient"),_colWidthPatName,GridSortingStrategy.StringCompare));
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Date"),_colWidthProcDate,HorizontalAlignment.Center,GridSortingStrategy.DateParse));
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Code"),_colWidthProcCode,GridSortingStrategy.StringCompare));
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Tth"),_colWidthProcTth,GridSortingStrategy.StringCompare));
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Prov"),_colWidthProv,GridSortingStrategy.StringCompare));
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Fee"),_colWidthFee,HorizontalAlignment.Right,GridSortingStrategy.AmountParse));
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Ins Paid"),_colWidthInsPay,HorizontalAlignment.Right,GridSortingStrategy.AmountParse));
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Write-off"),_colWidthWO,HorizontalAlignment.Right,GridSortingStrategy.AmountParse));
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Pt Paid"),_colWidthPtPaid,HorizontalAlignment.Right,GridSortingStrategy.AmountParse));
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Adjust"),_colWidthAdj,HorizontalAlignment.Right,GridSortingStrategy.AmountParse));
			gridMain.Columns.Add(new GridColumn(Lan.g(this,"Overpayment"),_colWidthOverpay,HorizontalAlignment.Right,GridSortingStrategy.AmountParse));
		}
		...
		for(var i = 0;i<_myReport.ReportObjects.Count;i++) {
			...
			for(var j = 0;j<queryObj.ReportTable.Rows.Count;j++) {
				var rowCur=queryObj.ReportTable.Rows[j];
				row=new GridRow();
	...
	private void RefreshReport() {
		...
		var tableOverpaidProcs=new DataTable();
		var listSelectedProvNums=comboBoxMultiProv.GetSelectedProvNums();
		...
		var subTitleProviders=Lan.g(this,"All Providers");
		...
		var subtitleClinics=comboBoxMultiClinics.GetStringSelectedClinics();
		...
		var query=_myReport.AddQuery(tableOverpaidProcs,DateTime.Today.ToShortDateString());
