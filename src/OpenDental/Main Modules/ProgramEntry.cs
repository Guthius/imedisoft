...
namespace OpenDental {
	static class ProgramEntry {
		...
		static void Main(string[] args) {
			//WPF software mode. This fixes a bug that causes empty windows on a small percentage of computers, typically laptops.
			//Later will will give users a choice per computer somehow. 
			//Defaulting to software might be the safest for most users.
			//But the imaging module will need to default to hardware. It works fine to have different windows software vs hardware.
