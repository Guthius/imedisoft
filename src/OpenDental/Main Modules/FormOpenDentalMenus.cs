...
namespace OpenDental{
	partial class FormOpenDental {
		...
		private void LayoutMenuSetup(MenuItemOD menuItemSetup) {
			//Preferences-----------------------------------------------------------------------------------------------------
			MenuItemOD menuItemPrefences=new MenuItemOD("Preferences",menuItemPreferences_Click);
		...
		private void LayoutMenuHelp(MenuItemOD menuItemHelp) {
			...
			_menuItemRemoteSupport=new MenuItemOD("Remote Support",menuItemRemoteSupport_Click);
			menuItemHelp.Add(_menuItemRemoteSupport);
