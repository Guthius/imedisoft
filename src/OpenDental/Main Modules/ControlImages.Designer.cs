namespace OpenDental
{
	partial class ControlImages
	{
		...
		private void InitializeComponent()
		{
			...
			this.controlImageDock = new OpenDental.ControlImageDock();
			...
			this.panelAILayers = new System.Windows.Forms.Panel();
			this.groupAILayers = new OpenDental.UI.GroupBox();
			this.labelAIProcessing = new System.Windows.Forms.Label();
			this.butAILayers = new OpenDental.UI.Button();
			this.checkShow = new OpenDental.UI.CheckBox();
			this.checkToothParts = new OpenDental.UI.CheckBox();
			this.panelNote.SuspendLayout();
			this.panelImportAuto.SuspendLayout();
			this.panelDraw.SuspendLayout();
			this.panelAILayers.SuspendLayout();
			this.groupAILayers.SuspendLayout();
			this.SuspendLayout();
			// 
			// imageListTools2
			// 
    ...
    "les will be ignored.  Imported files will be deleted.";
			...
			this.elementHostImageSelector.Size = new System.Drawing.Size(200, 365);
			...
			// controlImageDock
			// 
			this.controlImageDock.AllowDrop = true;
			this.controlImageDock.BackColor = System.Drawing.Color.White;
			this.controlImageDock.Location = new System.Drawing.Point(254, 192);
			this.controlImageDock.Name = "controlImageDock";
			this.controlImageDock.Size = new System.Drawing.Size(813, 240);
			this.controlImageDock.TabIndex = 20;
			this.controlImageDock.Paint += new System.Windows.Forms.PaintEventHandler(this.panelMain_Paint);
			// 
			...
			// panelAILayers
			// 
			this.panelAILayers.Controls.Add(this.groupAILayers);
			this.panelAILayers.Location = new System.Drawing.Point(15, 522);
			this.panelAILayers.Name = "panelAILayers";
			this.panelAILayers.Size = new System.Drawing.Size(200, 62);
			this.panelAILayers.TabIndex = 54;
			this.panelAILayers.Visible = false;
			// 
			// groupAILayers
			// 
			this.groupAILayers.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.groupAILayers.Controls.Add(this.labelAIProcessing);
			this.groupAILayers.Controls.Add(this.butAILayers);
			this.groupAILayers.Controls.Add(this.checkShow);
			this.groupAILayers.Controls.Add(this.checkToothParts);
			this.groupAILayers.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.groupAILayers.Location = new System.Drawing.Point(3, 3);
			this.groupAILayers.Name = "groupAILayers";
			this.groupAILayers.Size = new System.Drawing.Size(194, 56);
			this.groupAILayers.TabIndex = 3;
			this.groupAILayers.Text = "Pearl AI";
			// 
			// labelAIProcessing
			//
			...
			// butAILayers
			// 
			this.butAILayers.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.butAILayers.Location = new System.Drawing.Point(137, 16);
			this.butAILayers.Name = "butAILayers";
			this.butAILayers.Size = new System.Drawing.Size(54, 24);
			this.butAILayers.TabIndex = 2;
			this.butAILayers.Text = "Layers";
			this.butAILayers.UseVisualStyleBackColor = true;
			this.butAILayers.Click += new System.EventHandler(this.butAILayers_Click);
			// 
			// checkShow
			// 
			this.checkShow.Checked = true;
			this.checkShow.CheckState = System.Windows.Forms.CheckState.Checked;
			this.checkShow.Location = new System.Drawing.Point(7, 17);
			this.checkShow.Name = "checkShow";
			this.checkShow.Size = new System.Drawing.Size(83, 18);
			...
			// checkToothParts
			// 
			this.checkToothParts.Location = new System.Drawing.Point(7, 35);
			this.checkToothParts.Name = "checkToothParts";
			this.checkToothParts.Size = new System.Drawing.Size(83, 18);
			this.checkToothParts.TabIndex = 1;
			this.checkToothParts.Text = "Tooth Parts";
			this.checkToothParts.Click += new System.EventHandler(this.checkToothParts_Click);
			// 
			// ControlImages
			// 
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.None;
			this.Controls.Add(this.panelAILayers);
			...
			this.Controls.Add(this.controlImageDock);
			...
			this.panelAILayers.ResumeLayout(false);
			this.groupAILayers.ResumeLayout(false);
		...
		private OpenDental.ControlImageDock controlImageDock;
		...
		private System.Windows.Forms.Panel panelAILayers;
		private UI.CheckBox checkToothParts;
		private UI.CheckBox checkShow;
		private UI.GroupBox groupAILayers;
		private UI.Button butAILayers;
