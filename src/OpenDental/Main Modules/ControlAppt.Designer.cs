namespace OpenDental {
	partial class ControlAppt {
		...
		private void InitializeComponent() {
			...
			this.tabWaiting = new OpenDental.UI.TabPage();
			this.gridWaiting = new OpenDental.UI.GridOD();
			this.tabSched = new OpenDental.UI.TabPage();
			this.gridEmpSched = new OpenDental.UI.GridOD();
			this.tabProv = new OpenDental.UI.TabPage();
			...
			this.listSearchResults = new OpenDental.UI.ListBox();
			this._listBoxProviders = new OpenDental.UI.ListBox();
			...
			this.toggleDayWeek = new OpenDental.UI.ToggleDayWeek();
			...
			this.listConfirmed = new OpenDental.UI.ListBox();
			...
			this.panelCalendarLower.Controls.Add(this.toggleDayWeek);
			...
			// toggleDayWeek
			// 
			this.toggleDayWeek.Location = new System.Drawing.Point(17, 27);
			this.toggleDayWeek.Name = "toggleDayWeek";
			this.toggleDayWeek.Size = new System.Drawing.Size(80, 40);
			this.toggleDayWeek.TabIndex = 99;
			this.toggleDayWeek.DayClick += new System.EventHandler(this.toggleDayWeek_DayClick);
			this.toggleDayWeek.WeekClick += new System.EventHandler(this.toggleDayWeek_WeekClick);
			// 
			// butFwd4
			// 
		...
		private OpenDental.UI.TabPage tabWaiting;
		private UI.GridOD gridWaiting;
		private OpenDental.UI.TabPage tabSched;
		private UI.GridOD gridEmpSched;
		private OpenDental.UI.TabPage tabProv;
		private UI.GridOD gridProv;
		private OpenDental.UI.TabPage tabReminders;
		private UI.GridOD gridReminders;
		private OpenDental.UI.ListBox listConfirmed;
		...
		private OpenDental.UI.ListBox listSearchResults;
		private UI.ListBox _listBoxProviders;
		...
		private UI.ToggleDayWeek toggleDayWeek;
	}
}
