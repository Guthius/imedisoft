	...
	public partial class ControlImagesOld:System.Windows.Forms.UserControl {
		...
		private void treeDocuments_DragDrop(object sender,DragEventArgs e) {
			...
			for(int i=0;i<arrayFiles.Length;i++) {
				...
				FrmDocInfo frmDocInfo=new FrmDocInfo(_patient,docSave,isDocCreate:true);
		...
		private void ToolBarInfo_Click() {
			...
			if(nodeIdTag.NodeType==EnumNodeType.ApteryxImage) {
				...
				FrmDocInfo frmDocInfo=new FrmDocInfo(_patient,doc,true);//disable ok button, they can't save anything. Image is just temp.
				...
				FrmDocInfo frmDocInfo2=new FrmDocInfo(_patient,_documentShowing);
		...
		private void RefreshModuleData(long patNum) {
			...
			if(false) {
				actionClosing=ODProgress.Show(startingMessage:Lan.g(this,"Loading..."));
			}
