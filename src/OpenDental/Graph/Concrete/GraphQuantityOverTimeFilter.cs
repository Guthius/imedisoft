...
public partial class GraphQuantityOverTimeFilter : UserControl, IODGraphPrinter, IDashboardDockContainer
{
    ...
    private readonly IncomeGraphOptionsCtrl _incomeOptionsCtrl = new();
    private readonly ProductionGraphOptionsCtrl _productionOptionsCtrl = new();
    private readonly BrokenApptGraphOptionsCtrl _brokenApptsCtrl = new();
    private readonly HqMessagesRealTimeOptionsCtrl _hqMsgRealTimeCtrl = new();
    ...
    public bool CanEdit
    {
        get
        {
            ...
            {
                DashboardCellType.ProductionGraph or DashboardCellType.IncomeGraph or DashboardCellType.NewPatientsGraph or DashboardCellType.BrokenApptGraph or DashboardCellType.AccountsReceivableGraph => true,
                _ => false
            };
        }
    }
        ...
        set
        {
            ...
            switch (CellType)
            {
                ...
                case DashboardCellType.NewPatientsGraph:
                    ...
                    break;
                default:
                    throw new Exception("Unsupported CellType: " + CellType);
            }
            ...
            case DashboardCellType.BrokenApptGraph:
            {
                ...
                switch (_brokenApptsCtrl.CurRunFor)
                {
                    ...
                    case BrokenApptGraphOptionsCtrl.RunFor.Procedure:
                        ...
                        break;
                    default:
                        throw new Exception("Unsupported CurRunFor: " + _brokenApptsCtrl.CurRunFor);
                }
            }
                break;
            default:
