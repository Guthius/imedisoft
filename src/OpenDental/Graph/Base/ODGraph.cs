...
public class ODGraphSettingsBase
{
    ...
    public DashboardFilter Filter => new() {DateTo = DateTo, DateFrom = DateFrom, UseDateFilter = QuickRangePref != QuickRange.allTime};
    ...
    public static DashboardFilter GetDatesFromQuickRange(QuickRange quickRange, DateTime customDateFrom, DateTime customDateTo)
    {
        ...
        switch (quickRange)
        {
            ...
            case QuickRange.allTime:
                ...
                break;
            default:
                throw new Exception("Unsupported QuickRange: " + quickRange);
        }
