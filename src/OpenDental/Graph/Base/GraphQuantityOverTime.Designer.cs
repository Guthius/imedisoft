namespace OpenDental.Graph.Base {
	partial class GraphQuantityOverTime {
		...
		private void InitializeComponent() {
			...
			this.chartLegend1.LegendDock = LegendDockType.Left;
			...
			this.pictureBoxLoading.Image = global::OpenDental.Graph.Properties.Resources.loadingAnim;
