...
using DashboardCellType = Imedisoft.Core.Entities.DashboardCellType;

namespace OpenDental.Graph.Base;

public partial class GraphQuantityOverTime : UserControl, IODGraphPrinter
{
    private readonly List<ODGraphLegendItem> _listHiddenLegendItems = [];
    private readonly List<Tuple<DateTime, DateTime>> _intervals = [];
    ...
    public GraphQuantityOverTime()
    {
        ...
        comboChartType.SetDataToEnumsPrimitive([..new[] {SeriesChartType.StackedArea, SeriesChartType.StackedColumn, SeriesChartType.Column, SeriesChartType.Line}]);
