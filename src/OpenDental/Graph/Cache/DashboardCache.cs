...
public class DashboardCache
{
    ...
    public static DashboardCacheNewPatient Patients { get; } = new();
    public static DashboardCacheCompletedProc CompletedProcs { get; } = new();
    public static DashboardCacheWriteoff Writeoffs { get; } = new();
    public static DashboardCacheAdjustment Adjustments { get; } = new();
    public static DashboardCachePaySplit PaySplits { get; } = new();
    public static DashboardCacheClaimPayment ClaimPayments { get; } = new();
    public static DashboardCacheAR AR { get; } = new();
    public static DashboardCacheProvider Providers { get; } = new();
    public static DashboardCacheBrokenAppt BrokenAppts { get; } = new();
    public static DashboardCacheBrokenProcedure BrokenProcs { get; } = new();
    public static DashboardCacheBrokenAdj BrokenAdjs { get; } = new();
    public static DashboardCacheClinic Clinics { get; } = new();
    ...
    public static void RefreshCellTypeIfInvalid(DashboardCellType cellType, DashboardFilter filter, bool waitToReturn, bool invalidateFirst, EventHandler onExit = null)
    {
        ...
        try
        {
            ...
            switch (cellType)
            {
                ...
                default:
                    throw new Exception("Unsupported DashboardCellType: " + cellType);
            }
        }
        finally
        {
    ...
    {
        var thread = new ODThread(_ => { cache.Run(filter, invalidateFirst); })
        {
            GroupName = groupName
        };
        thread.Start(false);
...
public class DashboardCacheLock
{
    ...
    public static readonly DashboardFilter FilterOptions = new();
}
