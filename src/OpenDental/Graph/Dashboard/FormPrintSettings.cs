...
using PdfSharp.Pdf;
using Legend = OpenDental.Graph.Base.Legend;
...
{
    private readonly Chart _chartCur;
    ...
    private void FormPrintSettings_Load(object sender, EventArgs e)
    {
        ...
        _chartCur.Printing.PrintDocument.PrintPage += ChartGenericFormat_PrintPage;
    ...
    private void MakePage()
    {
        ...
        _chartCur.Printing.PrintDocument.DefaultPageSettings.Margins = new Margins(_marginWidth, _marginWidth, _marginHeight, _marginHeight);
        ...
        using (var chartbmp = new Bitmap(_chartCur.Width, _chartCur.Height))
        using (var legendbmp = new Bitmap(_legend.Width, _legend.Height))
        {
    ...
    private void FillDimensions()
    {
        ...
        try
        {
            _chartCur.Width = SIn.Int(textWidth.Text);
        }
        catch
        {
            _chartCur.Width = 1;
        ...
        try
        {
            _chartCur.Height = SIn.Int(textHeight.Text);
        }
        catch
        {
            _chartCur.Height = 1;
        ...
        try
        {
            _marginWidth = SIn.Int(textMarginWidth.Text);
        }
        catch
        {
            _marginWidth = 0;
        ...
        try
        {
            _marginHeight = SIn.Int(textMarginHeight.Text);
        }
        catch
        {
            _marginHeight = 0;
    ...
    private void butExport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ODMessageBox.Show(Lans.g("Chart saved."));
        }
        catch (Exception ex)
        {
