...
public partial class DashApptGrid : UserControl, IDashWidgetField
{
    ...
    private void AppointmentEvent_Fired(ODEventArgs e)
    {
        ...
        {
            var listSignalods = (List<Signalod>) e.Tag;
    ...
    private void FillGrid()
    {
        ...
        var appointmentOtherSelected = ListApptOthers.Find(x => x.AptNum == gridMain.SelectedTag<long>());
        ...
        for (var i = 0; i < ListApptOthers.Count; i++)
        {
            ...
            if (ListApptOthers[i].AptDateTime.Year > 1880)
            {
                                                                      ...
                                                                      && ListApptOthers[i].AptStatus != ApptStatus.Broken)
                {
                    ...
                    if (ListApptOthers[i].AptDateTime < DateTime.Today)
                    {
                        //Past
                        row.ColorBackG = _listDefsProgNoteColors[11].ItemColor;
                        row.ColorText = _listDefsProgNoteColors[10].ItemColor;
                    }
                    else if (ListApptOthers[i].AptDateTime.Date == DateTime.Today.Date)
                    {
                        //Today
                    ...
                    else if (ListApptOthers[i].AptDateTime > DateTime.Today)
                    {
                        //Future
                ...
                else if (ListApptOthers[i].AptStatus == ApptStatus.Planned)
                {
