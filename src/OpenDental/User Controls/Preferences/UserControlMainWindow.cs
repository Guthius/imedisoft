...
public partial class UserControlMainWindow:UserControl {
	...
	public void FillWindowMain() {
		...
		if(PrefC.GetString(PrefName.PopupsDisableTimeSpan)!="") {
			var timeSpanPopupsDisable=TimeSpan.Parse(PrefC.GetString(PrefName.PopupsDisableTimeSpan),CultureInfo.InvariantCulture);
	...
	public bool SaveMainWindow() {
		var timeSpanPopup=TimeSpan.Zero;
		var popupsDisableDays=textPopupsDisableDays.Text;
		var popupsDisableTimeSpan=textPopupsDisableTimeSpan.Text;
