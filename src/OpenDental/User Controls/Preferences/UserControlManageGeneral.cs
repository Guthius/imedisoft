...
public partial class UserControlManageGeneral:UserControl {
	...
	private void FillComboEraAutomation() {
		var listEraAutomationModes=typeof(EraAutomationMode).GetEnumValues()
	...
	private void FillComboEraWriteOff () {
		var listEraAutoPostWriteOffModes=typeof(EnumEraAutoPostWriteOff).GetEnumValues()
	...
	public void FillManageGeneral() {
		var claimZeroPayRollingDays=PrefC.GetInt(PrefName.ClaimPaymentNoShowZeroDate);
