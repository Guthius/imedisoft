...
namespace OpenDentBusiness {
	public class PaymentEdit {
		...
		///<summary>Gets the charges and links credits for the patient. Includes family account entries if listPatNums left null. Set hasOffsettingAdjustments true so PrefName.AdjustmentsOffsetEachOther decides if we offset unattached adjustments or not.</summary>
		...
		public class LoadData {
			...
			public string TableBalancesXml {
				...
				set {
					...
					TableBalances=XmlConverter.XmlToDataTable(value);
				}
			}
		...
		public class ConstructResults {
			...
			public ConstructResults(long patNum,long clinicNum,double payAmt,long payNum,DateTime payDate,List<PaySplit> listPaySplitsForPayment=null,
				List<AccountEntry> listAccountEntries=null,List<ClaimProc> listClaimProcs=null)
			{
				PayAmt=payAmt;
				PayDate=payDate;
				PatNum=patNum;
