...
namespace OpenDentBusiness {
	...
	public class PayPlanProductionEntry {
		...
		///<summary>Only used for web conversion.</summary>
		...
		///<summary>Only returns payPlanProductionEntries that haven't been fully charged out ordered by CreditDate.</summary>
