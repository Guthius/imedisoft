...
namespace OpenDentBusiness {
	...
	public class AccountEntry {
		...
		///<summary>The sum of all positive adjustment entries that are explicitly linked to this account entry.</summary>
		public decimal AdjustmentAmtPos;
		///<summary>The sum of all negative adjustment entries that are explicitly linked to this account entry.</summary>
