...
public class FeeLim
{
    ...
    ///     For clinic and/or provider fees, amount can be set to -1 which indicates that their fee should be blank and not use
    ///     the default fee.
    /// </summary>
    ...
    /// <summary>
    ///     Used in securitylogs to track when fees are updated or modified.
    /// </summary>
    ...
    ///     Will fail if attempting to cast a null.
    ///     Casting will always return a deep copy.
    /// </summary>
