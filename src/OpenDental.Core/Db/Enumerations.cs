...
namespace OpenDentBusiness
{
    ...
    public enum InvalidType
    {
        ...
        ///<summary>31 - Also include EForms.</summary>
        Sheets = 31,
        ...
        ApiSubscriptions = 106,

        ///<summary>107. Used as template for Patient eRouting</summary>
        ERoutingDef = 107,

        ///<summary>108. Used as template for Patient eRouting Actions</summary>
        FlowActionDef = 108,
        ...
        ///<summary>113. Used to keep the daycare map and parent check in/out window synced. Has nothing to do with the cache.</summary>
        Children = 113,
        ...
        ///<summary>115. This is used internally by OD, refreshes the AI assistant list. Fkey is not used.</summary>
        WebChatAiAssistants = 115
    }
    ...
    public enum AccountEntryType
    {
        ...
        ///<summary>5 - payplancharge.PayPlanChargeNum.</summary>
        PayPlanCharge
    }
    ...
    public enum LimitationTypeMet
    {
        ...
        ///<summary>1 - Individual annual max exceeded</summary>
        PeriodMax,

        ///<summary>2 - Family annual max exceeded</summary>
        FamilyPeriodMax,

        ///<summary>3 - Patient age exceeds limit</summary>
        Aging,

        ///<summary>4 - Frequency limit exceeded</summary>
        Frequency,
    }
}