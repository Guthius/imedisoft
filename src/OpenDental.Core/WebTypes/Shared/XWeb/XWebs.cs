...
public class XWebs
{
    ...
    {
        public Func<string> ResponseData;
    }
    ...
    internal abstract class XWebInputAbs
    {
        ...
        {
            if (Mock != null && Mock.ResponseData != null)
            {
    ...
    private abstract class XWebInputDTG : XWebInputAbs
    {
        ...
        protected override string XWebSpecVersion
        {
            get { return "XWeb3.6"; }
        }
    ...
    private class XWebInputDTGPaymentSale : XWebInputDTG
    {
        ...
        protected CreditCardSource _ccSource;
        ...
        protected override XWebTransactionStatus ApprovalStatus
        {
            get { return XWebTransactionStatus.DtgPaymentApproved; }
        }

        protected virtual bool InsertPaymentOnApproval
        {
            get { return _insertPaymentOnApproval; }
            set { _insertPaymentOnApproval = value; }
        }

        protected virtual bool InsertPositivePayment
        {
            get { return true; }
        }
        ...
        public XWebInputDTGPaymentSale(long patNum, string payNote, double amount, long creditCardNum, bool createPayment, bool forceDuplicates,
            CreditCardSource ccSource = CreditCardSource.XWeb)
    ...
    private class XWebInputDTGPaymentVoid : XWebInputDTG
    {
        ...
        protected override XWebTransactionStatus ApprovalStatus
        {
            get { return XWebTransactionStatus.DtgPaymentVoided; }
        }
    ...
    private class XWebInputDTGPaymentReturn : XWebInputDTGPaymentSale
    {
        protected override XWebTransactionStatus ApprovalStatus
        {
            get { return XWebTransactionStatus.DtgPaymentReturned; }
        }

        protected override bool InsertPositivePayment
        {
            get { return false; }
        }
    ...
    private class XWebInputDTGDeleteAlias : XWebInputDTG
    {
        ...
        protected override XWebTransactionStatus ApprovalStatus
        {
            get { return XWebTransactionStatus.DtgAliasDeleted; }
        }
        ...
        protected override void PostProcessOutput(XWebResponse response)
        {
            ...
            try
            {
                response.PayNote = "Deleted CreditCard: " + JsonConvert.SerializeObject(_cc);
            }
            catch
            {
            }
