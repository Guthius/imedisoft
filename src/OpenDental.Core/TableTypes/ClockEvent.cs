...
namespace OpenDentBusiness{
	...
	public class ClockEvent:TableBase {
		...
		///<summary>Used only for serialization purposes</summary>
		[XmlElement("Rate3Hours",typeof(long))]
		public long Rate3HoursXml {
			get {
				return Rate3Hours.Ticks;
			}
			set {
				Rate3Hours=TimeSpan.FromTicks(value);
			}
		}

		///<summary>Used only for serialization purposes</summary>
		[XmlElement("Rate3Auto",typeof(long))]
		public long Rate3AutoXml {
			get {
				return Rate3Auto.Ticks;
			}
			set {
				Rate3Auto=TimeSpan.FromTicks(value);
			}
		}
		...
		public ClockEvent() {
			...
			Rate3Hours=TimeSpan.FromHours(-1);
		}
