...
namespace OpenDentBusiness{
	...
	public class Userod:TableBase{
		...
		///<summary>Rreturns a struct created from the database-ready password which is stored in the Password field.</summary>
		public PasswordContainer GetPasswordContainer() {
			return Authentication.DecodePass(this.Password);
		}

		///<summary>Manipulates the Password variable to the string representation of this PasswordContainer object.</summary>
		...
		public string PasswordHash {
			get {
				return GetPasswordContainer().Hash;
			}
		}
	...
	public enum EServiceTypes {
		///<summary>Not an eService user.  All valid users should be this type otherwise permission checking will act differently.</summary>
		None,
