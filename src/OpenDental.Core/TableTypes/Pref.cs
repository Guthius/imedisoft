...
namespace OpenDentBusiness {
	...
	public enum PrefName {
		...
		AccountShowTrojanExpressCollect = 12,
		ADAComplianceDateTime = 13,
		...
		AdjustmentsForceAttachToProc = 18,
		...
		///<summary>DEPRECATED.  Will always be false.</summary>
		AgingCalculatedMonthlyInsteadOfDaily = 23,
		...
		///<summary>DEPRECATED.  Will always be true for aging to use the intermediate table famaging for calculating aging.</summary>
		AgingIsEnterprise = 25,
		///<summary>DEPRECATED.  Use AgingProcLifo instead.</summary>
		[Obsolete("This preference has been deprecated. Do not use.",true)]
		AgingNegativeAdjsByAdjDate = 26,
		...
		ApptConfirmEnableForClinicZero = 62,
		...
		ApptEConfirm2ClickConfirmation = 73,
		...
		ApptGeneralMessageAutoEnabled = 80,
		///<summary>Boolean.  Defaults to false. Only used for the clinicpref table, not the preference table. When true, this clinic will use the 
		///Appointment General Message rules for ClinicNum 0.</summary>
		ApptGeneralMessageUseDefaults = 81,
		...
		[Obsolete("This preference has been deprecated. Do not use.",true)]
		ApptModuleUses2019Overhaul = 88,
		///<summary>Boolean. True if automated new patient thank yous are enabled for the entire DB. See ApptReminderRules for setup details.
		...
		ApptNewPatientThankYouEnabled = 89,
		///<summary>Boolean. Defaults to false. Only used for the clinicpref table, not the preference table. When true, this clinic will use the 
		///New Patient Thank You rules for ClinicNum 0.</summary>
		ApptNewPatientThankYouUseDefaults = 90,
		///<summary>Comma delimited string of WebSheetDefIDs. Defaults to 0, holds WebSheetDefIDs that are used for URL generation.</summary>
		ApptNewPatientThankYouWebSheetDefID = 91,
		...
		///Permissions are still checked here at HQ so manually overriding this value will only make the program behave annoyingly, but won't break anything.</summary>
		ApptRemindAutoEnabled = 99,
		///<summary>DEPRECATED.  See ApptReminderRule table instead.</summary>
		ApptReminderDayInterval = 100,
		///<summary>DEPRECATED.  See ApptReminderRule table instead.</summary>
		ApptReminderDayMessage = 101,
		///<summary>DEPRECATED.  See ApptReminderRule table instead.</summary>
		ApptReminderEmailMessage = 102,
		///<summary>DEPRECATED.  See ApptReminderRule table instead.</summary>
		ApptReminderHourInterval = 103,
		///<summary>DEPRECATED.  See ApptReminderRule table instead.</summary>
		ApptReminderHourMessage = 104,
		///<summary>Used as the value of the [Premed] tag in eReminders.</summary>
		ApptReminderPremedTemplate = 105,
		///<summary>DEPRECATED.  See ApptReminderRule table instead.</summary>
		ApptReminderSendAll = 106,
		///<summary>DEPRECATED.  See ApptReminderRule table instead.</summary>
		ApptReminderSendOrder = 107,
		///<summary>Boolean.  Defaults to false. Only used for the clinicpref table, not the preference table. When true, this clinic will use the 
		///Appointment Reminder rules for ClinicNum 0.</summary>
		ApptReminderUseDefaults = 108,
		...
		AsteriskConferenceApplication = 145,
		...
		AutomaticSummaryOfCareWebmail = 158,
		///<summary>Only used for the clinicpref table, not the preference table.</summary>
		AutoMsgingUseDefaultPref = 159,
		...
		BillingElectClientAcctNumber = 188,
		...
		///<summary>Deprecated. Boolean.  Defaults to true.  Determines if the billing window shows progress when sending statements.</summary>
		BillingShowSendProgress = 216,
		...
		BrokenApptCommLogNotAdjustment = 228,
		...
		CloudFileWatcherDirectoryAPI = 301,
		...
		CustListenerConnectionRequestTimeoutMS = 321,
		...
		CustListenerHeartbeatFrequencyMinutes = 322,
		...
		CustListenerSocketTimeoutMS = 324,
		...
		[PrefName(ValueType=PrefValueType.STRING)]
		DatabaseIntegritiesWhiteList = 333,
		...
		DoseSpotDateLastAccessCheck = 362,
		...
		[PrefName(ValueType=PrefValueType.BOOL)]
		EClipboardAllowPaymentOnCheckin = 384,
		...
		[PrefName(ValueType=PrefValueType.BOOL)]
		EClipboardAllowSelfCheckIn = 385,
		///Deprecated. Do not use. Replaced by 'eclipboardimagecapturedef' table. Boolean, false by default. When true, allows patients on tablets to take a picture of themselves on check-in. </summary>
		[PrefName(ValueType=PrefValueType.BOOL)]
		EClipboardAllowSelfPortraitOnCheckIn = 386,
		...
		[PrefName(ValueType=PrefValueType.BOOL)]
		EClipboardAppendByodToArrivalResponseSms = 387,
		...
		[PrefName(ValueType=PrefValueType.INT)]
		EClipboardClinicalValidationFrequency = 389,
		...
		[PrefName(ValueType=PrefValueType.BOOL)]
		EClipboardCreateMissingFormsOnCheckIn = 390,
		...
		[PrefName(ValueType=PrefValueType.BOOL)]
		EClipboardHasMultiPageCheckIn = 393,
		...
		[PrefName(ValueType=PrefValueType.BOOL)]
		EClipboardPopupKioskOnCheckIn = 396,
		...
		[PrefName(ValueType=PrefValueType.BOOL)]
		EClipboardPresentAvailableFormsOnCheckIn = 397,
		...
		EClipboardClinicsSignedUp = 399,
		///<summary>Boolean, default true. When this pref is true, after a perio chart is closed on eClipboard, it will generate and bring up a
		///PDF of the graphical perio chart to display to the patient.</summary>
		[PrefName(ValueType=PrefValueType.BOOL)]
		EClipboardShowPerioGraphical = 400,
		///<summary>Boolean, false by default. When this pref is true, if a clinical QR code is scanned, it will automatically log the current user into 
		///eClipboard Clinical. Otherwise it will ask the current user to sign in on the Clinical device.</summary>
		[PrefName(ValueType=PrefValueType.BOOL)]
		EClipClinicalAutoLogin = 401,
		///<summary>Deprecated. Boolean, false by default.  Will be set to true when the update server successfully upgrades the CustListener service to the 
		...
		EConnectorCleanupLoggerIntervalDays = 403,
		...
		EHREmailFromAddress = 408,
		EHREmailPassword = 409,
		EHREmailPOPserver = 410,
		EHREmailPort = 411,
		EhrRxAlertHighSeverity = 412,
		...
		[PrefName(ValueType = PrefValueType.INT)]
		EmailAlertMaxConsecutiveFails = 416,
		...
		EmailSendExternalManagerTimeoutMs = 438,
		...
		EmailSendExternalTimeoutMs = 439,
		...
		ImagesModuleTreeIsCollapsed = 505,
		...
		[Obsolete("This preference has been deprecated. Use CodeGroups instead.",true)]
		InsBenFullDebridementCodes = 533,
		...
		InsPlanConverstion_7_5_17_AutoMergeYN = 560,
		...
		JobManagerDefaultEmail = 591,
		JobManagerDefaultBillingMsg = 592,
		...
		LetterMergePath = 608,
		///<summary>A bool. Determines if the License Agreement signature has been logged at HQ. False when it needs to be sent.</summary>
		[PrefName(ValueType=PrefValueType.BOOL)]
		LicenseAgreementAccepted = 609,
		...
		MassEmailSecret = 614,
		///<summary>String. The guid for a clinic's Advertising - Postcards account.</summary>
		[PrefName(ValueType=PrefValueType.STRING)]
		AdvertisingPostCardGuid = 615,
		...
		[Obsolete("Deprecated")]
		MobileSynchNewTables112Done = 625,
		...
		[Obsolete("Deprecated")]
		MobileSynchNewTables121Done = 626,
		[Obsolete("Deprecated")]
		MobileSyncIntervalMinutes = 627,
		[Obsolete("Deprecated")]
		MobileSyncServerURL = 628,
		[Obsolete("Deprecated")]
		MobileSyncWorkstationName = 629,
		[Obsolete("Deprecated")]
		MobileExcludeApptsBeforeDate = 630,
		[Obsolete("Deprecated")]
		MobileUserName = 631,
		MobileWebClinicsSignedUp = 632,
		///<summary>Int. Adjusts RunInterval of MsgToPay in seconds.</summary>
		MsgToPaySendThreadFrequency = 633,
		...
		NewCropAccountId = 636,
		///<summary>The date this customer last checked with HQ to determine which provider have access to eRx.</summary>
		NewCropDateLastAccessCheck = 637,
		...
		NistTimeServerUrl = 643,
		///<summary>Boolean. False by default. Set true if notes can only be signed by providers.</summary>
		NotesProviderSignatureOnly = 644,
		///<summary>Comma delimited list of ClinicNums signed up for OCR scanning. Gets updated from HQ via the nightly sync</summary>
		OCRClinicsSignedUp = 645,
		...
		ODMobileCacheDurationHours = 646,
		...
		OpenDentalServiceHeartbeat = 652,
		OpenDentalVendor = 653,
		OracleInsertId = 654,
		...
		PatientPortalInviteEnabled = 680,
		///<summary>Boolean.  Defaults to false. Only used for the clinicpref table, not the preference table. When true, this clinic will use the 
		///Patient Portal Invite rules for ClinicNum 0.</summary>
		PatientPortalInviteUseDefaults = 681,
		...
		PaymentsPromptForAutoSplit = 698,
		...
		[PrefName(ValueType=PrefValueType.BOOL)]
		PaymentsTransferPatientIncomeOnly = 700,
		...
		///<summary>Long. FK to def.DefNum, in category PaymentType.  Default payment type for payments made through the payment portal where the user arrived via a Message-To-Pay url. If 0, continues to use whatever payment method was default.</summary>
		[PrefName(ValueType=PrefValueType.LONG)]
		PayTypeMessageToPay = 722,
		...
		PlannedApptTreatedAsRegularAppt = 746,
		PracticeAddress = 747,
		...
		PregnancyDefaultCodeValue = 774,
		PregnancyDefaultCodeSystem = 775,
		...
		PublicHealthScreeningSheet = 800,
		...
		PublicHealthScreeningUsePat = 801,
		...
		RadiologyDateStartedUsing154 = 807,
		...
		///<summary>FK to definition.DefNum. Uses the existing RecallUnschedStatus DefCat.</summary>
		[PrefName(ValueType=PrefValueType.LONG)]
		ReactivationStatusEmailedTexted = 820,
		///<summary>FK to definition.DefNum. Uses the existing RecallUnschedStatus DefCat.</summary>
		[PrefName(ValueType=PrefValueType.LONG)]
		ReactivationStatusMailed = 821,
		///<summary>FK to definition.DefNum. Uses the existing RecallUnschedStatus DefCat.</summary>
		[PrefName(ValueType=PrefValueType.LONG)]
		ReactivationStatusTexted = 822,
		...
		RecurringChargesAutomatedLastDateTime = 867,
		...
		RegistrationNumberClaim = 880,
		RenaissanceLastBatchNumber = 881,
		...
		///<summary>Deprecated. Was never meant for production. WebsApps uses this pref specifically for testing.</summary>
		[Obsolete("This preference has been deprecated. Do not use.",false)]
		RxSendNewToQueue = 913,
		...
		ScannerCompression = 923,
		ScannerResolution = 924,
		ScannerSuppressDialog = 925,
		...
		///</summary>
		ShortCodeOptInOnApptCompleteOffScript = 974,
		...
		ShowProgressNotesInsteadofCommLog = 993,
		...
		ShowProviderPayrollReport = 994,
		ShowUrgFinNoteInProgressNotes = 995,
		...
		///<summary>Deprecated. Moved to the supplementalbackups database. Used by OD HQ. Never added to db convert script. The maximum number of bytes allowed per backup upload respectively.</summary>
		SupplementalBackupUploadMaxByteCount = 1023,
		///<summary>Deprecated. Moved to the supplementalbackups database. Used by OD HQ. Never added to db convert script. The timeout in seconds of a backup upload from the time the upload begins.</summary>
		SupplementalBackupUploadTimeoutSeconds = 1024,
		...
		ToothChartExternalProcess = 1055,
		///<summary>Deprecated.  Not used anywhere.</summary>
		ToothChartMoveMenuToRight = 1056,
		...
		TreatPlanPriorityForDeclined = 1068,
		...
		TreatPlanShowGraphics = 1072,
		TreatPlanShowIns = 1073,
		...
		//INSERT INTO preference(PrefName,ValueString) VALUES ('HQSerializedMapContainers','');//deprecated
		///<summary>DEPRECATED.  Moved to the Trojan Express Collect program link properties.</summary>
		[Obsolete("This preference has been deprecated. Do not use.",true)]
		TrojanExpressCollectBillingType = 1082,
		///<summary>DEPRECATED.  Moved to the Trojan Express Collect program link properties.</summary>
		[Obsolete("This preference has been deprecated. Do not use.",true)]
		TrojanExpressCollectPassword = 1083,
		///<summary>DEPRECATED.  Moved to the Trojan Express Collect program link properties.</summary>
		[Obsolete("This preference has been deprecated. Do not use.",true)]
		TrojanExpressCollectPath = 1084,
		///<summary>DEPRECATED.  Moved to the Trojan Express Collect program link properties.</summary>
		[Obsolete("This preference has been deprecated. Do not use.",true)]
		TrojanExpressCollectPreviousFileNumber = 1085,
		///<summary>Can be any int.  Defaults to 0.</summary>
		...
		UpdateCode = 1090,
		UpdateInProgressOnComputerName = 1091,
		...
		UpdateWindowShowsClassicView = 1101,
		...
		WebCamFrequencyMS = 1124,
		///<summary>Boolean.  1 by default.  Determines whether or not the checkbox in FormWebFormSetup is checked by default.</summary>
		WebFormsAutoFillNameAndBirthdate = 1125,
		///<summary>Hidden preference, no UI to enable this feature, but is present in all databases. Used to determine the frequency of WebFormRetrieveThread.</summary>
		WebFormsDownloadAlertFrequency = 1126,
		///<summary>0 to disable. 1 by default. When enabled, web forms will be downloaded automatically, including web forms that don't match any patients.</summary>
		WebFormsDownloadAutomcatically = 1127,
		///<summary>Only used for sheet synch.  See Mobile... for URL for mobile synch.</summary>
		WebHostSynchServerURL = 1128,
		...
		WebSchedExistingPatDoAuthEmail = 1135,
		///<summary>Require existing patient to respond to 2-step verification text before creating new appointment.</summary>
		WebSchedExistingPatDoAuthText = 1136,
		/// <summary>Allows a user to customize the default WebSched Recall display name in WSEP.</summary>
		[PrefName(ValueType=PrefValueType.STRING)]
		WebSchedExistingPatRecallName = 1137,
		...
		WebSchedExistingPatConfirmStatus = 1143,
		...
		WebSchedExistingPatDoubleBooking = 1144,
		...
		WebSchedExistingPatIgnoreBlockoutTypes = 1145,
		...
		WebSchedExistingPatMessage = 1146,
		///<summary>Boolean, false by default. If true, patients will be able to schedule disabled recalls for Web Sched Existing Pat.</summary>
		WebSchedExistingPatAllowDisabledRecalls = 1147,
		...
		WebSchedExistingPatAllowProvSelection = 1148,
		///<summary>Boolean, false by default. Used to enforce an insurance carrier selection for existing patients prior to scheduling a WebSched appt.</summary>
		WebSchedExistingPatRequestInsurance = 1149,
		...
		WebSchedNewPatApptEnabled = 1163,
		...
		WebSchedNewPatApptForcePhoneFormatting = 1164,
		...
		WebSchedNewPatApptIgnoreBlockoutTypes = 1165,
		...
		WebSchedNewPatApptMessage = 1166,
		...
		WebSchedNewPatApptTimePattern = 1168,
		///<summary>Integer.  Represents the number of days into the future we will go before searching for available time slots.
		///Empty will start looking for available time slots today.</summary>
		WebSchedNewPatApptSearchAfterDays = 1169,
		...
		WebSchedNewPatDoAuthEmail = 1171,
		///<summary>Require new patient to respond to 2-step verification text message before creating new appointment.</summary>
		WebSchedNewPatDoAuthText = 1172,
		///<summary>Boolean, false by default. Used to enforce an insurance carrier selection for new patients prior to scheduling a WebSched appt.</summary>
		WebSchedNewPatRequestInsurance = 1173,
		...
		[PrefName(ValueType=PrefValueType.INT)]
		WebSchedRecallApptSearchMaximumMonths = 1180,
		...
		///<summary>Comma delimited list.  Empty by default.  Stores the defnums to blockouts to ignore in Web Sched Recall web app.</summary>
		WebSchedRecallIgnoreBlockoutTypes = 1186,
		...
		WebSchedVerifyRecallType = 1212,
		WebServiceHQServerURL = 1213,
		...
		WebServiceServerNameCanBeBlank = 1215,
		...
		WikiCreatePageFromLink = 1217,
		WordProcessorPath = 1218,
		XRayExposureLevel = 1219
	}
