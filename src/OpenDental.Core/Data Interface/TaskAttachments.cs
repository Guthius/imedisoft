...
public class TaskAttachments
{
    ...
    {
        return TaskAttachmentCrud.SelectOne(taskAttachmentNum);
    }

    /// <summary>
    ///     Retrieves attachment linked to the passed in docNum. If no attachment is linked to the docNum, then it returns
    ///     null.
    /// </summary>
    ...
    {
        return TaskAttachmentCrud.Insert(taskAttachment);
    }
    ...
    {
        return TaskAttachmentCrud.Update(taskAttachment, taskAttachmentOld);
    }
