...
public class ProcButtons
{
    ...
    private static void SetToDefaultMySQL()
    {
        ...
        long autoCodeNum2;
        //Db---------------------------------------------------------------------------------------------------------
        var command = "INSERT INTO definition (Category,ItemOrder,ItemName,ItemValue,ItemColor,IsHidden) "
        ...
        if (ProcedureCodes.IsValidCode("D2750") || ProcedureCodes.IsValidCode("N4118"))
        {
            ...
            {
                command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum,ItemOrder) VALUES (" + SOut.Long(procButtonNum)
        ...
        if (autoCodeNum != 0 || ProcedureCodes.IsValidCode("D2750"))
        {
            ...
            if (ProcedureCodes.IsValidCode("D2750"))
            {
                command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum) VALUES (" + SOut.Long(procButtonNum)
        ...
        command = "INSERT INTO definition (Category,ItemOrder,ItemName,ItemValue,ItemColor,IsHidden) "
                  + "VALUES (26,1,'Dentures','',0,0)";
        category = Db.NonQ(command, true);
        //Denture
        autoCodeNum = AutoCodes.GetNumFromDescript("Denture");
        if (autoCodeNum != 0)
        {
            command = "INSERT INTO procbutton (Description,ItemOrder,Category,ButtonImage) VALUES('Denture',0,"
                      + SOut.Long(category) + @",'')";
            procButtonNum = Db.NonQ(command, true);
            command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum) VALUES (" + SOut.Long(procButtonNum) + ",0,"
                      + autoCodeNum + ")";
        ...
        //Immediate Denture
        autoCodeNum = AutoCodes.GetNumFromDescript("Immediate Denture");
        if (autoCodeNum != 0)
        {
            command = "INSERT INTO procbutton (Description,ItemOrder,Category,ButtonImage) VALUES('Immediate Denture',1,"
                      + SOut.Long(category) + @",'')";
            procButtonNum = Db.NonQ(command, true);
            command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum) VALUES (" + SOut.Long(procButtonNum) + ",0,"
                      + autoCodeNum + ")";
        ...
        //Resin Based Partial
        autoCodeNum = AutoCodes.GetNumFromDescript("Resin Base Partial");
        if (autoCodeNum != 0)
        {
            command = "INSERT INTO procbutton (Description,ItemOrder,Category,ButtonImage) VALUES('Resin Base Partial',2,"
                      + SOut.Long(category) + @",'')";
            procButtonNum = Db.NonQ(command, true);
            command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum) VALUES (" + SOut.Long(procButtonNum) + ",0,"
                      + autoCodeNum + ")";
        ...
        //Cast Metal Partial
        autoCodeNum = AutoCodes.GetNumFromDescript("Cast Metal Partial");
        if (autoCodeNum != 0)
        {
            command = "INSERT INTO procbutton (Description,ItemOrder,Category,ButtonImage) VALUES('Cast Metal Partial',3,"
                      + SOut.Long(category) + @",'')";
            procButtonNum = Db.NonQ(command, true);
            command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum) VALUES (" + SOut.Long(procButtonNum) + ",0,"
                      + autoCodeNum + ")";
        ...
        //Flex Based Partial
        autoCodeNum = AutoCodes.GetNumFromDescript("Flex Base Partial");
        if (autoCodeNum != 0)
        {
            command = "INSERT INTO procbutton (Description,ItemOrder,Category,ButtonImage) VALUES('Flex Base Partial',4,"
                      + SOut.Long(category) + @",'')";
            procButtonNum = Db.NonQ(command, true);
            command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum) VALUES (" + SOut.Long(procButtonNum) + ",0,"
                      + autoCodeNum + ")";
        ...
        command = "INSERT INTO definition (Category,ItemOrder,ItemName,ItemValue,ItemColor,IsHidden) "
                  + "VALUES (26,2,'Exams/Cleanings','',0,0)";
        category = Db.NonQ(command, true);
        //PA
    ...
    private static void SetToDefaultMySQLCanadaHygiene()
    {
            ...
            || ProcedureCodes.IsValidCode("12111") || ProcedureCodes.IsValidCode("12112") || ProcedureCodes.IsValidCode("12113") || ProcedureCodes.IsValidCode("04403"))
        {
            ...
            {
                command = "INSERT INTO procbutton (Description,ItemOrder,Category,ButtonImage) VALUES('Fluoride Rinse',12,"
                          + SOut.Long(category) + @",'')";
                procButtonNum = Db.NonQ(command, true);
                command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum) VALUES (" + SOut.Long(procButtonNum)
            ...
            {
                command = "INSERT INTO procbutton (Description,ItemOrder,Category,ButtonImage) VALUES('Fluoride Gel/Foam',13,"
                          + SOut.Long(category) + @",'')";
                procButtonNum = Db.NonQ(command, true);
                command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum) VALUES (" + SOut.Long(procButtonNum)
            ...
            {
                command = "INSERT INTO procbutton (Description,ItemOrder,Category,ButtonImage) VALUES('Fluoride Varnish',14,"
                          + SOut.Long(category) + @",'')";
                procButtonNum = Db.NonQ(command, true);
                command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum) VALUES (" + SOut.Long(procButtonNum)
            ...
            || ProcedureCodes.IsValidCode("77802") || ProcedureCodes.IsValidCode("79601") || ProcedureCodes.IsValidCode("79602"))
        {
            ...
            if (ProcedureCodes.IsValidCode("72119"))
            {
                command = "INSERT INTO procbutton (Description,ItemOrder,Category,ButtonImage) VALUES('Ext Add''l Soft Tissue Coverage',7,"
                          + SOut.Long(category) + @",'')";
                procButtonNum = Db.NonQ(command, true);
                command = "INSERT INTO procbuttonitem (ProcButtonNum,CodeNum,AutoCodeNum) VALUES (" + SOut.Long(procButtonNum)
    ...
    private class ProcButtonCache : CacheListAbs<ProcButton>
    {
        ...
        {
            var command = "SELECT * FROM procbutton ORDER BY ItemOrder";
            return ProcButtonCrud.SelectMany(command);
        }

        protected override List<ProcButton> TableToList(DataTable dataTable)
        {
            return ProcButtonCrud.TableToList(dataTable);
        }

        protected override ProcButton Copy(ProcButton item)
        {
            return item.Copy();
        }

        protected override DataTable ToDataTable(List<ProcButton> items)
        {
            return ProcButtonCrud.ListToTable(items, "ProcButton");
        }
