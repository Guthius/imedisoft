...
public class ProcButtonQuicks
{
    ...
    */
    ...
    {
        return ProcButtonQuickCrud.Insert(procButtonQuick);
    }
    ...
    /// <summary>
    ///     Ensures that Quick Buttons category exists in DB, and validates all Quick buttons in the DB.
    ///     Returns false if there is something wrong with ProcButtonQuick table. (Similar to DB maint.)
    /// </summary>
