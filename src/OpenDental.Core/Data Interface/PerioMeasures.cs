...
public class PerioMeasures
{
    ...
    {
        return PerioMeasureCrud.SelectMany("SELECT periomeasure.* FROM periomeasure,perioexam WHERE periomeasure.PerioExamNum = perioexam.PerioExamNum AND perioexam.PatNum = " + patNum);
    }
