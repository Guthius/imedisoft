...
namespace CodeBase {
	public class ODFileUtils {
		...
		///<summary>Creates a new randomly named file in the given directory path with the given extension and returns the full path to the new file. The file name will include the local date and time down to the second. Extension can be like ".txt" or "txt". It's better to use PrefC.GetRandomTempFile() instead of this directly because that has a cleanup mechanism built in.</summary>
