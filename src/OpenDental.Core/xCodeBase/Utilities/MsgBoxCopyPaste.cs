...
public class MsgBoxCopyPaste : Form
{
    ...
    protected virtual void butPrint_Click(object sender, EventArgs e)
    {
    ...
    private bool Print(Graphics g, int pageToPrint, Rectangle margins)
    {
        ...
        baseY += textSize.Height;
        font.Dispose();
        var messageLines = textMain.Text.Split(new string[] {Environment.NewLine}, StringSplitOptions.None);
        font = Font;
