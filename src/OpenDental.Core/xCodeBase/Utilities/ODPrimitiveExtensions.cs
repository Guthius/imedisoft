...
namespace CodeBase {
	...
	public static class ODPrimitiveExtensions{
		///<summary>OD extension. Returns a string array that contains the substrings in this string that are delimited by the specified string.</summary>
		...
		///<summary>OD extension. Returns true if the List is null or the count is 0.</summary>
		public static bool IsNullOrEmpty<T>(this List<T> list) {
			//jordan Approved. 
			return list==null || list.Count()==0;
		}

		///<summary>OD extension. Returns true if the Array is null or the length is 0.</summary>
		public static bool IsNullOrEmpty(this Array array) {
			//jordan Approved. 
			return array==null || array.Length==0;
		}

		///<summary>OD extension. Returns true if the string is null or empty.</summary>
		public static bool IsNullOrEmpty(this string str) {
			//jordan Approved.
			return string.IsNullOrEmpty(str);
		}

		///<summary>OD extension. Returns the Description attribute, if available. If not, returns enum.ToString().  Pass it through translation after retrieving from here.</summary>
		...
		///<summary>OD extension. Returns the Category attribute, if available. If not, returns enum.ToString().</summary>
		public static string GetCategory(this Enum value) {
			...
			if(categoryAttributes.IsNullOrEmpty()) {
				return value.ToString();
			}
			return categoryAttributes[0].Category;
		}

		///<summary>OD extension. Use like this: if(!x.In(2,3,61,71)). This lets you avoid making a list. If you already have a list, then just use the linq Contains method.</summary>
	...
	public class EnumTools{
		...
		///<summary>Returns the enum value with the passed in flags toggled.</summary>
		...
		///<summary>Takes in list of comma-delim ints (usually from a pref), seperates them, parses to ints, converts to list of enum defined by T.
		///Throws exception if doThrow is true and any comma-delim cells will not convert to int or enum of type T.</summary>
	...
	public class ListTools{
		...
		///<summary>Compares 2 lists. Returns true if size and items are exactly the same in each list. Throws if all list items do not match, otherwise returns silently.</summary>
		...
		///<summary>This is being eliminated.  All instances will be converted to List<>.Contains() instead.</summary>
	...
	///<summary>The IsODHQAttribute can  be applied to a field, and checked. Use in tandem with false to hide HQ only features.</summary>
