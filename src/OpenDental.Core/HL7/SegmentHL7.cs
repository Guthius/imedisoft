    ...
    public class SegmentHL7
    {
        ...
        public string FullText
        {
            ...
            set
            {
                ...
                var fieldSeparatorEscaped = "\\"; //default escape character is \
                ...
                var fields = _fullText.Replace(fieldSeparatorEscaped, "&124;") //replace \| with &124; (ASCII code for | is 124)
        ...
        public int SequenceNum
        {
            get
            {
                ...
                try
                {
                    retval = int.Parse(Fields[SequenceNumIndex].FullText);
                }
                catch (Exception ex)
                {
        ...
        public DateTime GetDateTime(int fieldIndex)
        {
            ...
            var str = Fields[fieldIndex].FullText.Trim(); //trailing space was causing problems.
            try
            {
                if (str.Length == 8)
                {
