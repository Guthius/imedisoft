...
public class PaySplit : TableBase
{
    ...
    public bool IsUnallocated => ProcNum == 0 && AdjNum == 0 && PayPlanNum == 0 && PayPlanChargeNum == 0 && UnearnedType == 0;
...
/// <summary>
/// Payment plan debit charge types. Used to keep track of payment splits made towards principal or interest.
/// </summary>
public enum PayPlanDebitTypes
{
    /// <summary>
    /// Legacy splits associated to payment plans did not specify what SplitAmt was applied towards and use this status.
    /// </summary>
    Unknown,

    /// <summary>
    /// Flags a split as a principal only payment.
    /// </summary>
    Principal,

    /// <summary>
    /// Flags a split as an interest only payment.
    /// </summary>
    Interest,
}