...
public class Disease : TableBase
{
    ...
    public Disease Copy()
    {
        return (Disease) MemberwiseClone();
    }
}
...
public enum SnomedProblemTypes
{
    ...
    ///<summary>2 - Complaint (finding). 409586006</summary>
    Complaint,

    ///<summary>3 - Diagnosis. Diagnosis interpretation (observable entity). 282291009</summary>
    Diagnosis,

    ///<summary>4 - Condition. Disease (disorder). 64572001</summary>
    Condition,

    ///<summary>5 - FunctionalLimitation. Finding of functional performance and activity (finding). 248536006</summary>
    FunctionalLimitation,

    ///<summary>6 - Symptom. Finding reported by subject or history provider (finding). 418799008</summary>
    Symptom,
}