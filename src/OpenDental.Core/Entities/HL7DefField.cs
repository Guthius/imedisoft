...
public class HL7DefField : TableBase
{
    ...
    {
        return (HL7DefField) MemberwiseClone();
    }
}

public class FieldNameAndType(string name, DataTypeHL7 datatype, string tableid)
{
    public string Name = name;
    public string TableId = tableid;
    public DataTypeHL7 DataType = datatype;

    public FieldNameAndType(string name, DataTypeHL7 datatype) : this(name, datatype, "")
    {
    }

    public static List<FieldNameAndType> GetFullList()
    {
        var retVal = new List<FieldNameAndType>();
