...
public class Procedure : TableBase
{
    ...
    public byte IcdVersion = PrefC.GetByte(PrefName.DxIcdVersion);
    ...
    public int PriorityOrder
    {
        get
        {
            ...
            {
                _priorityOrder = Defs.GetOrder(DefCat.TxPriorities, Priority);
            }
    ...
    public double ProcFeeTotal => ProcFee * Quantity;

    public double Quantity => Math.Max(1, BaseUnits + UnitQty);
