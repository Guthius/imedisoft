...
public class PatientRace : TableBase
{
    ...
    public const string DeclineSpecifyRaceCode = "ASKU-RACE";
    public const string DeclineSpecifyEthnicityCode = "ASKU-ETHNICITY";
    public const string MultiRaceCode = "MULTI-RACE";

    public PatientRace Clone()
    {
        return (PatientRace) MemberwiseClone();
    }
}
