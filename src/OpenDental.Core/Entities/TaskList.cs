...
{
    /// <summary>
    /// Hides filtering from UI. Only shows in FormTaskPreferences.
    /// Disabled is only valid on the TasksGlobalFilterType preference.
    /// Disabled is not valid for tasklists and will be treated as Default if applied to a tasklist.
    /// </summary>
    Disabled = 0,

    /// <summary>
    /// Only shows in FormTaskListEdit.
    /// </summary>
    Default,
    ...
    /// <summary>
    /// Region is defined in Defs and can be assigned to clinic.
    /// </summary>
    Region
}
