...
public class EServiceSignal:TableBase {
	...
	public EServiceSignal Copy() {
		return (EServiceSignal)MemberwiseClone();
	}
}
...
public enum eServiceCode {
	...
	UrlRedirect,
	///<summary>50 - Developer Portal API</summary>
	DeveloperPortalApi,
	///<summary>51 - Developer Portal UI</summary>
	DeveloperPortalUI,
	///<summary>52 - Email Transmission HQ Service</summary>
	EmailHqService,
}
