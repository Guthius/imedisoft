...
public class LimitedBetaFeature:TableBase {
	...
	public EServiceFeatureInfoEnum GetLimitedBetaFeatureEnum() {
		if(!Enum.TryParse(LimitedBetaFeatureTypeNum.ToString(),out EServiceFeatureInfoEnum ret)) {
...
/// <summary>These are the servicesHQ.eServiceFeatureInfoHQ PK's. If the feature is no longer in limited beta, add an attribute to the enum and set to true. </summary>
