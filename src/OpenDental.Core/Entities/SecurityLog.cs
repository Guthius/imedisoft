...
public enum LogSources
{
    ...
    WebSchedExistingPatient = 19,

    ///<summary>20 - eRx</summary>
    eRx = 20,

    ///<summary>22 - X12 834 Employer Import from the Manage Module.</summary>
    EmployerImport834 = 22,

    ///<summary>24 - Indicates that a claim was automatically received.</summary>
    ClaimReceiveAutomatic = 24,

    ///<summary>25 - Indicates that a payment was made from the Payment Portal.</summary>
    PaymentPortal = 25
}