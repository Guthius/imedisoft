...
public class EClipboardImageCaptureDef:TableBase {
	...
	public EClipboardImageCaptureDef Copy() {
		return (EClipboardImageCaptureDef)MemberwiseClone();
	}
...
Basically, there are synch patterns that make this table convoluted and make the UI hard to understand. Synch is bad.
...
EClipboardImageCapture defcat gets deprected and hidden
