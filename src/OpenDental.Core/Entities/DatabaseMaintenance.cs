...
public class DatabaseMaintenance:TableBase {
	...
	public DatabaseMaintenance Copy() {
		return (DatabaseMaintenance)MemberwiseClone();
	}
}
...
public class DbmMethodAttr:Attribute {
	...
	///<summary>Set to true if this is a DBM method with explanations that will display in the DBM method grid.</summary>
	...
	public DbmMethodAttr() {
		...
		_isCanada=false;
		_isOneOff=false;
		_isReplicationUnsafe=false;
		_hasWarningMessage=false;
	}
