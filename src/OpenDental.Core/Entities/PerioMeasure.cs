...
[Serializable]
[CrudTable(IsLargeTable=true,IsSynchable=true,HasBatchWriteMethods=true)]
public class PerioMeasure:TableBase {
	...
	public PerioMeasure Copy(){
		return (PerioMeasure)MemberwiseClone();
	}
}
...
public enum PerioSequenceType{
	...
	CAL,
	///<summary>8. Attached Gingiva.  This type is auto calculated and is never saved to the db.</summary>
	AttGing,
}
