...
public class SheetFieldDef : TableBase
{
    ...
    ///<summary>A convenient place to store the image of a field so that it does not have to be repeatedly downloaded. Be sure to dispose this field to prevent resource leaks.</summary>
    [XmlIgnore]
    [JsonIgnore]
    ...
    private SheetFieldDef(SheetFieldType fieldType, string fieldName, string fieldValue, float fontSize, string fontName, bool fontIsBold, int xPos, int yPos, int width, int height, GrowthBehaviorEnum growthBehavior, string radioButtonValue, bool isPaymentOption = false, KnownColor itemColor = KnownColor.Black, HorizontalAlignment textAlign = HorizontalAlignment.Left, bool isNew = false, string language = "")
    {
        FieldType = fieldType;
        FieldName = fieldName;
    ...
    {
        return (SheetFieldDef) MemberwiseClone();
    }
    ...
    public static SheetFieldDef NewOutput(string fieldName, float fontSize, string fontName, bool fontIsBold, int xPos, int yPos, int width, int height, GrowthBehaviorEnum growthBehavior = GrowthBehaviorEnum.None, KnownColor itemColor = KnownColor.Black)
    {
        return new SheetFieldDef(SheetFieldType.OutputText, fieldName, "", fontSize, fontName, fontIsBold, xPos, yPos, width, height, growthBehavior, "", false, itemColor, isNew: true);
    }

    public static SheetFieldDef NewOutput(string fieldName, float fontSize, string fontName, bool fontIsBold, int xPos, int yPos, int width, int height, HorizontalAlignment textAlign, KnownColor itemColor = KnownColor.Black, GrowthBehaviorEnum growthBehavior = GrowthBehaviorEnum.None)
    {
        return new SheetFieldDef(SheetFieldType.OutputText, fieldName, "", fontSize, fontName, fontIsBold, xPos, yPos, width, height, growthBehavior, "", false, itemColor, textAlign, isNew: true);
    }
    
    public static SheetFieldDef NewStaticText(string fieldValue, float fontSize, string fontName, bool fontIsBold, int xPos, int yPos, int width, int height, GrowthBehaviorEnum growthBehavior = GrowthBehaviorEnum.None, bool isPaymentOption = false, KnownColor itemColor = KnownColor.Black, HorizontalAlignment textAlign = HorizontalAlignment.Left)
    {
        return new SheetFieldDef(SheetFieldType.StaticText, "", fieldValue, fontSize, fontName, fontIsBold, xPos, yPos, width, height, growthBehavior, "", isPaymentOption, itemColor, textAlign, isNew: true);
    }

    public static SheetFieldDef NewInput(string fieldName, float fontSize, string fontName, bool fontIsBold, int xPos, int yPos, int width, int height)
    {
        return new SheetFieldDef(SheetFieldType.InputField, fieldName, "", fontSize, fontName, fontIsBold, xPos, yPos, width, height, GrowthBehaviorEnum.None, "", isNew: true);
    }

    public static SheetFieldDef NewImage(string fileName, int xPos, int yPos, int width, int height)
    {
        return new SheetFieldDef(SheetFieldType.Image, fileName, "", 0, "", false, xPos, yPos, width, height, GrowthBehaviorEnum.None, "", isNew: true);
    }

    public static SheetFieldDef NewPatImage(int xPos, int yPos, int width, int height)
    {
        return new SheetFieldDef(SheetFieldType.PatImage, "", "", 0, "", false, xPos, yPos, width, height, GrowthBehaviorEnum.None, "", isNew: true);
    }
    ...
    {
        return new SheetFieldDef(SheetFieldType.Line, "", "", 0, "", false, xPos, yPos, width, height, GrowthBehaviorEnum.None, "", isPaymentOption, itemColor, isNew: true);
    }

    public static SheetFieldDef NewRect(int xPos, int yPos, int width, int height, KnownColor itemColor = KnownColor.Black)
    {
        return new SheetFieldDef(SheetFieldType.Rectangle, "", "", 0, "", false, xPos, yPos, width, height, GrowthBehaviorEnum.None, "", itemColor: itemColor, isNew: true);
    }

    public static SheetFieldDef NewCheckBox(string fieldName, int xPos, int yPos, int width, int height)
    {
        return new SheetFieldDef(SheetFieldType.CheckBox, fieldName, "", 0, "", false, xPos, yPos, width, height, GrowthBehaviorEnum.None, "", isNew: true);
    }

    public static SheetFieldDef NewComboBox(string fieldName, string fieldValue, int xPos, int yPos)
    {
        return new SheetFieldDef(SheetFieldType.ComboBox, fieldName, fieldValue, 0, "", false, xPos, yPos, 155, 19, GrowthBehaviorEnum.None, "", isNew: true);
    }
    ...
    {
        return new SheetFieldDef(SheetFieldType.CheckBox, fieldName, "", 0, "", false, xPos, yPos, width, height, GrowthBehaviorEnum.None, radioButtonValue, isNew: true);
    }

    public static SheetFieldDef NewSigBox(int xPos, int yPos, int width, int height, SheetFieldType sigBox = SheetFieldType.SigBox)
    {
        return new SheetFieldDef(sigBox, "", "", 0, "", false, xPos, yPos, width, height, GrowthBehaviorEnum.None, "", isNew: true);
    }

    public static SheetFieldDef NewSpecial(string fieldName, int xPos, int yPos, int width, int height, string fieldValue = "")
    {
        return new SheetFieldDef(SheetFieldType.Special, fieldName, fieldValue, 0, "Calibri", false, xPos, yPos, width, height, GrowthBehaviorEnum.None, "", isNew: true);
    }

    public static SheetFieldDef NewGrid(string fieldName, int xPos, int yPos, int width, int height, float fontSize = 8.5f, string fontName = "", GrowthBehaviorEnum growthBehavior = GrowthBehaviorEnum.DownGlobal)
    {
        var retVal = new SheetFieldDef(SheetFieldType.Grid, fieldName, "", fontSize, fontName, false, xPos, yPos, width, height, growthBehavior, "", isNew: true);
        return retVal;
    }

    public static SheetFieldDef NewMobileHeader(string uiLabelMobile)
    {
        var retVal = new SheetFieldDef(SheetFieldType.MobileHeader, "misc", "", 8.5f, "", false, 0, 0, 0, 0, GrowthBehaviorEnum.DownGlobal, "", isNew: true);
        retVal.UiLabelMobile = uiLabelMobile;
        return retVal;
    }

    public Rectangle Bounds => new(XPos, YPos, Width, Height);
    public RectangleF BoundsF => new(XPos, YPos, Width, Height);
}