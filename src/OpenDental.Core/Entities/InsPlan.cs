...
public class InsPlan:TableBase{
	...
	public double PerVisitPatAmount;
	...
	public double PerVisitInsAmount;
	...
	public InsPlan Copy(){
		return (InsPlan)MemberwiseClone();
	}
