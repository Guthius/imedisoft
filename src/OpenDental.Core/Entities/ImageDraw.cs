...
public class ImageDraw:TableBase {
	...
	///<summary>This centralizes handling of our global font size for Pearl and BetterDiag.</summary>
	public float GetFontSize(){
		float fontSize=FontSize;
		ProgramName programName=Programs.GetActiveImagingAIProgram();
		if(programName==ProgramName.Pearl){
			string strFontHeight=ProgramProperties.GetPropVal(ProgramName.Pearl,OpenDentBusiness.Bridges.Pearl.PEARL_FONT_SIZE_PROPERTY);
			try{
			...
			string strFontSize=ProgramProperties.GetPropVal(ProgramName.BetterDiagnostics,"Text font size");
			try{
