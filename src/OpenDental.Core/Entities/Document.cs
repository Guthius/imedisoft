...
public class Document : TableBase
{
    ...
    public EnumDocChartLetterStatus ChartLetterStatus;
...
public enum EnumDocChartLetterStatus
{
    ///<summary>0- Not a chart letter.</summary>
    None,

    ///<summary>1- This chart letter will show in the Chart Module.</summary>
    Active,

    ///<summary>2- This chart letter was edited. This is the old version, retained for audit mode viewing.</summary>
    AuditTrail,

    ///<summary>3- This chart letter was deleted and only shows in audit mode.</summary>
    Deleted
}
