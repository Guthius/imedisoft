...
public class XWebResponse : TableBase
{
    ...
    public XWebTransactionType XTransactionType => !Enum.TryParse(TransactionType, out XWebTransactionType xWebTransactionType) ? XWebTransactionType.Undefined : xWebTransactionType;
    ...
    public void SetPersistentFields(long xWebResponseNum, string transactionType, long patNum, long provNum, long clinicNum, double amount, string otk, string hpfUrl, DateTime hpfExpiration, string debugError, string payNote, CreditCardSource ccSource, string email = "")
    {
    ...
    public string GetFormattedNote(bool keepAmountPositive, bool doIncludeNote = true, bool isErrorMessage = false)
    {
        ...
        if (!isErrorMessage)
        {
            retVal = "Amount: " + (keepAmountPositive ? Amount : -Amount).ToString("f") + "\r\nCard Number: " + MaskedAcctNum + "\r\nTransaction ID:" + " " + TransactionID + "\r\n";
        }

        retVal += "Response: " + ResponseDescription + "\r\nProcessed: " + dateTimeProcessed.ToShortDateString() + " " + dateTimeProcessed.ToShortTimeString() + "\r\n" + (doIncludeNote ? "Note:" + " " + PayNote : "");
        return retVal;
    }
}
