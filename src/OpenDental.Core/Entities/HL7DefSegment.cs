...
public class HL7DefSegment : TableBase
{
    ...
    {
        return (HL7DefSegment) MemberwiseClone();
    }
    ...
    public void AddField(int ordinalPos, string tableId, DataTypeHL7 dataType, string fieldName, string fixedText)
    {
        ...
        hl7DefFields.Add(new HL7DefField
        {
    ...
    {
        var dataType = FieldNameAndType.GetTypeFromName(fieldName);
        var tableNum = FieldNameAndType.GetTableNumFromName(fieldName);
