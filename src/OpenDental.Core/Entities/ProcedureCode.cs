...
public class ProcedureCode : TableBase
{
    ...
    public Color GraphicColor = Color.FromArgb(0);
    ...
    {
        get => ProcCat == 0 ? procCatDescript : Defs.GetName(DefCat.ProcCodeCats, ProcCat);
        set => procCatDescript = value;
    }
    
    public ProcedureCode Copy()
    {
        return (ProcedureCode) MemberwiseClone();
    }
}
