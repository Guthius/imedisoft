...
{
    /// <summary>
    /// X12 1. Use for claims that are not ongoing.
    /// </summary>
    Original,

    /// <summary>
    /// X12 7. Use to entirely replace an original claim.
    /// A claim reference number will be required.
    /// </summary>
    Replacement,

    /// <summary>
    /// X12 8. Use to undo an original claim.
    /// A claim reference number will be required.
    /// </summary>
    Void
}
