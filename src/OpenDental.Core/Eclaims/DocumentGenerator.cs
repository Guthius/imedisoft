...
namespace OpenDentBusiness.Eclaims {
	///<summary>This class could someday be replaced by using MigraDoc.DocumentObjectModel.Document to print directly to PDF,
	///because the logic in this class is very similar. DocumentGenerator was created years before MigraDoc existed,
	///and this is why the DocumentGenerator class was created.</summary>
