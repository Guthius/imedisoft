...
namespace OpenDentBusiness {
	public class Authentication {
		...
		public static bool CheckPassword(Userod userod,string inputPass,bool isEcw=false) {
			...
			if(isEcw) {
				return ConstantEquals(inputPass,passwordContainer.Hash);
			}
			if(!CheckPassword(inputPass,passwordContainer)) {
				return false;
			}
		...
		public static bool CheckPassword(string inputPass,PasswordContainer passwordContainer) {
			return CheckPassword(inputPass,passwordContainer.Salt,passwordContainer.Hash,passwordContainer.HashType);
		}
