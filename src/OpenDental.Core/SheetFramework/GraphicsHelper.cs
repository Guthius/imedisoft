...
namespace OpenDentBusiness {
	public class GraphicsHelper {
		...
		///<summary>Only rounds some corners.</summary>
		public static System.Windows.Shapes.Path GetRoundedPathWpf(System.Windows.Rect rect,double radiusCorner,bool roundUL=false,bool roundUR=false,bool roundLL=false,bool roundLR=false){
			...
			System.Windows.Media.LineSegment lineSegmentTop=new System.Windows.Media.LineSegment(new System.Windows.Point(rect.Right-radiusUR,rect.Top),isStroked:true);
			pathFigure.Segments.Add(lineSegmentTop);
			if(roundUR){
				System.Windows.Media.ArcSegment arcSegmentUR=new System.Windows.Media.ArcSegment(new System.Windows.Point(rect.Right,rect.Top+radiusUR),new System.Windows.Size(radiusUR,radiusUR),
					rotationAngle:0,isLargeArc:false,sweepDirection:System.Windows.Media.SweepDirection.Clockwise,isStroked:true);
				pathFigure.Segments.Add(arcSegmentUR);
				//path.AddArc(rect.Right-radiusUR*2,rect.Top,radiusUR*2,radiusUR*2,270,90);//UR
			}
			System.Windows.Media.LineSegment lineSegmentRight=new System.Windows.Media.LineSegment(new System.Windows.Point(rect.Right,rect.Bottom-radiusLR),isStroked:true);
			pathFigure.Segments.Add(lineSegmentRight);
			//path.AddLine(rect.Right,rect.Top+radiusUR,rect.Right,rect.Bottom-radiusLR);//right
			if(roundLR){
				System.Windows.Media.ArcSegment arcSegmentLR=new System.Windows.Media.ArcSegment(new System.Windows.Point(rect.Right-radiusLR,rect.Bottom),new System.Windows.Size(radiusLR,radiusLR),
					rotationAngle:0,isLargeArc:false,sweepDirection:System.Windows.Media.SweepDirection.Clockwise,isStroked:true);
			...
			System.Windows.Media.LineSegment lineSegmentBottom=new System.Windows.Media.LineSegment(new System.Windows.Point(rect.Left+radiusLL,rect.Bottom),isStroked:true);
			...
			if(roundLL){
				System.Windows.Media.ArcSegment arcSegmentLL=new System.Windows.Media.ArcSegment(new System.Windows.Point(rect.Left,rect.Bottom-radiusLL),new System.Windows.Size(radiusLL,radiusLL),
					rotationAngle:0,isLargeArc:false,sweepDirection:System.Windows.Media.SweepDirection.Clockwise,isStroked:true);
				pathFigure.Segments.Add(arcSegmentLL);
				//path.AddArc(rect.Left,rect.Bottom-radiusLL*2,radiusLL*2,radiusLL*2,90,90);//LL
			}
			System.Windows.Media.LineSegment lineSegmentLeft=new System.Windows.Media.LineSegment(new System.Windows.Point(rect.Left,rect.Top+radiusUL),isStroked:true);
			pathFigure.Segments.Add(lineSegmentLeft);
			//path.AddLine(rect.Left,rect.Bottom-radiusLL,rect.Left,rect.Top+radiusUL);//left
			if(roundUL){
				System.Windows.Media.ArcSegment arcSegmentUL=new System.Windows.Media.ArcSegment(new System.Windows.Point(rect.Left+radiusUL,rect.Top),new System.Windows.Size(radiusUL,radiusUL),
					rotationAngle:0,isLargeArc:false,sweepDirection:System.Windows.Media.SweepDirection.Clockwise,isStroked:true);
