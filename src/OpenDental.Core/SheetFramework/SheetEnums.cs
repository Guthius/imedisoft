...
public enum SheetTypeEnum
{
    ...
    ///<summary>26</summary>
    [SheetLayout(isChartModule: true, SheetFieldLayoutMode.Ecw, SheetFieldLayoutMode.MedicalPractice)]
    ChartModule = 26,
...
public enum SheetFieldLayoutMode
{
    ...
    [Description("Medical practice treatment plan view")]
...
{
    /// <summary>
    /// This will indicate if the auto save check box should be enabled in FormSheetDef.
    /// Will only matter if offices have opted to allow saving sheets as images
    /// </summary>
...
public class SheetInternalAttribute : Attribute
{
    ...
    public bool DoShowInDashboardSetup;
}

/// <summary>
/// Used when we want to link a SheetTypeEnum to a set of SheetFieldLayoutModes.
/// Ex: ChartModule link to ECW or Medical etc.
/// SheetTypeEnums which are not chart module will have IsChartModule=false and ArraySheetFieldLayoutModes
/// will only contain SheetFieldLayoutMode.Default.
/// </summary>
public class SheetLayoutAttribute : Attribute
{
    public bool IsChartModule;

    public SheetFieldLayoutMode[] SheetFieldLayoutModes = [SheetFieldLayoutMode.Default];
    ...
    public SheetLayoutAttribute(bool isChartModule, params SheetFieldLayoutMode[] arraySheetFieldLayoutModes)
    {
        ...
        SheetFieldLayoutModes = new SheetFieldLayoutMode[arraySheetFieldLayoutModes.Length + 1];
        SheetFieldLayoutModes[0] = SheetFieldLayoutMode.Default;

        for (var i = 0; i < arraySheetFieldLayoutModes.Length; i++)
        {
            SheetFieldLayoutModes[i + 1] = arraySheetFieldLayoutModes[i];
        }
    }
}
...
public class SheetGrowthAttribute : Attribute
{
    ...
    public bool IsGridOnly { get; set; }
