...
namespace OpenDentBusiness {
	...
	public class CrudTableAttribute : Attribute {
		...
		///Tables with UsesDataReader=true will have the option of calling DataCore.GetList(command,RowToObj) that uses a DataReader and converts DataRows
	...
	public enum CrudAuditPerm {
		...
		///<summary>Perm#16 - Value:32768</summary>
		AppointmentDelete=32768,
		///<summary>Perm#17 - Value:65536</summary>
