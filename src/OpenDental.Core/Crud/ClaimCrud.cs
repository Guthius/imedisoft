    ...
    public static List<Claim> TableToList(DataTable table)
    {
        ...
        foreach (DataRow row in table.Rows)
        {
            var claim = new Claim
            {
                ...
                ClaimStatus = SIn.String(row["ClaimStatus"].ToString()),
                DateReceived = SIn.Date(row["DateReceived"].ToString()),
                PlanNum = SIn.Long(row["PlanNum"].ToString()),
                ProvTreat = SIn.Long(row["ProvTreat"].ToString()),
                ClaimFee = SIn.Double(row["ClaimFee"].ToString()),
                ...
                PreAuthString = SIn.String(row["PreAuthString"].ToString()),
                IsProsthesis = SIn.String(row["IsProsthesis"].ToString()),
                PriorDate = SIn.Date(row["PriorDate"].ToString()),
                ReasonUnderPaid = SIn.String(row["ReasonUnderPaid"].ToString()),
                ClaimNote = SIn.String(row["ClaimNote"].ToString()),
                ClaimType = SIn.String(row["ClaimType"].ToString()),
                ProvBill = SIn.Long(row["ProvBill"].ToString()),
                ReferringProv = SIn.Long(row["ReferringProv"].ToString()),
                RefNumString = SIn.String(row["RefNumString"].ToString()),
                PlaceService = (PlaceOfService) SIn.Int(row["PlaceService"].ToString()),
                AccidentRelated = SIn.String(row["AccidentRelated"].ToString()),
                AccidentDate = SIn.Date(row["AccidentDate"].ToString()),
                AccidentST = SIn.String(row["AccidentST"].ToString()),
                EmployRelated = (YN) SIn.Int(row["EmployRelated"].ToString()),
                IsOrtho = SIn.Bool(row["IsOrtho"].ToString()),
                OrthoRemainM = SIn.Byte(row["OrthoRemainM"].ToString()),
                OrthoDate = SIn.Date(row["OrthoDate"].ToString()),
                PatRelat = (Relat) SIn.Int(row["PatRelat"].ToString()),
                PlanNum2 = SIn.Long(row["PlanNum2"].ToString()),
                PatRelat2 = (Relat) SIn.Int(row["PatRelat2"].ToString()),
                WriteOff = SIn.Double(row["WriteOff"].ToString()),
                Radiographs = SIn.Byte(row["Radiographs"].ToString()),
                ClinicNum = SIn.Long(row["ClinicNum"].ToString()),
                ClaimForm = SIn.Long(row["ClaimForm"].ToString()),
                AttachedImages = SIn.Int(row["AttachedImages"].ToString()),
                AttachedModels = SIn.Int(row["AttachedModels"].ToString()),
                AttachedFlags = SIn.String(row["AttachedFlags"].ToString()),
                AttachmentID = SIn.String(row["AttachmentID"].ToString()),
                CanadianMaterialsForwarded = SIn.String(row["CanadianMaterialsForwarded"].ToString()),
                CanadianReferralProviderNum = SIn.String(row["CanadianReferralProviderNum"].ToString()),
                CanadianReferralReason = SIn.Byte(row["CanadianReferralReason"].ToString()),
                CanadianIsInitialLower = SIn.String(row["CanadianIsInitialLower"].ToString()),
                CanadianDateInitialLower = SIn.Date(row["CanadianDateInitialLower"].ToString()),
                CanadianMandProsthMaterial = SIn.Byte(row["CanadianMandProsthMaterial"].ToString()),
                CanadianIsInitialUpper = SIn.String(row["CanadianIsInitialUpper"].ToString()),
                CanadianDateInitialUpper = SIn.Date(row["CanadianDateInitialUpper"].ToString()),
                CanadianMaxProsthMaterial = SIn.Byte(row["CanadianMaxProsthMaterial"].ToString()),
                InsSubNum = SIn.Long(row["InsSubNum"].ToString()),
                InsSubNum2 = SIn.Long(row["InsSubNum2"].ToString()),
                CanadaTransRefNum = SIn.String(row["CanadaTransRefNum"].ToString()),
                CanadaEstTreatStartDate = SIn.Date(row["CanadaEstTreatStartDate"].ToString()),
                CanadaInitialPayment = SIn.Double(row["CanadaInitialPayment"].ToString()),
                CanadaPaymentMode = SIn.Byte(row["CanadaPaymentMode"].ToString()),
                CanadaTreatDuration = SIn.Byte(row["CanadaTreatDuration"].ToString()),
                CanadaNumAnticipatedPayments = SIn.Byte(row["CanadaNumAnticipatedPayments"].ToString()),
                CanadaAnticipatedPayAmount = SIn.Double(row["CanadaAnticipatedPayAmount"].ToString()),
                PriorAuthorizationNumber = SIn.String(row["PriorAuthorizationNumber"].ToString()),
                SpecialProgramCode = (EnumClaimSpecialProgram) SIn.Int(row["SpecialProgramCode"].ToString()),
                UniformBillType = SIn.String(row["UniformBillType"].ToString()),
                MedType = (EnumClaimMedType) SIn.Int(row["MedType"].ToString()),
                AdmissionTypeCode = SIn.String(row["AdmissionTypeCode"].ToString()),
                AdmissionSourceCode = SIn.String(row["AdmissionSourceCode"].ToString()),
                PatientStatusCode = SIn.String(row["PatientStatusCode"].ToString()),
                CustomTracking = SIn.Long(row["CustomTracking"].ToString()),
                DateResent = SIn.Date(row["DateResent"].ToString()),
                CorrectionType = (ClaimCorrectionType) SIn.Int(row["CorrectionType"].ToString()),
                ClaimIdentifier = SIn.String(row["ClaimIdentifier"].ToString()),
                OrigRefNum = SIn.String(row["OrigRefNum"].ToString()),
                ProvOrderOverride = SIn.Long(row["ProvOrderOverride"].ToString()),
                OrthoTotalM = SIn.Byte(row["OrthoTotalM"].ToString()),
                ShareOfCost = SIn.Double(row["ShareOfCost"].ToString()),
                ...
                DateSentOrig = SIn.Date(row["DateSentOrig"].ToString()),
                DateIllnessInjuryPreg = SIn.Date(row["DateIllnessInjuryPreg"].ToString()),
                DateIllnessInjuryPregQualifier = (DateIllnessInjuryPregQualifier) SIn.Int(row["DateIllnessInjuryPregQualifier"].ToString()),
                DateOther = SIn.Date(row["DateOther"].ToString()),
                DateOtherQualifier = (DateOtherQualifier) SIn.Int(row["DateOtherQualifier"].ToString()),
                IsOutsideLab = SIn.Bool(row["IsOutsideLab"].ToString()),
                SecurityHash = SIn.String(row["SecurityHash"].ToString()),
                Narrative = SIn.String(row["Narrative"].ToString())
            };
            retVal.Add(claim);
        }
