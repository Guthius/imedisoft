...
public class ClockEventCrud
{
    ...
    public static long Insert(ClockEvent clockEvent)
    {
        ...
        command +=
            SOut.Long(clockEvent.EmployeeNum) + ","
                                              ...
                                              + SOut.DateTime(clockEvent.TimeDisplayed2) + ","
                                              + "'" + SOut.TimeSpan(clockEvent.OTimeHours) + "',"
                                              + "'" + SOut.TimeSpan(clockEvent.OTimeAuto) + "',"
                                              + "'" + SOut.TimeSpan(clockEvent.Adjust) + "',"
                                              + "'" + SOut.TimeSpan(clockEvent.AdjustAuto) + "',"
                                              + SOut.Bool(clockEvent.AdjustIsOverridden) + ","
                                              + "'" + SOut.TimeSpan(clockEvent.Rate2Hours) + "',"
                                              + "'" + SOut.TimeSpan(clockEvent.Rate2Auto) + "',"
                                              + SOut.Long(clockEvent.ClinicNum) + ","
                                              + "'" + SOut.TimeSpan(clockEvent.Rate3Hours) + "',"
    ...
    public static void Update(ClockEvent clockEvent)
    {
        var command = "UPDATE clockevent SET "
                      ...
                      + "TimeDisplayed1    =  " + SOut.DateTime(clockEvent.TimeDisplayed1) + ", "
                      + "ClockStatus       =  " + SOut.Int((int) clockEvent.ClockStatus) + ", "
                      + "Note              =  " + DbHelper.ParamChar + "paramNote, "
                      + "TimeEntered2      =  " + SOut.DateTime(clockEvent.TimeEntered2) + ", "
                      + "TimeDisplayed2    =  " + SOut.DateTime(clockEvent.TimeDisplayed2) + ", "
                      + "OTimeHours        = '" + SOut.TimeSpan(clockEvent.OTimeHours) + "', "
                      + "OTimeAuto         = '" + SOut.TimeSpan(clockEvent.OTimeAuto) + "', "
                      + "Adjust            = '" + SOut.TimeSpan(clockEvent.Adjust) + "', "
                      + "AdjustAuto        = '" + SOut.TimeSpan(clockEvent.AdjustAuto) + "', "
                      + "AdjustIsOverridden=  " + SOut.Bool(clockEvent.AdjustIsOverridden) + ", "
                      + "Rate2Hours        = '" + SOut.TimeSpan(clockEvent.Rate2Hours) + "', "
                      + "Rate2Auto         = '" + SOut.TimeSpan(clockEvent.Rate2Auto) + "', "
                      + "ClinicNum         =  " + SOut.Long(clockEvent.ClinicNum) + ", "
                      + "Rate3Hours        = '" + SOut.TimeSpan(clockEvent.Rate3Hours) + "', "
                      + "Rate3Auto         = '" + SOut.TimeSpan(clockEvent.Rate3Auto) + "', "
