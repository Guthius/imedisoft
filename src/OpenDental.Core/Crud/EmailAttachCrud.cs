...
public class EmailAttachCrud
{
    ...
    public static List<EmailAttach> TableToList(DataTable table)
    {
        ...
        foreach (DataRow row in table.Rows)
        {
            ...
            {
                EmailAttachNum = SIn.Long(row["EmailAttachNum"].ToString()),
    ...
    public static void Insert(EmailAttach emailAttach)
    {
    ...
    public static void Sync(List<EmailAttach> listNew, List<EmailAttach> listDB)
    {
        ...
        {
            EmailAttach fieldNew = null;
            if (idxNew < listNew.Count) fieldNew = listNew[idxNew];
            EmailAttach fieldDB = null;
