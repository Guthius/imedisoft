...
namespace OpenDentBusiness
{
    public class Erx
    {
        ...
        public static void ValidateClinic(ClinicDto clinic)
        {
            if (clinic == null)
            {
        ...
        ///All intended exceptions are Exceptions and are already translated.</summary>
        public static void ValidateProv(Provider provider, ClinicDto clinic = null)
        {
            if (provider == null)
            {
            ...
            ProviderClinic providerClinic = ProviderClinics.GetOneOrDefault(provider.ProvNum, (clinic == null ? 0 : clinic.Id));
        ...
        public static void ValidatePat(Patient patient)
        {
            ...
            if (patient.Zip != "" && !Regex.IsMatch(patient.Zip, @"^[0-9]{5}\-?([0-9]{4})?$"))
            {
                //Blank, or #####, or #####-####, or #########
