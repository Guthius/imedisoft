...
public class PayConnect2
{
    ...
    public static string GetPayConnect2ApiKey()
    {
        if (_payConnectApiKey.IsNullOrEmpty())
        {
            try
            {
                _payConnectApiKey = string.Empty;
                if (_payConnectApiKey.IsNullOrEmpty())
                {
                    //Only make call to HQ if we are not using introspection.
    ...
    {
        var integrationType = GetIntegrationType(clinicNum);
        PayConnect2Response response;
        if (integrationType == 1)
        {
            //Surcharge account
            var req = new CreateSurchargeTransactionRequest();
    ...
    {
        var body = JsonConvert.SerializeObject(requestBody, new JsonSerializerSettings {NullValueHandling = NullValueHandling.Ignore});
        var listHeaders = GetHeadersForApi(clinicNum);
        var response = Request(ApiRoute.CreateTransaction, HttpMethod.Post, listHeaders, body);
        return response;
    }
    ...
    public static PayConnect2Response PostCreateSurchargeTransaction(CreateSurchargeTransactionRequest requestBody, long clinicNum)
    {
        var body = JsonConvert.SerializeObject(requestBody, new JsonSerializerSettings {NullValueHandling = NullValueHandling.Ignore});
        var listHeaders = GetHeadersForApi(clinicNum);
        var response = Request(ApiRoute.CreateTransactionSurcharge, HttpMethod.Post, listHeaders, body);
        return response;
    }
    ...
    public static PayConnect2Response PutVoidWithReferenceID(VoidReferenceIDRequest requestBody, long clinicNum)
    {
        var body = JsonConvert.SerializeObject(requestBody, new JsonSerializerSettings {NullValueHandling = NullValueHandling.Ignore});
        var listHeaders = GetHeadersForApi(clinicNum);
        var response = Request(ApiRoute.VoidTransaction, HttpMethod.Put, listHeaders, body);
        return response;
    }
    ...
    public static PayConnect2Response PostRefundWithReferenceID(RefundReferenceIDRequest requestBody, long clinicNum)
    {
        var body = JsonConvert.SerializeObject(requestBody, new JsonSerializerSettings {NullValueHandling = NullValueHandling.Ignore});
        var listHeaders = GetHeadersForApi(clinicNum);
        var response = Request(ApiRoute.RefundTransaction, HttpMethod.Post, listHeaders, body);
        return response;
    }
    ...
    public static PayConnect2Response PutSignatureWithReferenceID(AddSignatureReferenceIDRequest requestBody, long clinicNum)
    {
        var body = JsonConvert.SerializeObject(requestBody, new JsonSerializerSettings {NullValueHandling = NullValueHandling.Ignore});
        var listHeaders = GetHeadersForApi(clinicNum);
        var response = Request(ApiRoute.AddSignature, HttpMethod.Put, listHeaders, body);
        return response;
    }
    ...
    public static PayConnect2Response GetTransactionStatus(long clinicNum, string refNumber, int transactionId = 0)
    {
        ...
        var listHeaders = GetHeadersForApi(clinicNum);
        var response = Request(ApiRoute.GetStatus, HttpMethod.Get, listHeaders, "", queryStr);
        return response;
    }
    ...
    public static PayConnect2Response PostEmbedSession(EmbedSessionRequest requestBody, long clinicNum)
    {
        var body = JsonConvert.SerializeObject(requestBody, new JsonSerializerSettings {NullValueHandling = NullValueHandling.Ignore});
        var listHeaders = GetHeadersForApi(clinicNum);
        var response = Request(ApiRoute.EmbedSession, HttpMethod.Post, listHeaders, body);
        return response;
    }
    ...
    public static PayConnect2Response PostCreateTerminalTransaction(CreateTerminalTransactionRequest requestBody, long clinicNum)
    {
        var body = JsonConvert.SerializeObject(requestBody, new JsonSerializerSettings {NullValueHandling = NullValueHandling.Ignore});
        var listHeaders = GetHeadersForApi(clinicNum);
        var response = Request(ApiRoute.CreateTerminalTransaction, HttpMethod.Post, listHeaders, body);
        return response;
    }

    public static PayConnect2Response GetMerchantInfo(long clinicNum, string merchantSecret)
    {
        var listHeaders = GetHeadersForApi(clinicNum, merchantSecret);
        var response = Request(ApiRoute.GetMerchantInfo, HttpMethod.Get, listHeaders, "");
        return response;
    }

    public static string GetApiBaseUrl()
    {
        return "https://api.dentalxchange.com/payments";
    }
    ...
    private static PayConnect2Response Request(ApiRoute route, HttpMethod method, List<string> listHeaders, string body, string queryStr = "")
    {
        ...
        using (var client = new WebClient())
        {
            ...
            var response = new PayConnect2Response();
            var res = "";
            try
            {
    ...
    {
        var payConnect2Response = new PayConnect2Response();
    ...
    {
        var payConnectResponse = new PayConnectResponse();
        switch (response.ResponseType)
        {
            ...
            case ResponseType.CreateSurchargeTransaction:
                var transactionSurchargeResponse = response.TransactionSurchargeResponse;
            ...
            case ResponseType.AddSignature:
                var addSignatureResponse = response.SignatureResponse;
            ...
            case ResponseType.IFrame:
                var iFrameResponse = response.iFrameResponse;
                ...
                var year = int.Parse(iFrameResponse.Response.ExpiryYear);
                var month = int.Parse(iFrameResponse.Response.ExpiryMonth);
            ...
            case ResponseType.TerminalTransaction:
                var terminalTransactionResponse = response.TerminalTransactionResponse;
            ...
            case ResponseType.GetStatus:
                var statusResponse = response.GetStatusResponse;
    ...
    [JsonConverter(typeof(StringEnumConverterWithDefault<CardNetwork>), Unrecognized)]
    ...
    private class StringEnumConverterWithDefault<T> : StringEnumConverter where T : struct, Enum
    {
        ...
        public override object ReadJson(JsonReader jsonReader, Type type, object enumValueCurrent, JsonSerializer jsonSerializer)
        {
            ...
            var didFindMatch = Enum.TryParse(jsonValue, ignoreCase: true, out T enumValueMatch);
            if (didFindMatch)
            {
