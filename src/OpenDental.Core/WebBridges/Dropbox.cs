...
namespace OpenDentBusiness {
	public class Dropbox {
		...
		public static string GetDropboxAuthorizationUrl(string appkey) {
			return OpenDental.Cloud.Storage.Dropbox.GetDropboxAuthorizationUrl(appkey);
		}
		...
		public static string GetDropboxAccessToken(string code,string appkey,string appsecret) {
			return OpenDental.Cloud.Storage.Dropbox.GetDropboxAccessToken(code,appkey,appsecret);
		}
	}
}
