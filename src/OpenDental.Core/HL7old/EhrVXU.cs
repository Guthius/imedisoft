...
namespace OpenDentBusiness.HL7 {
	...
	public class EhrVXU {
		...
		private void InitializeVariables() {
			...
			if(true && _pat.ClinicNum!=0) {//Using clinics and a clinic is assigned.
				var clinic=Clinics.GetClinic(_pat.ClinicNum);
		...
		public static string Validate(Patient pat,List<VaccinePat> vaccines) {
			...
			for(int i=0;i<vaccines.Count;i++) {
				...
				if(true && pat.ClinicNum!=0) {//Using clinics and a clinic is assigned.
