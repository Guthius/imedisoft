...
namespace OpenDentBusiness
{
    ...
    public class X834 : X12object
    {
        ...
        {
            if (xobj.FunctGroups.Count == 0)
            {
                //At least 1 GS segment in each 834.
                return false;
            }

            if (xobj.FunctGroups[0].Header.Get(1) == "BE")
            {
                //GS01 (pg. 237 and pg. 7)
                return true;
            }
        ...
        private void ReadLoop2000_INS(Hx834_Member member)
        {
            ...
            if (member.MemberLevelDetail.IndividualRelationshipCode == "01")
            {
                //Spouse
                member.PlanRelat = Relat.Spouse;
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "03")
            {
                //Father or Mother
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "04")
            {
                //Grandfather or Grandmother
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "05")
            {
                //Grandson or Granddaughter
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "06")
            {
                //Uncle or Aunt
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "07")
            {
                //Niece or Nephew
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "08")
            {
                //Cousin
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "09")
            {
                //Adopted Child
                member.PlanRelat = Relat.Child;
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "10")
            {
                //Foster Child
                member.PlanRelat = Relat.Child;
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "11")
            {
                //Son-in-law or Daugther-in-law
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "12")
            {
                //Brother-in-law or Sister-in-law
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "13")
            {
                //Mother-in-law or Father-in-law
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "14")
            {
                //Brother or Sister
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "15")
            {
                //Ward
                member.PlanRelat = Relat.HandicapDep;
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "16")
            {
                //Stepparent
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "17")
            {
                //Stepson or Stepdaughter
                member.PlanRelat = Relat.Child;
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "18")
            {
                //Self
                member.PlanRelat = Relat.Self;
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "19")
            {
                //Child
                member.PlanRelat = Relat.Child;
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "23")
            {
                //Sponsored Dependent
                member.PlanRelat = Relat.Dependent;
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "24")
            {
                //Dependent of Minor Dependent
                member.PlanRelat = Relat.Dependent;
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "25")
            {
                //Ex-spouse
                member.PlanRelat = Relat.SignifOther;
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "26")
            {
                //Guardian
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "31")
            {
                //Court Appointed Guardian
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "38")
            {
                //Collateral Dependent
                member.PlanRelat = Relat.Dependent;
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "53")
            {
                //Life Partner
                member.PlanRelat = Relat.LifePartner;
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "60")
            {
                //Annuitant
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "D2")
            {
                //Trustee
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "G8")
            {
                //Other Relationship
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            else if (member.MemberLevelDetail.IndividualRelationshipCode == "G9")
            {
                //Other Relative
                member.PlanRelat = Relat.Dependent; //No direct correlation to the standard.
            }
            ...
            if (member.MemberLevelDetail.MedicareStatusCode.StartsWith("A"))
            {
                //Medicare Part A (Hospital Insurance)
                isMedicareA = true;
            }
            else if (member.MemberLevelDetail.MedicareStatusCode.StartsWith("B"))
            {
                //Medicare Part B (Medical Insurance)
                isMedicareB = true;
            }
            else if (member.MemberLevelDetail.MedicareStatusCode.StartsWith("C"))
            {
            ...
            else if (member.MemberLevelDetail.MedicareStatusCode.StartsWith("D"))
            {
                //Medicare.  Presumably this is the same as "C" above.
                //We can only specify one filing code, so we have to pick either A or B.
                isMedicareB = true; //Medical insurance is more likely for OD users than Hospital insurance is.
            }
            else
        ...
        private void ReadLoop2000_DTP(Hx834_Member member)
        {
                       ...
                       "050", "286", "296", "297", "300", "301", "303", "336", "337", "338", "339", "340", "341", "350", "351", "356", "357", "383", "385", "386", "393", "394", "473", "474"))
            {
                ...
                else if (dtp.DateTimeQualifier == "336")
                {
                    //Employment Begin
                }
                else if (dtp.DateTimeQualifier == "337")
                {
                    //Employment End
                }
                else if (dtp.DateTimeQualifier == "338")
                {
                    //Medicare Begin
                }
                else if (dtp.DateTimeQualifier == "339")
                {
                    //Medicare End
                }
                else if (dtp.DateTimeQualifier == "340")
                {
                    //Consolidated Omnibus Budget Reconciliation Act (COBRA) Begin
                }
                else if (dtp.DateTimeQualifier == "341")
                {
                    //Consolidated Omnibus Budget Reconciliation Act (COBRA) End
                }
                else if (dtp.DateTimeQualifier == "350")
                {
                    //Education Begin
                    //This is the start date for the student at the current educational institution.
                }
                else if (dtp.DateTimeQualifier == "351")
                {
                    //Education End
                    //This is the expected graduation date the student at the current educational institution.
                }
                else if (dtp.DateTimeQualifier == "356")
                {
                    //Eligibility Begin
                ...
                else if (dtp.DateTimeQualifier == "357")
                {
                    //Eligibility End
                ...
                else if (dtp.DateTimeQualifier == "383")
                {
                    //Adjusted Hire
                }
                else if (dtp.DateTimeQualifier == "385")
                {
                ...
                else if (dtp.DateTimeQualifier == "386")
                {
                ...
                else if (dtp.DateTimeQualifier == "393")
                {
                    //Plan Participation Suspension
                }
                else if (dtp.DateTimeQualifier == "394")
                {
                    //Rehire
                }
                else if (dtp.DateTimeQualifier == "473")
                {
                    //Medicaid Begin
                }
                else if (dtp.DateTimeQualifier == "474")
                {
                    //Medicaid End
                }
            }
        ...
        private void ReadLoop2100A_NM1(Hx834_Member member)
        {
            ...
            {
                //The only other code is "ZZ" which is useless to us.
        ...
        private void ReadLoop2100A_PER(Hx834_Member member)
        {
            ...
            for (var i = 0; i < arrayNumbers.Length; i += 2)
            {
                ...
                else if (qualifier == "HP")
                {
                    //Home Phone Number
                    member.Pat.HmPhone = number;
                }
                else if (qualifier == "TE")
                {
                    //Telephone
                    if (member.Pat.AddrNote != "")
                    {
        ...
        private void ReadLoop2100A_DMG(Hx834_Member member)
        {
            ...
            //DMG04:
            if (member.MemberDemographics.MaritalStatusCode == "B")
            {
                //Registered Domestic Partner
                member.Pat.Position = PatientPosition.Married; //We do not have this status currently.  Closest match used instead.
            }
            else if (member.MemberDemographics.MaritalStatusCode == "D")
            {
                //Divorced
                member.Pat.Position = PatientPosition.Divorced;
            }
            else if (member.MemberDemographics.MaritalStatusCode == "I")
            {
                //Single
                member.Pat.Position = PatientPosition.Single;
            }
            else if (member.MemberDemographics.MaritalStatusCode == "M")
            {
                //Married
                member.Pat.Position = PatientPosition.Married;
            }
            else if (member.MemberDemographics.MaritalStatusCode == "R")
            {
                //Unreported
                member.Pat.Position = PatientPosition.Single; //We do not have this status currently.  Closest match used instead.
            }
            else if (member.MemberDemographics.MaritalStatusCode == "S")
            {
                //Separated
                member.Pat.Position = PatientPosition.Married; //We do not have this status currently.  Closest match used instead.
            }
            else if (member.MemberDemographics.MaritalStatusCode == "U")
            {
                //Unmarried
                member.Pat.Position = PatientPosition.Single; //We do not have this status currently.  Closest match used instead.
            }
            else if (member.MemberDemographics.MaritalStatusCode == "W")
            {
                //Widowed
                member.Pat.Position = PatientPosition.Widowed;
            }
            else if (member.MemberDemographics.MaritalStatusCode == "X")
            {
                //Legally Separated
                member.Pat.Position = PatientPosition.Married; //We do not have this status currently.  Closest match used instead.
            }
            ...
            if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("7"))
            {
                //Not Provided
            ...
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("8"))
            {
                //Not Applicable
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("A"))
            {
                //Asian or Pacific Islander
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "2028-9"));
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("B"))
            {
                //Black
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "2054-5"));
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("C"))
            {
                //Caucasian
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "2106-3"));
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("D"))
            {
                //Subcontinent Asian American
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("E"))
            {
                //Other Race or Ethnicity
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "2131-1"));
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("F"))
            {
                //Asian Pacific American
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "2028-9"));
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("G"))
            {
                //Native American
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "1002-5"));
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("H"))
            {
                //Hispanic
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "2135-2"));
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("I"))
            {
                //American Indian or Alaskan Native
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "1002-5"));
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("J"))
            {
                //Native Hawaiian
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "2076-8"));
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("N"))
            {
                //Black (Non-Hispanic)
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "2054-5"));
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("O"))
            {
                //White (Non-Hispanic)
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "2106-3"));
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("P"))
            {
                //Pacific Islander
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "2076-8"));
            }
            else if (member.MemberDemographics.CompositeRaceOrEthnicityInformation.StartsWith("Z"))
            {
                //Mutually Defined
                member.ListPatRaces.Add(new PatientRace(member.Pat.PatNum, "2131-1"));
            }
        ...
        private void ReadLoop2100A_LUI(Hx834_Member member)
        {
            ...
            while (_segCur.IsType("LUI"))
            {
                ...
                var lang = "";
                //LUI01 & LUI02:
                if (lui.IdentificationCodeQualifier == "LD")
                {
                    //NISO Z39.53 Language Code
                    lang = lui.IdentificationCode; //I think this is the same as ISO 639-2.  We support ISO 639-2 direclty.
                }
                else if (lui.IdentificationCodeQualifier == "LE")
                {
                    //ISO 639 Langauge Code.
                ...
                //LUI04:
                if (lui.UseOfLanguageIndicator == "5")
                {
                    //Language Reading
                    listLangRead.Add(lang);
                }
                else if (lui.UseOfLanguageIndicator == "6")
                {
                    //Language Writing
                    listLangWrite.Add(lang);
                }
                else if (lui.UseOfLanguageIndicator == "7")
                {
                    //Langauge Speaking
                    listLangSpeak.Add(lang);
                }
                else if (lui.UseOfLanguageIndicator == "8")
                {
                    //Native Language
                ...
                {
                    //Unspecified usage.  Assume primary.
        ...
        private void ReadLoop2300_DTP(Hx834_HealthCoverage healthCoverage)
        {
            ...
            while (_segCur.IsType("DTP", "300", "303", "343", "348", "349", "543", "695"))
            {
                ...
                else if (dtp.DateTimeQualifier == "343")
                {
                    //Premium Paid to Date End
                }
                else if (dtp.DateTimeQualifier == "348")
                {
                    //Benefit Begin
                ...
                else if (dtp.DateTimeQualifier == "349")
                {
                    //Benefit End
                ...
                else if (dtp.DateTimeQualifier == "543")
                {
                    //Last Premium Paid Date
                }
                else if (dtp.DateTimeQualifier == "695")
                {
                    //Pervious Period
        ...
        private void ReadLoop2300_REF_1(Hx834_HealthCoverage healthCoverage)
        {
            ...
            while (_segCur.IsType("REF", "17", "1L", "9V", "CE", "E8", "M7", "PID", "RB", "X9", "XM", "XX1", "XX2", "ZX", "ZZ"))
            {
                ...
                _segNum++;
                if (policyNum.ReferenceIdQualifier == "17")
                {
                ...
                else if (policyNum.ReferenceIdQualifier == "1L")
                {
                ...
                else if (policyNum.ReferenceIdQualifier == "9V")
                {
                    //Payment Category
                }
                else if (policyNum.ReferenceIdQualifier == "CE")
                {
                    //Class of Contract Code
                }
                else if (policyNum.ReferenceIdQualifier == "E8")
                {
                    //Service Contract (Coverage) Number
                }
                else if (policyNum.ReferenceIdQualifier == "M7")
                {
                    //Medical Assistance Cateogory
                }
                else if (policyNum.ReferenceIdQualifier == "PID")
                {
                    //Program Identification Number
                }
                else if (policyNum.ReferenceIdQualifier == "RB")
                {
                    //Rate code number
                }
                else if (policyNum.ReferenceIdQualifier == "X9")
                {
                    //Internal Control Number
                }
                else if (policyNum.ReferenceIdQualifier == "XM")
                {
                    //Issuer Number
                }
                else if (policyNum.ReferenceIdQualifier == "XX1")
                {
                    //Special Program Code
                }
                else if (policyNum.ReferenceIdQualifier == "XX2")
                {
                    //Service Area Code
                }
                else if (policyNum.ReferenceIdQualifier == "ZX")
                {
                    //Country Code
                }
                else if (policyNum.ReferenceIdQualifier == "ZZ")
                {
                    //Mutually Defined
    ...
    public class Hx834_HealthCoverage
    {
        ...
        public string GetCoverageMaintTypeDescript()
        {
            ...
            if (HealthCoverage.MaintenanceTypeCode == "001")
            {
                //Change
                return "Change";
            }
            else if (HealthCoverage.MaintenanceTypeCode == "002")
            {
                //Delete
                return "Delete";
            }
            else if (HealthCoverage.MaintenanceTypeCode == "021")
            {
                //Addition
                return "Addition";
            }
            else if (HealthCoverage.MaintenanceTypeCode == "024")
            {
                //Cancellation or Termination
                return "Cancel";
            }
            else if (HealthCoverage.MaintenanceTypeCode == "025")
            {
                //Reinstatement
                return "Reinstate";
            }
            else if (HealthCoverage.MaintenanceTypeCode == "026")
            {
                //Correction
                return "Correct";
            }
            else if (HealthCoverage.MaintenanceTypeCode == "030")
            {
                //Audit or Compare
                return "Audit";
            }
            else if (HealthCoverage.MaintenanceTypeCode == "032")
            {
    ...
    public class Hx834_Member
    {
        ...
        public string GetPatMaintTypeDescript()
        {
            ...
            if (MemberLevelDetail.MaintenanceTypeCode == "001")
            {
                //Change
                return "Change";
            }
            else if (MemberLevelDetail.MaintenanceTypeCode == "021")
            {
                //Addition
                return "Addition";
            }
            else if (MemberLevelDetail.MaintenanceTypeCode == "024")
            {
                //Cancellation or Termination
                return "Cancel";
            }
            else if (MemberLevelDetail.MaintenanceTypeCode == "025")
            {
                //Reinstatement
                return "Reinstate";
            }
            else if (MemberLevelDetail.MaintenanceTypeCode == "030")
            {
                //Audit or Compare
                return "Audit";
            }
        ...
        public Patient MergePatientIntoDbPatient(Patient patDb)
        {
            ...
            if (Pat.StudentStatus != null)
            {
                //Student status is situational information.  Only overwrite existing value if a new value was specified.
                patDb.StudentStatus = Pat.StudentStatus;
            }

            if (Pat.DateTimeDeceased.Year > 1880)
            {
                //Date deceased is situational information.  Only overwrite existing value if a new value was specified.
            ...
            if (Pat.SSN != "")
            {
                //SSN is situational information.  Only overwrite existing value if a new value was specified.
                patDb.SSN = Pat.SSN;
            ...
            {
                //Middle Name is situational information.  Only overwrite existing value if a new value was specified.
                patDb.MiddleI = Pat.MiddleI;
                patDb.FName = Pat.FName; //The patinet First Name must have been specified, as required by the format.  May be blank.
            }
            else if (Pat.FName != "")
            {
                //First Name is situational information.  Only overwrite existing value if a new value was specified.
                patDb.FName = Pat.FName;
            }

            if (Pat.AddrNote != null)
            {
                //Additinal contact information is situational information.  Only overwrite existing value if a new value was specified.
            ...
            if (Pat.WirelessPhone != null)
            {
                //Wireless Phone is situational information.  Only overwrite existing value if a new value was specified.
                patDb.WirelessPhone = Pat.WirelessPhone;
            }

            if (Pat.Email != null)
            {
                //Email is situational information.  Only overwrite existing value if a new value was specified.
                patDb.Email = Pat.Email;
            }

            if (Pat.HmPhone != null)
            {
                //Home Phone is situational information.  Only overwrite existing value if a new value was specified.
                patDb.HmPhone = Pat.HmPhone;
            }

            if (Pat.WkPhone != null)
            {
                //Work Phone is situational information.  Only overwrite existing value if a new value was specified.
                patDb.WkPhone = Pat.WkPhone;
            }

            if (Pat.Address2 != null)
            {
                //Address is situational information.  Only overwrite existing value if a new value was specified.
            ...
            if (MemberDemographics != null)
            {
                ...
                if (MemberDemographics.MaritalStatusCode != "")
                {
                    //The patient marital status is situational information.  Only overwrite if specified.
            ...
            if (ListMemberLanguages.Count > 0)
            {
                //The patient language is situational information.  Only overwrite if specified.
                patDb.Language = Pat.Language;
            }

            if (ListMemberSchools.Count > 0)
            {
                //The patient school is situational information.  Only overwrite if specified.
