...
namespace OpenDentBusiness
{
	...
	public class X270:X12object{
		...
		public static string GenerateMessageText(Clearinghouse clearinghouseClin,Carrier carrier,Provider billProv,ClinicDto clinic,InsPlan insPlan,Patient subscriber,InsSub insSub,Patient patForRequest) {
...
IEA*1*000012145~";
		...
		public static string Validate(Clearinghouse clearinghouseClin,Carrier carrier,Provider billProv,ClinicDto clinic,InsPlan insPlan,Patient subscriber,InsSub insSub,Patient patForRequest) {
			StringBuilder strb=new StringBuilder();
