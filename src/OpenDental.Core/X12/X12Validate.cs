...
namespace OpenDentBusiness {
	public class X12Validate {
		...
		public static void Clinic(ClinicDto clinic,StringBuilder strb) {
			if(clinic.UseBillingAddressOnClaims) { //If we're using billing address, check the clinic's billing info for validity.
			...
			if(clinic.PhoneNumber.Length!=10) {//1000A PER04 min length=1.
