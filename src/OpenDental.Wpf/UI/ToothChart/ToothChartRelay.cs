...
namespace OpenDental{
	...
	public class ToothChartRelay{
		...
		public void AddOrthoWireBetweenBrackets(string toothIDstart,string toothIDend,Color color){
			if(IsSparks3DPresent){
				_sparks3DInterface.AddOrthoWireBetweenBrackets(toothIDstart,toothIDend,color);
			}
			else{
				//not supported
			}
		...
		public void AddOrthoWireInBracket(string toothID,Color color){
			if(IsSparks3DPresent){
				_sparks3DInterface.AddOrthoWireInBracket(toothID,color);
			}
			else{
				//not supported
			}
		...
		public void AddOrthoElastic(string toothIDstart,string toothIDend,Color color){
			if(IsSparks3DPresent){
				_sparks3DInterface.AddOrthoElastic(toothIDstart,toothIDend,color);
			}
			else{
				//not supported
			}
		...
		public void SetBracket(string toothID,Color color){
			if(IsSparks3DPresent){
				_sparks3DInterface.SetBracket(toothID,color);
			}
			else{
				//not supported
			}
		...
		public void SetOrthoMode(bool isOrthoMode){
			if(IsSparks3DPresent){
				_sparks3DInterface.SetOrthoMode(isOrthoMode);
			}
			else{
				//not supported
			}
