...
namespace OpenDental
{
    ...
    public class DatabaseIntegrities
    {
        ...
        public static DatabaseIntegrity GetOneClass(EnumWarningIntegrityType warningIntegrityType)
        {
            ...
            {
                //If not found, get default behavior
        ...
        public static void AddPatientModuleToCache(long patNum, EnumModuleType moduleType)
        {
            ...
            if (patientModule.ListModuleTypes.Contains(moduleType))
            {
                //already cached for patient
                return;
            }
        ...
        private static void RefreshFromHQ()
        {
            ...
            if (/* ODBuild.IsDebug() */ false)
            {
                return; //Comment out this line when testing database integrity.
            }
            ...
            try
            {
                //WebServiceCustomerUpdates solution & project:
        ...
        private static void RefreshCacheFromPref()
        {
            ...
            if (!/* ODBuild.IsDebug() */ false)
            {
                whiteListObfuscated = Prefs.GetOne(PrefName.DatabaseIntegritiesWhiteList).ValueString;
            }
