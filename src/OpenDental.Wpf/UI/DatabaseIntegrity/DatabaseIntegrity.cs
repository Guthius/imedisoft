...
namespace OpenDental {
	///<summary>This is a database table in the HQ bugs database. There is no generated crud code. In the db, all the columns except PK are strings. Currently 70 rows.Most of them are have PluginName set to some dll, like "PatientRiver.dll". But there are two with that column empty: 1: DefaultClass, Triangle. 2: DefaultPlugin, PluginBlock.</summary>
