...
namespace OpenDental {
	...
	Fonts:
	Android uses 160 dpi for their dp (device-independent pixels) across all devices, including tablets, regardless of actual resolution.
	Flutter use approximately 96 dpi for their lp (logical pixels), although this may be inaccurate, sometimes by a significant margin.
	Flutter default font size is 14 lp.
	Recommended font size for a phone is 16 (@160dpi), which is equivalent to 9.6 lp @96dpi
	Recommended font size for a tablet is 18 to 20, which is equivalent to 10.8 to 12 @96
	When we initially built this, we were using 11.5 lp for both phone and tablet, which is actually in the recommended range.
	But ChrisS complains that our 11.5 lp on a tablet is too small.
	...
	*/
	...
	public partial class CtrlEFormFill:UserControl {
		...
		public CtrlEFormFill() {
			...
			// TODO: _cursorDrag=new Cursor(new MemoryStream(WpfControls.Properties.Resources.CursorDrag));
		}
