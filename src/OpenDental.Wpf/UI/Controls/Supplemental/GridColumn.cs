...
namespace WpfControls.UI {
	...
	public class GridColumn{
		...
		///<summary>Default false. Set a non-zero starting width for the column, then set this to true.  Column(s) will resize dynamically as long as not hScrollVisible.  The right column is usually set to IsWidthDynamic=true.</summary>
		[DefaultValue(false)]
		public bool IsWidthDynamic{ get; set; } = false;

		///<summary>Can be used when grid.SelectionMode=OneCell. Setting this list of strings causes combo boxes to be used in column cells instead of textboxes.  This is the list of strings to show in the combo boxes. If setting this, do not also set IsEditable.</summary>
		[DefaultValue(null)]
