...
namespace OpenDental
{
    public class UIManager
    {
        ...
        public UIManager(FormFrame formFrame, FrmODBase frmODBase)
        {
            ...
            {
                //This must be done for backward compatibility with language translations
                //and with the Help feature.
            ...
            {
                FormFrame_.WindowState = FormWindowState.Maximized;
            }

            FormFrame_.Text = frmODBase.Text;
            SizeClientOriginal = new Size((int) frmODBase.Width, (int) frmODBase.Height);
        ...
        public void SetElementHost()
        {
            ...
            if (FormFrame.AreBordersMS)
            {
                FormFrame_.ElementHostUI.Location = new Point(0, 0);
                FormFrame_.ElementHostUI.Dock = DockStyle.Fill;
            }
            else
            {
                FormFrame_.ElementHostUI.Size = new Size(FormFrame_.Width, FormFrame_.Height - GetHeightTitleBar());
                FormFrame_.ElementHostUI.Location = new Point(0, GetHeightTitleBar());
            }
...
//Proxy proxyForm=ListProxies[0];
            ...
            else if (FormFrame_.WindowState == FormWindowState.Maximized)
            {
                FormFrame_.ElementHostUI.Bounds = new Rectangle(
                    x: 0,
                ...
                FormFrame_.PanelBorders.Bounds = new Rectangle(-1, widthBorder - 1, FormFrame_.Width - widthBorder * 2 + 1, FormFrame_.ElementHostUI.Bounds.Bottom - 6); //FormODBase_.Height-widthBorder);
            }
            else
            {
                FormFrame_.ElementHostUI.Bounds = new Rectangle(
                ...
                FormFrame_.PanelBorders.Bounds = new Rectangle(-1, -1, FormFrame_.Width - widthBorder * 2 + 1, 100); //FormODBase_.Height-widthBorder);
            }
