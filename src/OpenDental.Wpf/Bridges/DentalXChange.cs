...
namespace OpenDental.Bridges {
	...
	public class DentalXChange {
		...
		public static void SendData(Program prog,Patient pat) {
			...
			formLauncher.SetField("UrlBrowseTo",url);
			formLauncher.SetField("PostData",postData);
			formLauncher.SetField("AdditionalHeaders","Content-Type: application/x-www-form-urlencoded\r\n");
			formLauncher.Show();
		}
