...
namespace OpenDental {
	...
	public partial class FrmDocInfo : FrmODBase {
		...
		public void FrmDocInfo_Load(object sender, System.EventArgs e){
			...
			else if(!SecurityL.IsAuthorizedToEditImage(_documentOld,suppressMessage:true)) {
		...
		private void butAudit_Click(object sender,EventArgs e) {
			...
			listPermissions.Add(EnumPermType.ImageSignatureCreate);
			listPermissions.Add(EnumPermType.SignedImageEdit);
		...
		private void butSave_Click(object sender, System.EventArgs e){
			...
			if(dateTimeEntered>_document.DateCreated) {
				...
				List<EnumPermType> listMissingPermissions=SecurityL.GetMissingPermissionsNeededToDeleteImage(_document);
