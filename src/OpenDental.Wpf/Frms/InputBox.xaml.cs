			...
			for(int i=0;i<_listInputBoxParams.Count;i++) {
				...
				switch(_listInputBoxParams[i].InputBoxType_) {
					...
					case InputBoxType.ListBoxMulti:
						...
						listBoxMulti.Name="listBox"+itemOrder;
						listBoxMulti.Margin=new Thickness(left:xPos,top:_yPos,right:0,bottom:0);
					...
					case InputBoxType.ListBox:
						...
						listBox.Height=95;
						if(_listInputBoxParams[i].SizeParam.Width!=0 && _listInputBoxParams[i].SizeParam.Height!=0){
							listBox.Width=_listInputBoxParams[i].SizeParam.Width;
							listBox.Height=_listInputBoxParams[i].SizeParam.Height;
						}
						control=listBox;
						break;
